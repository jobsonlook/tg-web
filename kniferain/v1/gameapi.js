...
(function() {
    ...
    function S(t, e) {
        t._state === ot && (t._result = e,
        t._state = it,
        0 !== t._subscribers.length && Q(T, t))
    }
    function j(t, e) {
        t._state === ot && (t._state = st,
        t._result = e,
        Q(A, t))
    }
    function E(t, e, n, r) {
    ...
    function N(t, e) {
        ...
        this._enumerate(),
        0 === this._remaining && S(this.promise, this._result))) : j(this.promise, U())
    }
    function U() {
    ...
    ;
    var B, G, H, I = z, J = 0, Q = function(t, e) {
        tt[J] = t,
        tt[J + 1] = e,
        J += 2,
        2 === J && (G ? G(a) : H())
    }, R = "undefined" != typeof window ? window : void 0, V = R || {}, X = V.MutationObserver || V.WebKitMutationObserver, Z = "undefined" == typeof self && "undefined" != typeof process && "[object process]" === {}.toString.call(process), $ = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, tt = new Array(1e3);
    ...
    N.prototype._settledAt = function(t, e, n) {
        var r = this.promise;
        r._state === ot && (this._remaining--,
        t === st ? j(r, n) : this._result[e] = n),
    ...
    "function" == typeof define && define.amd ? define(function() {
        return vt
    }) : "undefined" != typeof module && module.exports ? module.exports = vt : "undefined" != typeof this && (this.ES6Promise = vt),
    dt()
}
).call(this);
...
!function(t, s, e) {
    ...
    i.prototype = {
        ...
        backspace: function(t, s) {
            ...
            if (this.stop !== !0) {
                if (this.fadeOut)
                    return void this.initFadeOut();
                var i = Math.round(70 * Math.random()) + this.backSpeed;
                e.timeout = setTimeout(function() {
                    if ("html" === e.contentType && ">" === t.substr(s).charAt(0)) {
                        for (var i = ""; "<" !== t.substr(s - 1).charAt(0) && (i -= t.substr(s).charAt(0),
                        s--,
                        !(s < 0)); )
                            ;
                        s--,
                    ...
                    e.init()) : e.typewrite(e.strings[e.sequence[e.arrayPos]], s))
                }, i)
            }
        },
...
fg_api.prototype.adsModule = function() {
    ...
    module.prototype.init = function() {
        ...
        case "dfp":
            ...
            faZepto.getScript("https://imasdk.googleapis.com/js/sdkloader/ima3.js", // https://imasdk.googleapis.com/js/sdkloader/ima3_debug.js
            sdkLoadedCallback, function() {
                sdkLoadedCallback();
            });
            ...
            if (self.hasFeature("rewarded")) {
                faZepto.getScript("//www.googletagservices.com/tag/js/gpt.js", function() {
                    window.googletag.cmd.push(function() {
                        ...
                        window.googletag.pubads().setRequestNonPersonalizedAds(self.config.ads.npa);

                        window.googletag.pubads().addEventListener("rewardedSlotReady", function(evt) {
                            M.rewardedAdEvent = evt;
                        });

                        window.googletag.pubads().addEventListener("rewardedSlotCanceled", function() {
                            M.rewardedAdEvent = undefined;

                            self.game.resume();

                            self.wait(1e3).then(M.preloadRewardedAd);
                        });
                        ...
                        window.googletag.pubads().addEventListener("rewardedSlotFailedToLoad", function() {
                            M.rewardedAdEvent = undefined;
                        ...
                        window.googletag.pubads().addEventListener("slotRenderEnded", function(evt) {
                            if (evt.isEmpty) {
    ...
    module.prototype.hasRewardedAd = function() {
        return !!M.rewardedAdEvent || !!M.preloadRewardedAd();
    }
    ;
    ...
    module.prototype.rewardedAd = function(callback) {
        ...
        if (!self.hasFeature("rewarded")) {
            throw new Error("Configuration Error: famobi feature 'rewarded' is not defined");
        }
    ...
    module.prototype.configureRewardedSlot = function() {
        window.googletag.cmd.push(function() {
            ...
            M.rewardedSlot = window.googletag.defineOutOfPageSlot(self.debug ? "/6062/sanghan_rweb_ad_unit" : M.dfp_ad_unit_code, window.googletag.enums.OutOfPageFormat.REWARDED).addService(window.googletag.pubads()).setTargeting("a", "" + self.config.aid).setTargeting("game", "" + window.famobi_gameID).setTargeting("gametype", "html5").setTargeting("video", "1").setTargeting("uuid", "" + self.config.uuid);
        });
    }
    ;
    ...
    module.prototype.preloadRewardedAd = function() {
        // rate limiter
        if (M.preloadingRewardedAd) {
            return;
        }
        M.preloadingRewardedAd = true;
        self.wait(5e3).then(function() {
            M.preloadingRewardedAd = false;
        });
        window.googletag.cmd.push(function() {
        ...
        function listApps(apps) {
            ...
            apps.slice(0, 4).forEach(function(app) {
                ...
                var aNode = self.createElement("a", {
                    href: "javascript:;",
                    "data-xhref": "https://play.famobi.com/" + gameID + "/" + self.config.aid + "?original_ref=" + encodeURIComponent(self.getShortLink()),
                    title: app.name,
                    target: "_blank"
                });
    ...
    module.prototype.showIMA = function(callback, force) {
        ...
        module.prototype.onAdsManagerLoaded = function(adsManagerLoadedEvent) {
            ...
            faZepto.each(["LOADED", "IMPRESSION", "STARTED", "SKIPPABLE_STATE_CHANGED", "FIRST_QUARTILE", "MIDPOINT", "THIRD_QUARTILE", "USER_CLOSE", "SKIPPED", "COMPLETE", "ALL_ADS_COMPLETED", "DURATION_CHANGE", "CONTENT_RESUME_REQUESTED", "CONTENT_PAUSE_REQUESTED"], function(key, value) {
        ...
        module.prototype.onAdEvent = function(adEvent) {
            ...
            case google.ima.AdEvent.Type.STARTED:
                ...
                if (ad.isLinear() && M.adsManager.getRemainingTime() > 0) {//self.tracking.trackEvent("Ad event", "DFP Video", adEvent.type);
                } else {//self.tracking.trackEvent("Ad event", "DFP", adEvent.type);
                }
                self.spinner.hide();
        ...
        // Add event listeners
        M.adsLoader.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED, M.onAdsManagerLoaded, false);
        M.adsLoader.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, M.onAdError, false);
            ...
            if (M.provider === "dfp") {
                var rules = (function() {
                    ...
                    if (self.lsg.isSamplingAllRules()) {
                        sorted = lsgRules.reverse().sort(self.randomSort).slice(0, 11);
                    } else {
    ...
    module.prototype.getAdTagUrl = function(variant) {
        ...
        M.dfp_custom_params = {
            ...
            ab: "" + variant,
            adcount: M.adcount > 20 ? "gt20" : M.adcount >= 10 ? "" + M.adcount : "0" + M.adcount
        };

        // @see https://support.google.com/dfp_premium/answer/1068325?hl=de
        myAdTagUrl = "https://securepubads.g.doubleclick.net/gampad/ads?npa=[npa]&gdfp_req=1&env=vp&output=xml_vast4&overlay=0&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";

        myAdTagUrl = myAdTagUrl.replace("[npa]", self.config.ads.npa ? "1" : "0");
        ...
        if (M.dfp_custom_params) {
            myAdTagUrl = myAdTagUrl + "&cust_params=" + encodeURIComponent(faZepto.param(M.dfp_custom_params));
        }
...
fg_api.prototype.notifyModule = function() {
    ...
    module.prototype.create = function(options) {
        ...
        if (!M.closing) {
            M.close();
            // close all other windows - it's a 'modal'
        }
    ...
    module.prototype.setScrollAreaHeight = function() {
        ...
        var windowHeight = faZepto(window).height() - padding * 5;
        // 4 = top & bottom padding + top & bottom margin, + top margin for icon
        ...
        if (typeof window.famobi_adapters !== "undefined") {
            for (section in window.famobi_adapters) {
                ...
                for (subsection in window.famobi_adapters[section]) {
                    //self.log(subsection);
                    this.add(section, subsection, window.famobi_adapters[section][subsection]);
                }
            }
        }
    }
...
fg_api.prototype.getUrlParams = function(a, b, c) {
    (a = /[?&]?([^=]+)=([^&]*)/g),
    (b = document.location && document.location.search ? document.location.search.split("+").join(" ") : "");
...
fg_api.prototype.getMoreGamesButtonImage = function(forceAbsolute) {
    ...
    // if (forceAbsolute || (window.location.hostname.indexOf("cdn.famobi.com") === -1 && window.location.hostname.indexOf("dev.famobi.com") === -1)) {
...
fg_api.prototype.highscoresModule = function() {
    ...
    module.prototype.submit = function(level, score, callback) {
        ...
        function listScores(opts) {
            ...
            faZepto(infoDiv).find("a.editNick").each(function() {
            ...
            faZepto(infoDiv).find("a.cancelEditNick").each(function() {
                self.handleClick(this, function() {
                    var $notify = faZepto(".fg-notify");
            ...
            faZepto(infoDiv).find("a.saveNick").each(function() {
                self.handleClick(this, function() {
...
fg_api.prototype.setLiveScore = function() {//this.highscores.setLiveScore(score);
}
;
...
fg_api.prototype.screenshotModule = function() {
    ...
    function initClip() {
        ...
        if (self.config.gameParams.screenshot && self.config.gameParams.screenshot.camera) {
            fgFotoshootOverlay.style.top = "auto";
            //reset css
            fgFotoshootOverlay.style.right = "auto";
            //reset css
    ...
    module.prototype.init = function() {
        ...
        if (!self.config.gameParams.screenshot || !self.config.gameParams.screenshot.active || !self.sizeOf(self.config.gameParams.screenshot.areas)) {
            return false;
        }
    ...
    function cropImage(canvas, area) {
        ...
        ctx.drawImage(image.element, image.slicing.x, image.slicing.y, image.slicing.width, image.slicing.height, image.positionX, image.positionY, image.targetWidth, image.targetHeight);
...
fg_api.prototype.navigationModule = function() {
    ...
    module.prototype._moreGamesLink = function(popup) {
        ...
        if (faZepto("#fg-root .fg-ad-container").height() > 0 || faZepto("#fg-root .fg-click2play").height() > 0) {
            return false;
        }
...
fg_api.prototype.modalModule = function() {
    ...
    module.prototype.init = function() {
        self.iframe.subscribePostMessageListener("modal", "showModalCloseBtn", function() {
            M.showCloseBtn();
    ...
    module.prototype.create = function(options) {
        ...
        if (!M.closing) {
            M.close();
            // close all other window - it's a MODAL
        }
...
fg_api.prototype.iframeModule = function() {
    var self = this, postMessageListeners = {}, M;
    ...
    iframePrototype.show = function(url, options) {
        ...
        self.modal.setContent(self.iframeContainer);
...
fg_api.prototype.orientationModule = function() {
    ...
    M = new module();
    M.init().onorientationchange(function() {//self.log('famobi.onorientationchange: ', self.getOrientation(), window.innerWidth, window.innerHeight);
    });
...
!(function(a, b) {
    var famobi_analytics = {
        stats: {},
        // params for achivements etc. - custom key-value pairs
        events: [],
        // list of logged events, for debugging purposes
        currentScreen: "",
        pageTitle: "",
        ...
        trackStats: function(key, value) {
            return new Promise(function(resolve, reject) {
                ...
                var statsValidator = function() {
                    // eslint-disable-next-line no-unused-vars
                    for (var k in values) {
                        var testKey = typeof key === "string" && key.length && key.length <= 42 && key.match(/^[a-z_0-9]+$/);
                        if (!testKey) {
                ...
                var updateKey = function(key, value) {
                    if (typeof key === "string" && key.length) {
                        if (key in famobi_analytics.stats && (typeof value === "undefined" || value === null)) {
        ...
        // custom, use pageTitle to differentiate
        SCREEN_BONUS: "SCREEN_BONUS",
        // bonus screen, e.g. extra chance
        SCREEN_CHARACTER: "SCREEN_CHARACTER",
        // Select character
        SCREEN_CREDITS: "SCREEN_CREDITS",
        // credits screen, if used
        SCREEN_GAMERESULT: "SCREEN_GAMERESULT",
        // result screen with total score (game over)
        SCREEN_HELP: "SCREEN_HELP",
        // help screen
        SCREEN_HOME: "SCREEN_HOME",
        // home screen (start screen)
        SCREEN_LEVEL: "SCREEN_LEVEL",
        // level screen while playing
        SCREEN_LEVELINTRO: "SCREEN_LEVELINTRO",
        // level has not yet begun (optional)
        SCREEN_LEVELLOADING: "SCREEN_LEVELLOADING",
        // level is loading (optional)
        SCREEN_LEVELRESULT: "SCREEN_LEVELRESULT",
        // result screen with level score
        SCREEN_LEVELSELECT: "SCREEN_LEVELSELECT",
        // level select screen
        SCREEN_PAUSE: "SCREEN_PAUSE",
        // pause screen
        SCREEN_SETTINGS: "SCREEN_SETTINGS",
        // settings screen (advanced game settings)
        SCREEN_SHOP: "SCREEN_SHOP",
        // when the game features an ingame shop, use pageTitle to differentiate between items
        SCREEN_SPLASH: "SCREEN_SPLASH",
        // splash screen, if used
        SCREEN_TUTORIAL: "SCREEN_TUTORIAL",
        // tutorial screen(s), use pageTitle to differentiate between multiple tutorial screens
...
fg_api.prototype.firebaseModule = function() {
    ...
    module.prototype.initializeFirebase = function() {
        ...
        M.promise = new Promise(function(resolve, reject) {
            ...
            faZepto.getScript("v1/firebase-app.js", function() {
                faZepto.getScript("v1/firebase-database.js", function() {
                    // Initialize Firebase
                    var config = {
        ...
        return new Promise(function(resolve, reject) {
            ...
            self.firebase.isReady().then(function() {
                M.getRules().then(function() {
                    var nbRules = 11;
                    var bestRulesRef = M.getDynamicRulesRef().orderByChild("amount_req_ecpm").limitToLast(nbRules);

                    Promise.all([bestRulesRef.once("value")]).then(function(snapshots) {
...
fg_api.prototype.gametranslationModule = function() {
    ...
    module.prototype.getGameTranslations = function() {
        ...
        i18n.current = faZepto.extend({}, i18n["default"], i18n[self.config.aid + ".default"], i18n[lang], i18n[self.config.aid + "." + lang]);
...
fg_api.prototype.gameModule = function() {
    ...
    gamePrototype.pause = function() {
        ...
        try {
            ...
            // CreateJS <3
            if (typeof window.createjs !== "undefined") {//window.createjs.Sound.setMute(true);
            }
        } catch (e) {
    ...
    gamePrototype.resume = function() {
        ...
        try {
            ...
            // CreateJS <3
            if (typeof window.createjs !== "undefined") {//window.createjs.Sound.setMute(false);
            }
        } catch (e) {
...
fg_api.prototype.flashModule = function() {
    ...
    flashPrototype.init = function() {
        ...
        if (!self.config.gameParams.flash)
            return false;
        ...
        for (var key in arr) {
            if (!self.config.gameParams.flash[arr[key]])
                break;
        ...
        //self.log("Go!");
        window.famobi_gameJS = window.famobi_gameJS || [];
        window.famobi_gameJS.unshift("/flashgames/swfobject/swfobject.js", function() {
...
fg_api.prototype.videoadsModule = function() {
    ...
    module.prototype.init = function() {
        ...
        switch (M.provider) {
        default:
            faZepto.getScript("https://imasdk.googleapis.com/js/sdkloader/ima3.js", sdkLoadedCallback, function() {
                sdkLoadedCallback();
            });
    ...
    module.prototype.getAdTagUrl = function() {
        ...
        // @see https://support.google.com/dfp_premium/answer/1068325?hl=de
        myadTagUrl = "https://securepubads.g.doubleclick.net/gampad/ads?npa=1&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";
...
fg_api.prototype.init = function() {
    ...
    Promise.all([self.game.prepare(), loadStylesheet(), loadMoreGamesButton()]).then(onloadCallback).catch(onloadCallback);
