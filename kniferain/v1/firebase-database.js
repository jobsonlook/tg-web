!function(t, e) {
    ...
    try {
        (function() {
            ...
            var t = !1
              ...
              , a = function(t) {
                for (var e = [], n = 0, r = 0; r < t.length; r++) {
                    ...
                    e[n++] = i < 128 ? i : (e[n++] = i < 2048 ? i >> 6 | 192 : (55296 == (64512 & i) && r + 1 < t.length && 56320 == (64512 & t.charCodeAt(r + 1)) ? (i = 65536 + ((1023 & i) << 10) + (1023 & t.charCodeAt(++r)),
                    e[n++] = i >> 18 | 240,
                    e[n++] = i >> 12 & 63 | 128) : e[n++] = i >> 12 | 224,
                    i >> 6 & 63 | 128),
                    63 & i | 128)
                }
                return e
                ...
                init_: function() {
                    if (!this.byteToCharMap_) {
                        ...
                        for (var t = 0; t < this.ENCODED_VALS.length; t++)
                            ...
                            (this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]] = t) >= this.ENCODED_VALS_BASE.length && (this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)] = t,
            ...
            (y.prototype.constructor = y).prototype.name = f;
            var v = function() {
                function t(t, e, n) {
                    this.service = t,
                    this.serviceName = e,
                ...
                return t.prototype.create = function(t, r) {
                    void 0 === r && (r = {});
                    var e, n = this.errors[t], i = this.service + "/" + t;
            ...
            var E = function(t) {
              ...
              , O = function(n) {
                ...
                t.prototype.compress_ = function(t, e) {
                    ...
                    for (r = 0; r < 80; r++) {
                        s = r < 40 ? r < 20 ? (o = l ^ h & (u ^ l),
                        1518500249) : (o = h ^ u ^ l,
                        1859775393) : r < 60 ? (o = h & u | l & (h | u),
                        2400959708) : (o = h ^ u ^ l,
                        3395469782);
              ...
              , k = function(t, e, n, r) {
                var i;
                if (r < e ? i = "at least " + e : n < r && (i = 0 === n ? "none" : "no more than " + n),
                i)
            ...
            function F(t, e, n, r) {
                if ((!r || n) && "function" != typeof n)
                    throw new Error(x(t, e, r) + "must be a valid function.")
            }
            function A(t, e, n, r) {
                if ((!r || n) && ("object" != typeof n || null === n))
                    throw new Error(x(t, e, r) + "must be a valid context object.")
            }
            var L, M, W = function(t) {
                for (var e = 0, n = 0; n < t.length; n++) {
                    var r = t.charCodeAt(n);
                    r < 128 ? e++ : r < 2048 ? e += 2 : 55296 <= r && r <= 56319 ? (e += 4,
                    n++) : e += 3
                }
                return e
            };
            (M = L || (L = {}))[M.DEBUG = 0] = "DEBUG",
            M[M.VERBOSE = 1] = "VERBOSE",
            M[M.INFO = 2] = "INFO",
            M[M.WARN = 3] = "WARN",
            M[M.ERROR = 4] = "ERROR",
            M[M.SILENT = 5] = "SILENT";
            var q, Q = L.INFO, U = function(t, e) {
                ...
                return new B
            }, K = j("localStorage"), Y = j("sessionStorage"), z = new V("@firebase/database"), G = (q = 1,
            function() {
                return q++
            }
            ), X = function(t) {
                var e = function(t) {
                    for (var e = [], n = 0, r = 0; r < t.length; r++) {
                        ...
                        if (55296 <= i && i <= 56319) {
                            var o = i - 55296;
                            C(++r < t.length, "Surrogate pair missing trail surrogate."),
                            i = 65536 + (o << 10) + (t.charCodeAt(r) - 56320)
                        }
                        e[n++] = i < 128 ? i : (e[n++] = i < 2048 ? i >> 6 | 192 : (e[n++] = i < 65536 ? i >> 12 | 224 : (e[n++] = i >> 18 | 240,
                        i >> 12 & 63 | 128),
                        i >> 6 & 63 | 128),
                        63 & i | 128)
                    }
                ...
                for (var n = "", r = 0; r < t.length; r++)
                    Array.isArray(t[r]) || t[r] && "object" == typeof t[r] && "number" == typeof t[r].length ? n += $.apply(null, t[r]) : "object" == typeof t[r] ? n += m(t[r]) : n += t[r],
                    n += " ";
                return n
            }, J = null, Z = !0, tt = function(t, e) {
                C(!e || !0 === t || !1 === t, "Can't turn on custom loggers persistently."),
                !0 === t ? (z.logLevel = L.VERBOSE,
                J = z.log.bind(z),
                e && Y.set("logging_enabled", !0)) : "function" == typeof t ? J = t : (J = null,
                Y.remove("logging_enabled"))
            }, et = function() {
                for (var t = [], e = 0; e < arguments.length; e++)
                    t[e] = arguments[e];
                if (!0 === Z && (Z = !1,
                null === J && !0 === Y.get("logging_enabled") && tt(!0)),
                J) {
                    var n = $.apply(null, t);
                    J(n)
                }
            ...
            }, at = "[MIN_NAME]", ht = "[MAX_NAME]", ut = function(t, e) {
                if (t === e)
                    return 0;
                if (t === at || e === ht)
                    return -1;
                ...
                var e, n, r, i, o, s, a;
                for (0 === t ? e = 1 / t == -1 / (r = n = 0) ? 1 : 0 : (e = t < 0,
                r = (t = Math.abs(t)) >= Math.pow(2, -1022) ? (n = (i = Math.min(Math.floor(Math.log(t) / Math.LN2), 1023)) + 1023,
                Math.round(t * Math.pow(2, 52 - i) - Math.pow(2, 52))) : (n = 0,
            ...
            }, yt = new RegExp("^-?\\d{1,10}$"), vt = function(t) {
                if (yt.test(t)) {
                    var e = Number(t);
                ...
                try {
                    ...
                    setTimeout(function() {
                        var t = e.stack || "";
                        throw ot("Exception was thrown by user callback.", t),
                        e
                    }, Math.floor(0))
                }
            }, mt = function(t, e) {
                ...
                function i(t, e) {
                    if (void 0 === e) {
                        ...
                        for (var n = 0, r = 0; r < this.pieces_.length; r++)
                            0 < this.pieces_[r].length && (this.pieces_[n] = this.pieces_[r],
                            n++);
                ...
                i.prototype.popFront = function() {
                    ...
                    return t < this.pieces_.length && t++,
                    new i(this.pieces_,t)
                }
                ,
                ...
                i.relativePath = function(t, e) {
                    ...
                    if (null === n)
                        return e;
                    if (n === r)
                        return i.relativePath(t.popFront(), e.popFront());
                ...
                function t(t, e) {
                    ...
                    for (var n = 0; n < this.parts_.length; n++)
                        this.byteLength_ += W(this.parts_[n]);
                    this.checkValid_()
                }
                ...
                ,
                t
            }(), wt = "firebaseio.com", bt = "websocket", St = "long_polling", Tt = function() {
                function t(t, e, n, r, i) {
                    ...
                    this.internalHost = K.get("host:" + t) || this.host
                }
                ...
                t.prototype.updateHost = function(t) {
                    ...
                    this.isCacheableHost() && K.set("host:" + this.host, this.internalHost))
                }
                ,
                t.prototype.connectionURL = function(t, e) {
                    var n;
                    if (C("string" == typeof t, "typeof type must == string"),
                    C("object" == typeof e, "typeof params must == object"),
                    t === bt)
            ...
            var It, Nt, Rt, Pt, Dt, Ot = function(t) {
                var e = kt(t)
                  , n = e.subdomain;
                "firebase" === e.domain && it(e.host + " is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),
                n && "undefined" != n || "localhost" === e.domain || it("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),
                e.secure || "undefined" != typeof window && window.location && window.location.protocol && -1 !== window.location.protocol.indexOf("https:") && ot("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");
            ...
            }, xt = /[\[\].#$\/\u0000-\u001F\u007F]/, Ft = /[\[\].#$\u0000-\u001F\u007F]/, At = 10485760, Lt = function(t) {
                ...
                if ("function" == typeof t)
                    throw new Error(n + "contains a function " + r.toErrorString() + " with contents = " + t.toString());
                if (st(t))
                    throw new Error(n + "contains " + t.toString() + " " + r.toErrorString());
                if ("string" == typeof t && t.length > At / 3 && W(t) > At)
                    throw new Error(n + "contains a string greater than " + At + " utf8 bytes " + r.toErrorString() + " ('" + t.substring(0, 50) + "...')");
                ...
                if (!r || void 0 !== n) {
                    if (st(n))
                        throw new Error(x(t, e, r) + "is " + n.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
                    if (!Wt(n))
                        throw new Error(x(t, e, r) + "must be a valid Firebase priority (a string, finite number, server value, or null).")
                }
            }, Ht = function(t, e, n, r) {
                if (!r || void 0 !== n)
                    switch (n) {
                ...
                if (!(r && void 0 === n || Lt(n)))
                    throw new Error(x(t, e, r) + 'was an invalid key = "' + n + '".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").')
            }, jt = function(t, e, n, r) {
                if (!(r && void 0 === n || Mt(n)))
                    throw new Error(x(t, e, r) + 'was an invalid path = "' + n + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')
            }, Kt = function(t, e) {
                if (".info" === e.getFront())
                    throw new Error(t + " failed = Can't modify data under /.info/")
            }, Yt = function(t, e, n) {
                var r, i = n.path.toString();
                if ("string" != typeof n.repoInfo.host || 0 === n.repoInfo.host.length || !Lt(n.repoInfo.namespace) && "localhost" !== n.repoInfo.host.split(":")[0] || 0 !== i.length && ((r = i) && (r = r.replace(/^\/*\.info(\/|$)/, "/")),
                !Mt(r)))
                    throw new Error(x(t, e, !1) + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')
            }, zt = function() {
                function t(t, e) {
                    this.repo_ = t,
                    this.path_ = e
                ...
                t.prototype.setWithPriority = function(t, e, n) {
                    k("OnDisconnect.setWithPriority", 2, 3, arguments.length),
                    Kt("OnDisconnect.setWithPriority", this.path_),
                    qt("OnDisconnect.setWithPriority", 1, t, this.path_, !1),
                    Vt("OnDisconnect.setWithPriority", 2, e, !1),
                    F("OnDisconnect.setWithPriority", 3, n, !0);
                    var r = new l;
                ...
                ,
                t.prototype.update = function(t, e) {
                    if (k("OnDisconnect.update", 1, 2, arguments.length),
                    Kt("OnDisconnect.update", this.path_),
                    Array.isArray(t)) {
                        for (var n = {}, r = 0; r < t.length; ++r)
                            n["" + r] = t[r];
                        t = n,
                        ot("Passing an Array to firebase.database.onDisconnect().update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")
                    }
                    Ut("OnDisconnect.update", 1, t, this.path_, !1),
                    F("OnDisconnect.update", 2, e, !0);
                    var i = new l;
                ...
                ,
                t
            }(), Xt = (It = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",
            Nt = 0,
            Rt = [],
            function(t) {
                var e, n = t === Nt;
                ...
                var i = r.join("");
                if (n) {
                    for (e = 11; 0 <= e && 63 === Rt[e]; e--)
                        Rt[e] = 0;
                    Rt[e]++
                } else
                    for (e = 0; e < 12; e++)
                        Rt[e] = Math.floor(64 * Math.random());
                for (e = 0; e < 12; e++)
                    i += It.charAt(Rt[e]);
                return C(20 === i.length, "nextPushId: Length should be 20."),
                i
            }
            ), $t = function() {
                function n(t, e) {
                ...
                e.prototype.makePost = function(t, e) {
                    return C("string" == typeof t, "KeyIndex indexValue must always be a string."),
                    new $t(t,Pt)
                }
                ,
            ...
            var ee, ne, re, ie = function(t) {
                ...
                if (t.isLeafNode()) {
                    ...
                    C(t === Dt || t.isEmpty(), "priority of unexpected type.");
                C(t === Dt || t.getPriority().isEmpty(), "Priority nodes can't have a priority of their own.")
            }, se = function() {
                function o(t, e) {
                    void 0 === e && (e = o.__childrenNodeConstructor.EMPTY_NODE),
                    this.value_ = t,
                ...
                o.prototype.updateChild = function(t, e) {
                    var n = t.getFront();
                    return null === n ? e : e.isEmpty() && ".priority" !== n ? this : (C(".priority" !== n || 1 === t.getLength(), ".priority must be the last token in a path"),
                    this.updateImmediateChild(n, o.__childrenNodeConstructor.EMPTY_NODE.updateChild(t.popFront(), e)))
                }
                ,
                ...
                o.prototype.hash = function() {
                    if (null === this.lazyHash_) {
                        ...
                        t += e + ":",
                        t += "number" === e ? _t(this.value_) : this.value_,
                        this.lazyHash_ = X(t)
                    }
                ...
                o.prototype.compareTo = function(t) {
                    return t === o.__childrenNodeConstructor.EMPTY_NODE ? 1 : t instanceof o.__childrenNodeConstructor ? -1 : (C(t.isLeafNode(), "Unknown node type"),
                ...
                o.prototype.compareToLeafNode_ = function(t) {
                    ...
                    return C(0 <= r, "Unknown leaf type: " + e),
                    C(0 <= i, "Unknown leaf type: " + n),
                    r === i ? "object" === n ? 0 : this.value_ < t.value_ ? -1 : this.value_ === t.value_ ? 0 : 1 : i - r
                }
                ,
                ...
                ,
                o.VALUE_TYPE_ORDER = ["object", "boolean", "number", "string"],
                o
            }();
            var ae, he, ue = new (function(t) {
                ...
                function o(t, e, n, r, i) {
                    this.key = t,
                    this.value = e,
                    this.color = null != n ? n : o.RED,
                    this.left = null != r ? r : de.EMPTY_NODE,
                    this.right = null != i ? i : de.EMPTY_NODE
                }
                ...
                n.EMPTY_NODE = new pe,
                n
            }(), fe = Math.log(2), _e = function() {
                function t(t) {
                    var e;
                    this.count = (e = t + 1,
                    parseInt(Math.log(e) / fe, 10)),
                ...
                var c = function(t, e) {
                    ...
                    if (1 == i)
                        return n = u[t],
                        r = l ? l(n) : n,
                        new ce(r,n.node,ce.BLACK,null,null);
                    var o = parseInt(i / 2, 10) + t
                      , s = c(t, o)
                      , a = c(o + 1, e);
                    return n = u[o],
                    r = l ? l(n) : n,
                    new ce(r,n.node,ce.BLACK,s,a)
                }
                  , n = function(t) {
                ...
                return Object.defineProperty(c, "Default", {
                    get: function() {
                        return C(ue, "ChildrenNode.ts has not been loaded"),
                        ae = ae || new c({
                            ".priority": ve
                        },{
                            ".priority": ue
                ...
                c.prototype.addIndex = function(t, e) {
                    ...
                    for (var n, r = [], i = !1, o = e.getIterator($t.Wrap), s = o.getNext(); s; )
                ...
                c.prototype.addToIndexes = function(h, u) {
                    ...
                    return new c(R(this.indexes_, function(t, e) {
                        ...
                        if (C(n, "Missing index implementation for " + e),
                        t === ve) {
                            if (n.isDefinedOn(h.node)) {
                                for (var r = [], i = u.getIterator($t.Wrap), o = i.getNext(); o; )
                        ...
                        var s = u.get(h.name)
                          , a = t;
                        return s && (a = a.remove(new $t(h.name,s))),
                        a.insert(h, h.node)
                    }),this.indexSet_)
                }
                ,
            ...
            var Ee = function() {
                ...
                a.prototype.updateImmediateChild = function(t, e) {
                    if (C(e, "We should always be passing snapshot nodes"),
                    ".priority" === t)
                        return this.updatePriority(e);
                    var n = new $t(t,e)
                      , r = void 0
                      , i = void 0;
                    return i = e.isEmpty() ? (r = this.children_.remove(t),
                    this.indexMap_.removeFromIndexes(n, this.children_)) : (r = this.children_.insert(t, e),
                    this.indexMap_.addToIndexes(n, this.children_)),
                    new a(r,r.isEmpty() ? he : this.priorityNode_,i)
                }
                ,
                ...
                a.prototype.val = function(n) {
                    ...
                    if (this.forEachChild(ue, function(t, e) {
                        r[t] = e.val(n),
                        i++,
                        s && a.INTEGER_REGEXP_.test(t) ? o = Math.max(o, Number(t)) : s = !1
                    }),
                    !n && s && o < 2 * i) {
                        var t = [];
                        for (var e in r)
                    ...
                    return n && !this.getPriority().isEmpty() && (r[".priority"] = this.getPriority().val()),
                    r
                }
                ,
                a.prototype.hash = function() {
                    if (null === this.lazyHash_) {
                        var r = "";
                        this.getPriority().isEmpty() || (r += "priority:" + ie(this.getPriority().val()) + ":"),
                        this.forEachChild(ue, function(t, e) {
                            var n = e.hash();
                            "" !== n && (r += ":" + t + ":" + n)
                        }),
                ...
                a.prototype.getIteratorFrom = function(t, e) {
                    ...
                    for (var r = this.children_.getIteratorFrom(t.name, $t.Wrap), i = r.peek(); null != i && e.compare(i, t) < 0; )
                        r.getNext(),
                        i = r.peek();
                    return r
                }
                ...
                a.prototype.getReverseIteratorFrom = function(t, e) {
                    ...
                    for (var r = this.children_.getReverseIteratorFrom(t.name, $t.Wrap), i = r.peek(); null != i && 0 < e.compare(i, t); )
                        r.getNext(),
                        i = r.peek();
                    return r
                }
                ...
                a.prototype.withIndex = function(t) {
                    if (t === te || this.indexMap_.hasIndex(t))
                        return this;
            ...
            se.__childrenNodeConstructor = Ee,
            Dt = we,
            re = we;
            var be = !0;
            function Se(t, e) {
                ...
                C(null === e || "string" == typeof e || "number" == typeof e || "object" == typeof e && ".sv"in e, "Invalid priority type found: " + typeof e),
                "object" == typeof t && ".value"in t && null !== t[".value"] && (t = t[".value"]),
                "object" != typeof t || ".sv"in t)
                    return new se(t,Se(e));
            ...
            var Te, Ie, Ne, Re = new (function(t) {
                ...
                function t(t) {
                    ...
                    return e.indexPath_ = t,
                    C(!t.isEmpty() && ".priority" !== t.getFront(), "Can't create PathIndex with empty path or .priority key"),
                    e
                }
                return s(t, n),
                t.prototype.extractChild = function(t) {
                ...
                return i.prototype.val = function() {
                    return k("DataSnapshot.val", 0, 0, arguments.length),
                    this.node_.val()
                }
                ,
                i.prototype.exportVal = function() {
                    return k("DataSnapshot.exportVal", 0, 0, arguments.length),
                    this.node_.val(!0)
                }
                ,
                i.prototype.toJSON = function() {
                    return k("DataSnapshot.toJSON", 0, 1, arguments.length),
                    this.exportVal()
                }
                ,
                i.prototype.exists = function() {
                    return k("DataSnapshot.exists", 0, 0, arguments.length),
                    !this.node_.isEmpty()
                }
                ,
                i.prototype.child = function(t) {
                ...
                i.prototype.getPriority = function() {
                    return k("DataSnapshot.getPriority", 0, 0, arguments.length),
                    this.node_.getPriority().val()
                }
                ,
                i.prototype.forEach = function(n) {
                    var r = this;
                    return k("DataSnapshot.forEach", 1, 1, arguments.length),
                    F("DataSnapshot.forEach", 1, n, !1),
                    !this.node_.isLeafNode() && !!this.node_.forEachChild(this.index_, function(t, e) {
                        return n(new i(e,r.ref_.child(t),ue))
                    })
                }
                ,
                i.prototype.hasChildren = function() {
                    return k("DataSnapshot.hasChildren", 0, 0, arguments.length),
                ...
                i.prototype.numChildren = function() {
                    return k("DataSnapshot.numChildren", 0, 0, arguments.length),
                    this.node_.numChildren()
                }
                ,
                i.prototype.getRef = function() {
                    return k("DataSnapshot.ref", 0, 0, arguments.length),
                    this.ref_
                }
                ,
                ...
                i.prototype.matches = function(n) {
                    if (n instanceof i) {
                        if (!this.callbacks_ || !n.callbacks_)
                            return !0;
                ...
                return Object.defineProperty(u, "__referenceConstructor", {
                    get: function() {
                        return C(Te, "Reference.ts has not been loaded"),
                        Te
                    },
                    set: function(t) {
                        Te = t
                ...
                u.validateQueryEndpoints_ = function(t) {
                    ...
                    t.getIndex() === te) {
                        ...
                        if (t.hasStart()) {
                            if (t.getIndexStartName() != at)
                                throw new Error(r);
                            if ("string" != typeof e)
                                throw new Error(i)
                        }
                        if (t.hasEnd()) {
                            if (t.getIndexEndName() != ht)
                                throw new Error(r);
                            if ("string" != typeof n)
                                throw new Error(i)
                        }
                    } else if (t.getIndex() === ue) {
                        if (null != e && !Wt(e) || null != n && !Wt(n))
                            throw new Error("Query: When ordering by priority, the first argument passed to startAt(), endAt(), or equalTo() must be a valid priority value (null, a number, or a string).")
                    } else if (C(t.getIndex()instanceof Pe || t.getIndex() === Re, "unknown index type."),
                ...
                u.prototype.getRef = function() {
                    return k("Query.ref", 0, 0, arguments.length),
                    new u.__referenceConstructor(this.repo,this.path)
                }
                ,
                u.prototype.on = function(t, e, n, r) {
                    ...
                    if ("value" === t)
                        this.onValueEvent(e, i.cancel, i.context);
                    else {
                        var o = {};
                        o[t] = e,
                        this.onChildEvent(o, i.cancel, i.context)
                    }
                    return e
                }
                ,
                ...
                u.prototype.off = function(t, e, n) {
                    ...
                    var r = null
                      , i = null;
                    "value" === t ? r = new xe(e || null,null,n || null) : t && (e && ((i = {})[t] = e),
                    r = new Fe(i,null,n || null));
                ...
                u.prototype.limitToFirst = function(t) {
                    if (k("Query.limitToFirst", 1, 1, arguments.length),
                ...
                u.prototype.limitToLast = function(t) {
                    if (k("Query.limitToLast", 1, 1, arguments.length),
                    "number" != typeof t || Math.floor(t) !== t || t <= 0)
                ...
                u.prototype.orderByChild = function(t) {
                    if (k("Query.orderByChild", 1, 1, arguments.length),
                    "$key" === t)
                    ...
                    return u.validateQueryEndpoints_(r),
                    new u(this.repo,this.path,r,!0)
                }
                ,
                u.prototype.orderByKey = function() {
                    ...
                    return u.validateQueryEndpoints_(t),
                    new u(this.repo,this.path,t,!0)
                }
                ,
                ...
                u.prototype.startAt = function(t, e) {
                    ...
                    if (u.validateLimit_(n),
                    u.validateQueryEndpoints_(n),
                    this.queryParams_.hasStart())
                        throw new Error("Query.startAt: Starting point was already set (by another call to startAt or equalTo).");
                    return void 0 === t && (e = t = null),
                    new u(this.repo,this.path,n,this.orderByCalled_)
                }
                ,
                ...
                u.prototype.equalTo = function(t, e) {
                    if (k("Query.equalTo", 1, 2, arguments.length),
                ...
                u.prototype.toString = function() {
                    return k("Query.toString", 0, 0, arguments.length),
                    this.repo.toString() + this.path.toUrlEncodedString()
                }
                ,
                u.prototype.toJSON = function() {
                    return k("Query.toJSON", 0, 1, arguments.length),
                    this.toString()
                }
                ,
                ...
                u.prototype.isEqual = function(t) {
                    if (k("Query.isEqual", 1, 1, arguments.length),
                    !(t instanceof u)) {
                    ...
                    if (e && n)
                        ...
                        if ("object" == typeof e && null !== e)
                            ...
                            if ("function" != typeof e)
                                throw new Error(x(t, 3, !0) + " must either be a cancel callback or a context object.");
                            r.cancel = e
                        }
                    return r
                }
                ...
                i.prototype.remember = function(t, e) {
                    if (t.isEmpty())
                        ...
                        this.value_ = this.value_.updateChild(t, e);
                    else {
                ...
                i.prototype.forget = function(t) {
                    ...
                    var r = t.getFront();
                    return t = t.popFront(),
                    this.children_.contains(r) && this.children_.get(r).forget(t) && this.children_.remove(r),
                    !!this.children_.isEmpty() && !(this.children_ = null)
                }
                ,
                ...
                return t && "object" == typeof t ? (C(".sv"in t, "Unexpected leaf node or priority contents"),
                e[t[".sv"]]) : t
            }, qe = function(t, r) {
                var i, e = t.getPriority().val(), n = We(e, r);
                if (t.isLeafNode()) {
                    var o = t
                      , s = We(o.getValue(), r);
                ...
                var a = t;
                return n !== (i = a).getPriority().val() && (i = i.updatePriority(new se(n))),
                a.forEachChild(ue, function(t, e) {
                    var n = qe(e, r);
                    n !== e && (i = i.updateImmediateChild(t, n))
                }),
                i
            };
            (Ne = Ie || (Ie = {}))[Ne.OVERWRITE = 0] = "OVERWRITE",
            Ne[Ne.MERGE = 1] = "MERGE",
            Ne[Ne.ACK_USER_WRITE = 2] = "ACK_USER_WRITE",
            Ne[Ne.LISTEN_COMPLETE = 3] = "LISTEN_COMPLETE";
            var Qe, Ue, Ve = function() {
                ...
                return e.User = new e(!0,!1,null,!1),
                ...
                function n(t, e, n) {
                    ...
                    this.affectedTree = e,
                    this.revert = n,
                    this.type = Ie.ACK_USER_WRITE,
                    this.source = Ve.User
                }
                return n.prototype.operationForChild = function(t) {
                    if (this.path.isEmpty()) {
                        if (null != this.affectedTree.value)
                            return C(this.affectedTree.children.isEmpty(), "affectedTree should not have overlapping affected paths."),
                            this;
                        var e = this.affectedTree.subtree(new Ct(t));
                        return new n(Ct.Empty,e,this.revert)
                    }
                    return C(this.path.getFront() === t, "operationForChild called for unrelated child."),
                    new n(this.path.popFront(),this.affectedTree,this.revert)
                }
                ,
                n
            }(), Be = function() {
                function o(t, e) {
                    void 0 === e && (Qe || (Qe = new de(lt)),
                    e = Qe),
                    this.value = t,
                    this.children = e
                }
                ...
                o.prototype.remove = function(t) {
                    if (t.isEmpty())
                        return this.children.isEmpty() ? o.Empty : new o(null,this.children);
                    var e = t.getFront()
                      , n = this.children.get(e);
                    if (n) {
                        var r = n.remove(t.popFront())
                          , i = void 0;
                        return i = r.isEmpty() ? this.children.remove(e) : this.children.insert(e, r),
                        null === this.value && i.isEmpty() ? o.Empty : new o(this.value,i)
                    }
                    return this
                }
                ,
                ...
                return n.prototype.operationForChild = function(t) {
                    ...
                    return C(this.path.getFront() === t, "Can't get a merge for a child not on the path of the operation"),
                    new n(this.source,this.path.popFront(),this.children)
                }
                ,
                ...
                ,
                r.Empty = new r(new ze(Ee.EMPTY_NODE,!1,!1),new ze(Ee.EMPTY_NODE,!1,!1)),
                r
            }(), Xe = function() {
                ...
                ,
                r.CHILD_ADDED = "child_added",
                r.CHILD_REMOVED = "child_removed",
                r.CHILD_CHANGED = "child_changed",
                r.CHILD_MOVED = "child_moved",
                r.VALUE = "value",
                r
            }(), $e = function() {
                function t(t) {
                ...
                return t.prototype.updateChild = function(t, e, n, r, i, o) {
                    ...
                    return s.getChild(r).equals(n.getChild(r)) && s.isEmpty() == n.isEmpty() ? t : (null != o && (n.isEmpty() ? t.hasChild(e) ? o.trackChildChange(Xe.childRemovedChange(e, s)) : C(t.isLeafNode(), "A child remove without an old child only makes sense on a leaf node") : s.isEmpty() ? o.trackChildChange(Xe.childAddedChange(e, n)) : o.trackChildChange(Xe.childChangedChange(e, n, s))),
                ...
                t.prototype.updateFullNode = function(r, n, i) {
                    ...
                    n.isLeafNode() || n.forEachChild(ue, function(t, e) {
                        if (r.hasChild(t)) {
                            ...
                            i.trackChildChange(Xe.childAddedChange(t, e))
                    })),
                ...
                return t.prototype.trackChildChange = function(t) {
                    var e = t.type
                      , n = t.childName;
                    C(e == Xe.CHILD_ADDED || e == Xe.CHILD_CHANGED || e == Xe.CHILD_REMOVED, "Only child changes supported for tracking"),
                    C(".priority" !== n, "Only non-priority child changes can be tracked.");
                    var r = b(this.changeMap_, n);
                    if (r) {
                        var i = r.type;
                        if (e == Xe.CHILD_ADDED && i == Xe.CHILD_REMOVED)
                            this.changeMap_[n] = Xe.childChangedChange(n, t.snapshotNode, r.snapshotNode);
                        else if (e == Xe.CHILD_REMOVED && i == Xe.CHILD_ADDED)
                            delete this.changeMap_[n];
                        else if (e == Xe.CHILD_REMOVED && i == Xe.CHILD_CHANGED)
                            this.changeMap_[n] = Xe.childRemovedChange(n, r.oldSnap);
                        else if (e == Xe.CHILD_CHANGED && i == Xe.CHILD_ADDED)
                            this.changeMap_[n] = Xe.childAddedChange(n, t.snapshotNode);
                        else {
                            if (e != Xe.CHILD_CHANGED || i != Xe.CHILD_CHANGED)
                                throw p("Illegal combination of changes: " + t + " occurred after " + r);
                ...
                return c.prototype.assertIndexed = function(t) {
                    C(t.getEventCache().getNode().isIndexed(this.filter_.getIndex()), "Event snap not indexed"),
                    C(t.getServerCache().getNode().isIndexed(this.filter_.getIndex()), "Server snap not indexed")
                }
                ,
                c.prototype.applyOperation = function(t, e, n, r) {
                    ...
                    if (e.type === Ie.OVERWRITE) {
                        var a = e;
                        i = a.source.fromUser ? this.applyUserOverwrite_(t, a.path, a.snap, n, r, s) : (C(a.source.fromServer, "Unknown source."),
                        o = a.source.tagged || t.getServerCache().isFiltered() && !a.path.isEmpty(),
                        this.applyServerOverwrite_(t, a.path, a.snap, n, r, o, s))
                    } else if (e.type === Ie.MERGE) {
                        var h = e;
                        i = h.source.fromUser ? this.applyUserMerge_(t, h.path, h.children, n, r, s) : (C(h.source.fromServer, "Unknown source."),
                        o = h.source.tagged || t.getServerCache().isFiltered(),
                        this.applyServerMerge_(t, h.path, h.children, n, r, o, s))
                        ...
                        if (e.type !== Ie.LISTEN_COMPLETE)
                            throw p("Unknown operation type: " + e.type);
                        i = this.listenComplete_(t, e.path, n, s)
                    }
                    var l = s.getChanges();
                    return c.maybeAddValueEvent_(t, i, l),
                    new en(i,l)
                }
                ,
                ...
                c.prototype.generateEventCacheAfterServerEvent_ = function(t, e, n, r, i) {
                    ...
                    var s = void 0
                      , a = void 0;
                    if (e.isEmpty())
                        if (C(t.getServerCache().isFullyInitialized(), "If change path is empty, we must have complete server data"),
                ...
                c.prototype.applyUserOverwrite_ = function(t, e, n, r, i, o) {
                    var s, a, h = t.getEventCache(), u = new tn(r,t,i);
                    if (e.isEmpty())
                ...
                c.prototype.applyServerMerge_ = function(o, t, e, s, a, h, u) {
                    var l = this;
                    if (o.getServerCache().getNode().isEmpty() && !o.getServerCache().isFullyInitialized())
                        return o;
                    var n, c = o;
                ...
                c.prototype.ackUserWrite_ = function(t, r, e, n, i, o) {
                    if (null != n.shadowingWrite(r))
                        return t;
                    var s = t.getServerCache().isFiltered()
                      , a = t.getServerCache();
                    if (null != e.value) {
                        if (r.isEmpty() && a.isFullyInitialized() || a.isCompleteForPath(r))
                            return this.applyServerOverwrite_(t, r, a.getNode().getChild(r), n, i, s, o);
                        if (r.isEmpty()) {
                            var h = Be.Empty;
                ...
                c.prototype.revertUserWrite_ = function(t, e, n, r, i) {
                    ...
                    if (e.isEmpty() || ".priority" === e.getFront()) {
                        ...
                        if (t.getServerCache().isFullyInitialized())
                            u = n.calcCompleteEventCache(t.getCompleteServerSnap());
                        else {
                            var l = t.getServerCache().getNode();
                            C(l instanceof Ee, "serverChildren would be complete if leaf node"),
                            u = n.calcCompleteEventChildren(l)
                        }
                        u = u,
                        h = this.filter_.updateFullNode(a, u, i)
                    } else {
                        var c = e.getFront()
                          , p = n.calcCompleteChild(c, t.getServerCache());
                        null == p && t.getServerCache().isCompleteForChild(c) && (p = a.getImmediateChild(c)),
                        (h = null != p ? this.filter_.updateChild(a, c, p, e.popFront(), s, i) : t.getEventCache().getNode().hasChild(c) ? this.filter_.updateChild(a, c, Ee.EMPTY_NODE, e.popFront(), s, i) : a).isEmpty() && t.getServerCache().isFullyInitialized() && (o = n.calcCompleteEventCache(t.getCompleteServerSnap())).isLeafNode() && (h = this.filter_.updateFullNode(h, o, i))
                    }
                    return o = t.getServerCache().isFullyInitialized() || null != n.shadowingWrite(Ct.Empty),
                ...
                return t.prototype.generateEventsForChanges = function(t, e, n) {
                    ...
                    this.generateEventsForType_(i, Xe.CHILD_REMOVED, t, n, e),
                    this.generateEventsForType_(i, Xe.CHILD_ADDED, t, n, e),
                    this.generateEventsForType_(i, Xe.CHILD_MOVED, o, n, e),
                    this.generateEventsForType_(i, Xe.CHILD_CHANGED, t, n, e),
                    this.generateEventsForType_(i, Xe.VALUE, t, n, e),
                    i
                }
                ,
                ...
                t.prototype.compareChanges_ = function(t, e) {
                    if (null == t.childName || null == e.childName)
                        throw p("Should only compare child_ events.");
                ...
                t.prototype.applyOperation = function(t, e, n) {
                    t.type === Ie.MERGE && null !== t.source.queryId && (C(this.viewCache_.getCompleteServerSnap(), "We should always have a full cache before handling merges"),
                    C(this.viewCache_.getCompleteEventSnap(), "Missing event cache, even though we have a server cache"));
                ...
                t.prototype.getInitialEvents = function(t) {
                    ...
                    return e.isFullyInitialized() && n.push(Xe.valueChange(e.getNode())),
                ...
                return Object.defineProperty(u, "__referenceConstructor", {
                    get: function() {
                        return C(Ue, "Reference.ts has not been loaded"),
                        Ue
                    },
                    set: function(t) {
                        C(!Ue, "__referenceConstructor has already been defined"),
                        Ue = t
                    },
                    enumerable: !0,
                    configurable: !0
                ...
                u.prototype.applyOperation = function(n, r, i) {
                    ...
                    if (null !== t) {
                        ...
                        return C(null != e, "SyncTree gave us an op for an invalid query."),
                        e.applyOperation(n, r, i)
                    }
                    var o = [];
                ...
                u.prototype.addEventRegistration = function(t, e, n, r, i) {
                    ...
                    if (!s) {
                        var a = n.calcCompleteEventCache(i ? r : null)
                          , h = !1;
                        h = !!a || (a = r instanceof Ee ? n.calcCompleteEventChildren(r) : Ee.EMPTY_NODE,
                        !1);
                ...
                u.prototype.removeEventRegistration = function(t, n, r) {
                    ...
                    if ("default" === e) {
                        ...
                        S(this.views_, function(t, e) {
                            o = o.concat(e.removeEventRegistration(n, r)),
                            e.isEmpty() && (delete a.views_[t],
                            e.getQuery().getQueryParams().loadsAllData() || i.push(e.getQuery()))
                        })
                    } else {
                        var h = b(this.views_, e);
                        h && (o = o.concat(h.removeEventRegistration(n, r)),
                        h.isEmpty() && (delete this.views_[e],
                        h.getQuery().getQueryParams().loadsAllData() || i.push(h.getQuery())))
                    }
                ...
                return a.prototype.addWrite = function(t, e) {
                    if (t.isEmpty())
                        return new a(new Be(e));
                    var n = this.writeTree_.findRootMostValueAndPath(t);
                    if (null != n) {
                        var r = n.path
                          , i = n.value
                          , o = Ct.relativePath(r, t);
                        return i = i.updateChild(o, e),
                        new a(this.writeTree_.set(r, i))
                    }
                    var s = new Be(e);
                ...
                ,
                a.Empty = new a(new Be(null)),
                a.applySubtreeWrite_ = function(n, t, r) {
                    if (null != t.value)
                        return r.updateChild(n, t.value);
                    var i = null;
                    return t.children.inorderTraversal(function(t, e) {
                        ".priority" === t ? (C(null !== e.value, "Priority writes must always be leaf nodes"),
                        i = e.value) : r = a.applySubtreeWrite_(n.child(t), e, r)
                    }),
                    r.getChild(n).isEmpty() || null === i || (r = r.updateChild(n.child(".priority"), i)),
                    r
                }
                ,
                a
                ...
                u.prototype.removeWrite = function(e) {
                    ...
                    for (var i = r.visible, o = !1, s = this.allWrites_.length - 1; i && 0 <= s; ) {
                        ...
                        a.visible && (t <= s && this.recordContainsPath_(a, r.path) ? i = !1 : r.path.contains(a.path) && (o = !0)),
                        s--
                    }
                    if (i) {
                        if (o)
                ...
                u.prototype.calcCompleteEventChildren = function(t, e) {
                    ...
                    if (n)
                        return n.isLeafNode() || n.forEachChild(ue, function(t, e) {
                ...
                u.prototype.calcIndexedSlice = function(t, e, n, r, i, o) {
                    var s, a = this.visibleWrites_.childCompoundWrite(t), h = a.getCompleteNode(Ct.Empty);
                    if (null != h)
                        s = h;
                    else {
                        if (null == e)
                ...
                u.prototype.resetTree_ = function() {
                    this.visibleWrites_ = u.layerTree_(this.allWrites_, u.DefaultFilter_, Ct.Empty),
                    0 < this.allWrites_.length ? this.lastWriteId_ = this.allWrites_[this.allWrites_.length - 1].writeId : this.lastWriteId_ = -1
                }
                ,
                    ...
                    for (var r = an.Empty, i = 0; i < t.length; ++i) {
                        ...
                        if (e(o)) {
                            var s = o.path
                              , a = void 0;
                            if (o.snap)
                                n.contains(s) ? (a = Ct.relativePath(n, s),
                                r = r.addWrite(a, o.snap)) : s.contains(n) && (a = Ct.relativePath(s, n),
                                r = r.addWrite(Ct.Empty, o.snap.getChild(a)));
                            else {
                                if (!o.children)
                                    throw p("WriteRecord should have .snap or .children");
                                if (n.contains(s))
                                    a = Ct.relativePath(n, s),
                                    r = r.addWrites(a, o.children);
                                else if (s.contains(n))
                                    if ((a = Ct.relativePath(s, n)).isEmpty())
                                        r = r.addWrites(Ct.Empty, o.children);
                                    else {
                ...
                function v(t) {
                    ...
                    this.syncPointTree_ = Be.Empty,
                    this.pendingWriteTree_ = new hn,
                    this.tagToQueryMap_ = {},
                    this.queryToTagMap_ = {}
                }
                return v.prototype.applyUserOverwrite = function(t, e, n, r) {
                    return this.pendingWriteTree_.addOverwrite(t, e, n, r),
                    r ? this.applyOperationToSyncPoints_(new Ke(Ve.User,t,e)) : []
                }
                ,
                ...
                v.prototype.addEventRegistration = function(t, e) {
                    ...
                    i = i || s.getCompleteServerCache(Ct.Empty)) : (s = new sn,
                    ...
                    if (!a && !t.getQueryParams().loadsAllData()) {
                        ...
                        this.queryToTagMap_[h] = u,
                        this.tagToQueryMap_["_" + u] = h
                    }
                ...
                v.prototype.removeTags_ = function(t) {
                    for (var e = 0; e < t.length; ++e) {
                        ...
                        if (!n.getQueryParams().loadsAllData()) {
                            ...
                            delete this.queryToTagMap_[r],
                            delete this.tagToQueryMap_["_" + i]
                        }
                    }
                }
                ,
                ...
                v.prototype.setupListener_ = function(t, e) {
                    ...
                    if (r)
                        C(!s.value.hasCompleteView(), "If we're adding a query, it shouldn't be shadowed");
                    else
                ...
                v.prototype.createListenerForView_ = function(t) {
                    ...
                    return {
                        ...
                        onComplete: function(t) {
                            if ("ok" === t)
                                return i ? n.applyTaggedListenComplete(r.path, i) : n.applyListenComplete(r.path);
                            var e = function(t, e) {
                                var n = "Unknown Error";
                ...
                v.prototype.applyOperationDescendantsHelper_ = function(o, t, s, a) {
                    ...
                    e && (u = u.concat(e.applyOperation(o, a, s))),
                    u
                }
                ,
                v.nextQueryTag_ = 1,
                ...
                return t.prototype.getToken = function(t) {
                    return this.app_.INTERNAL.getToken(t).then(null, function(t) {
                        return t && "auth/token-not-initialized" === t.code ? (et("Got auth/token-not-initialized error.  Treating as null token."),
                ...
                return t.prototype.incrementCounter = function(t, e) {
                    void 0 === e && (e = 1),
                    w(this.counters_, t) || (this.counters_[t] = 0),
                    this.counters_[t] += e
                }
                ,
                ...
                return t.getCollection = function(t) {
                    var e = t.toString();
                    return this.collections_[e] || (this.collections_[e] = new dn),
                    this.collections_[e]
                }
                ,
                ...
                t.prototype.reportStats_ = function() {
                    var n = this
                      ...
                      , i = !1;
                    S(t, function(t, e) {
                        0 < e && w(n.statsToReport_, t) && (r[t] = e,
                        i = !0)
                    }),
                    i && this.server_.reportStats(r),
                    mt(this.reportStats_.bind(this), Math.floor(2 * Math.random() * 3e5))
                }
                ,
                t
            }(), vn = function() {
                ...
                function t(t) {
                    ...
                    this.listeners_ = {},
                    C(Array.isArray(t) && 0 < t.length, "Requires a non-empty array")
                }
                ...
                function t() {
                    ...
                    return "undefined" != typeof document && void 0 !== document.addEventListener && (void 0 !== document.hidden ? (t = "visibilitychange",
                ...
                t.prototype.getInitialEvent = function(t) {
                    return C("visible" === t, "Unknown event type: " + t),
                    [this.visible_]
                }
                ,
                t
                ...
                function t() {
                    ...
                    return t.online_ = !0,
                    "undefined" == typeof window || void 0 === window.addEventListener || c() || (window.addEventListener("online", function() {
                        t.online_ || (t.online_ = !0,
                        t.trigger("online", !0))
                    }, !1),
                    window.addEventListener("offline", function() {
                        t.online_ && (t.online_ = !1,
                        t.trigger("online", !1))
                    }, !1)),
                    t
                }
                ...
                ,
                t.prototype.getInitialEvent = function(t) {
                    return C("online" === t, "Unknown event type: " + t),
                    [this.online_]
                }
                ,
                ...
                function t(t, e, n, r) {
                    ...
                    this.log_ = nt(t),
                    this.stats_ = fn.getCollection(e),
                ...
                return t.prototype.open = function(t, e) {
                    ...
                    this.myPacketOrderer = new wn(t),
                    this.isClosed_ = !1,
                    this.connectTimeoutTimer_ = setTimeout(function() {
                        o.log_("Timed out trying to connect."),
                        o.onClosed_(),
                        o.connectTimeoutTimer_ = null
                    }, Math.floor(3e4)),
                    function(t) {
                        if (d() || "complete" === document.readyState)
                            t();
                        else {
                            var e = !1
                              , n = function() {
                        ...
                        if (!o.isClosed_) {
                            o.scriptTagHolder = new Sn(function() {
                                ...
                                var n = t[0]
                                  , r = t[1]
                                  , i = t[2];
                                if (o.incrementIncomingBytes_(t),
                                o.scriptTagHolder)
                                    if (o.connectTimeoutTimer_ && (clearTimeout(o.connectTimeoutTimer_),
                                    o.connectTimeoutTimer_ = null),
                                    o.everConnected_ = !0,
                                    "start" == n)
                                        o.id = r,
                                        ...
                                        r ? (o.scriptTagHolder.sendNewPolls = !1,
                                        o.myPacketOrderer.closeAfter(r, function() {
                                            o.onClosed_()
                                        })) : o.onClosed_()
                                    }
                            }
                            ,function() {
                                ...
                                var n = t[0]
                                  , r = t[1];
                                o.incrementIncomingBytes_(t),
                                o.myPacketOrderer.handleResponse(n, r)
                            }
                            ,function() {
                                o.onClosed_()
                            }
                            ...
                            o.scriptTagHolder.uniqueCallbackIdentifier && (t.cb = o.scriptTagHolder.uniqueCallbackIdentifier),
                            t.v = "5",
                            o.transportSessionId && (t.s = o.transportSessionId),
                            o.lastSessionId && (t.ls = o.lastSessionId),
                            !d() && "undefined" != typeof location && location.href && -1 !== location.href.indexOf(wt) && (t.r = "f");
                            var e = o.urlFn(t);
                            o.log_("Connecting via long-poll to " + e),
                            o.scriptTagHolder.addTag(e, function() {})
                        }
                    })
                }
                ,
                ...
                t.prototype.send = function(t) {
                    ...
                    for (var n, r = (n = a(e),
                    h.encodeByteArray(n, !0)), i = dt(r, 1840), o = 0; o < i.length; o++)
                ...
                function s(t, e, n, r) {
                    if (this.onDisconnect = n,
                    this.urlFn = r,
                    this.outstandingRequests = new Le,
                    this.pendingSegs = [],
                    ...
                    d() ? this.doNodeLongPoll(t, n) : setTimeout(function() {
                        try {
                            ...
                            e.onload = e.onreadystatechange = function() {
                                var t = e.readyState;
                                t && "loaded" !== t && "complete" !== t || (e.onload = e.onreadystatechange = null,
                                e.parentNode && e.parentNode.removeChild(e),
                                n())
                            }
                            ,
                            e.onerror = function() {
                                et("Long-poll script failed to load: " + t),
                                r.sendNewPolls = !1,
                                r.close()
                            }
                            ,
            ...
            var In = function() {
                function i(t, e, n, r) {
                    ...
                    this.bytesSent = 0,
                    this.bytesReceived = 0,
                    this.log_ = nt(this.connId),
                    this.stats_ = fn.getCollection(e),
                    this.connURL = i.connectionURL_(e, n, r)
                }
                return i.connectionURL_ = function(t, e, n) {
                    var r = {
                        v: "5"
                    };
                    return !d() && "undefined" != typeof location && location.href && -1 !== location.href.indexOf(wt) && (r.r = "f"),
                    e && (r.s = e),
                    n && (r.ls = n),
                    t.connectionURL(bt, r)
                }
                ,
                i.prototype.open = function(t, e) {
                    ...
                    try {
                        if (d()) {
                            ...
                            this.mySock = new Tn(this.connURL)
                    } catch (t) {
                        this.log_("Error instantiating WebSocket.");
                        var s = t.message || t.data;
                        return s && this.log_(s),
                        void this.onClosed_()
                    }
                ...
                i.prototype.extractFrameCount_ = function(t) {
                    if (C(null === this.frames, "We already have a frame buffer"),
                    t.length <= 6) {
                        var e = Number(t);
                        if (!isNaN(e))
                ...
                i.prototype.sendString_ = function(t) {
                    try {
                        ...
                        this.log_("Exception thrown from WebSocket.send():", t.message || t.data, "Closing connection."),
                        setTimeout(this.onClosed_.bind(this), 0)
                    }
                }
                ,
                i.responsesRequiredToBeHealthy = 2,
                i.healthyTimeout = 3e4,
                i
            }()
              , Nn = function() {
                function i(t) {
                ...
                i.prototype.initTransports_ = function(t) {
                    ...
                    if (t.webSocketOnly && (e || ot("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),
                    n = !0),
                    n)
                        this.transports_ = [In];
                    else {
              ...
              , Rn = function() {
                function t(t, e, n, r, i, o, s) {
                    ...
                    this.state_ = 0,
                    this.log_ = nt("c:" + this.id + ":"),
                    this.transportManager_ = new Nn(e),
                ...
                return t.prototype.start_ = function() {
                    ...
                    0 < i && (this.healthyTimeout_ = mt(function() {
                        ...
                        t.isHealthy_ || (t.conn_ && 102400 < t.conn_.bytesReceived ? (t.log_("Connection exceeded healthy timeout but has received " + t.conn_.bytesReceived + " bytes.  Marking connection healthy."),
                        t.isHealthy_ = !0,
                        t.conn_.markConnectionHealthy()) : t.conn_ && 10240 < t.conn_.bytesSent ? t.log_("Connection exceeded healthy timeout but has sent " + t.conn_.bytesSent + " bytes.  Leaving connection alive.") : (t.log_("Closing unhealthy connection after timeout."),
                        t.close()))
                    }, Math.floor(i)))
                }
                ,
                ...
                t.prototype.disconnReceiver_ = function(e) {
                    var n = this;
                    return function(t) {
                        e === n.conn_ ? n.onConnectionLost_(t) : e === n.secondaryConn_ ? (n.log_("Secondary connection lost."),
                        n.onSecondaryConnectionLost_()) : n.log_("closing an old connection")
                    }
                }
                ,
                ...
                t.prototype.onControl_ = function(t) {
                    ...
                    if ("d"in t) {
                        ...
                        if ("h" === e)
                            ...
                            "s" === e ? this.onConnectionShutdown_(n) : "r" === e ? this.onReset_(n) : "e" === e ? rt("Server Error: " + n) : "o" === e ? (this.log_("got pong on primary."),
                            this.onPrimaryResponse_(),
                            this.sendPingOnPrimaryIfNecessary_()) : rt("Unknown control packet command: " + e)
                    }
                }
                ,
                t.prototype.onHandshake_ = function(t) {
                    ...
                    "5" !== n && ot("Protocol version mismatch detected"),
                ...
                t.prototype.onConnectionLost_ = function(t) {
                    ...
                    this.repoInfo_.isCacheableHost() && (K.remove("host:" + this.repoInfo_.host),
              ...
              , Dn = function(a) {
                function l(t, e, n, r, i, o) {
                    ...
                    s.authOverride_ = o,
                    s.id = l.nextPersistentConnectionId_++,
                    s.log_ = nt("p:" + s.id + ":"),
                    s.interruptReasons_ = {},
                    s.listens_ = {},
                    s.outstandingPuts_ = [],
                    ...
                    return s.scheduleConnect_(0),
                    Cn.getInstance().on("visible", s.onVisible_, s),
                    -1 === t.host.indexOf("fblocal") && En.getInstance().on("online", s.onOnline_, s),
                    s
                }
                return s(l, a),
                l.prototype.sendRequest = function(t, e, n) {
                    ...
                    this.log_(m(i)),
                    C(this.connected_, "sendRequest call when we're not connected not allowed."),
                ...
                l.prototype.listen = function(t, e, n, r) {
                    ...
                    C(!this.listens_[o][i], "listen() called twice for same path/queryId.");
                    var s = {
                        onComplete: r,
                        hashFn: e,
                        query: t,
                ...
                l.prototype.sendListen_ = function(r) {
                    ...
                    r.tag && (t.q = o.queryObject(),
                    t.t = r.tag),
                    t.h = r.hashFn(),
                    this.sendRequest("q", t, function(t) {
                        var e = t.d
                          , n = t.s;
                        l.warnOnListenWarnings_(e, o),
                        (i.listens_[s] && i.listens_[s][a]) === r && (i.log_("listen response", t),
                ...
                l.prototype.reduceReconnectDelayIfAdminCredential_ = function(t) {
                    var e;
                    (t && 40 === t.length || "object" == typeof (e = E(t).claims) && !0 === e.admin) && (this.log_("Admin auth credential detected.  Reducing max reconnect time."),
                ...
                l.prototype.onDataPush_ = function(t, e) {
                    ...
                    "d" === t ? this.onDataUpdate_(e.p, e.d, !1, e.t) : "m" === t ? this.onDataUpdate_(e.p, e.d, !0, e.t) : "c" === t ? this.onListenRevoked_(e.p, e.q) : "ac" === t ? this.onAuthRevoked_(e.s, e.d) : "sd" === t ? this.onSecurityDebugPacket_(e) : rt("Unrecognized action received from server: " + m(t) + "\nAre you using the latest client?")
                }
                ,
                    ...
                    this.shouldReconnect_()) {
                        if (this.visible_) {
                            if (this.lastConnectionEstablishedTime_) {
                                3e4 < (new Date).getTime() - this.lastConnectionEstablishedTime_ && (this.reconnectDelay_ = 1e3),
                    ...
                    if (this.shouldReconnect_()) {
                        ...
                        this.realtime_ = {
                            ...
                            sendRequest: function(t) {
                                C(h, "sendRequest call when we're not connected not allowed."),
                                h.sendRequest(t)
                            }
                        };
                        var t = this.forceTokenRefresh_;
                        this.forceTokenRefresh_ = !1,
                        this.authTokenProvider_.getToken(t).then(function(t) {
                            a ? et("getToken() completed but was canceled") : (et("getToken() completed. Creating connection."),
                            o.authToken_ = t && t.accessToken,
                            h = new Rn(i,o.repoInfo_,e,n,r,function(t) {
                                ot(t + " (" + o.repoInfo_.toString() + ")"),
                ...
                l.prototype.interrupt = function(t) {
                    et("Interrupting connection for reason: " + t),
                ...
                l.prototype.resume = function(t) {
                    et("Resuming connection for reason: " + t),
                    delete this.interruptReasons_[t],
                    I(this.interruptReasons_) && (this.reconnectDelay_ = 1e3,
                    this.realtime_ || this.scheduleConnect_(0))
                }
                ,
                ...
                l.prototype.removeListen_ = function(t, e) {
                    ...
                    return void 0 !== this.listens_[r] ? (n = this.listens_[r][e],
                    delete this.listens_[r][e],
                    0 === N(this.listens_[r]) && delete this.listens_[r]) : n = void 0,
                    n
                }
                ,
                l.prototype.onAuthRevoked_ = function(t, e) {
                    et("Auth token revoked: " + t + "/" + e),
                    this.authToken_ = null,
                    this.forceTokenRefresh_ = !0,
                    this.realtime_.close(),
                    "invalid_token" !== t && "permission_denied" !== t || (this.invalidAuthTokenCount_++,
                    3 <= this.invalidAuthTokenCount_ && (this.reconnectDelay_ = 3e4,
                ...
                l.prototype.sendConnectStats_ = function() {
                    var t = {};
                    t["sdk.js." + tr.SDK_VERSION.replace(/\./g, "-")] = 1,
                    c() ? t["framework.cordova"] = 1 : "object" == typeof navigator && "ReactNative" === navigator.product && (t["framework.reactnative"] = 1),
                    this.reportStats(t)
                }
                ,
                ...
                ,
                l.nextPersistentConnectionId_ = 0,
                l.nextConnectionId_ = 0,
                l
            }(Pn)
              , On = function(i) {
                function u(t, e, n) {
                    var r = i.call(this) || this;
                    return r.repoInfo_ = t,
                    r.onDataUpdate_ = e,
                ...
                return s(u, i),
                u.prototype.reportStats = function(t) {
                    throw new Error("Method not implemented.")
                }
                ,
                u.getListenId_ = function(t, e) {
                    return void 0 !== e ? "tag$" + e : (C(t.getQueryParams().isDefault(), "should have a tag if it's not a default query."),
                    t.path.toString())
                }
                ,
                u.prototype.listen = function(t, e, r, i) {
                    ...
                    this.restRequest_(s + ".json", n, function(t, e) {
                        ...
                        b(o.listens_, a) === h) && i(t ? 401 == t ? "permission_denied" : "rest_error:" + t : "ok", null)
                    })
                }
                ,
                ...
                u.prototype.restRequest_ = function(o, s, a) {
                    ...
                    this.authTokenProvider_.getToken(!1).then(function(t) {
                        ...
                        e && (s.auth = e);
                        var n, r = (h.repoInfo_.secure ? "https://" : "http://") + h.repoInfo_.host + o + "?ns=" + h.repoInfo_.namespace + (n = [],
                        S(s, function(e, t) {
                        ...
                        i.onreadystatechange = function() {
                            if (a && 4 === i.readyState) {
                                ...
                                if (200 <= i.status && i.status < 300) {
                                    ...
                                    401 !== i.status && 404 !== i.status && ot("Got unsuccessful REST response for " + r + " Status: " + i.status),
                                    a(i.status);
                                a = null
                            }
                        }
              ...
              , xn = function() {
                function t(t, e, n) {
                    ...
                    this.eventQueue_ = new vn,
                    this.nextWriteId_ = 1,
                    this.interceptServerDataCallback_ = null,
                    this.onDisconnect_ = new Me,
                    this.persistentConnection_ = null;
                    var r = new pn(n);
                    if (this.stats_ = fn.getCollection(t),
                    e || 0 <= ("object" == typeof window && window.navigator && window.navigator.userAgent || "").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i))
                        this.server_ = new On(this.repoInfo_,this.onDataUpdate_.bind(this),r),
                        ...
                        this.persistentConnection_ = new Dn(this.repoInfo_,this.onDataUpdate_.bind(this),this.onConnectStatus_.bind(this),this.onServerInfoUpdate_.bind(this),r,i),
                    ...
                    this.infoData_ = new cn,
                    this.infoSyncTree_ = new ln({
                        startListening: function(t, e, n, r) {
                            var i = []
                              , o = s.infoData_.getNode(t.path);
                            return o.isEmpty() || (i = s.infoSyncTree_.applyServerOverwrite(t.path, o),
                            setTimeout(function() {
                                r("ok")
                            }, 0)),
                            i
                ...
                t.prototype.onDataUpdate_ = function(t, e, n, r) {
                    ...
                    var l = i;
                    0 < o.length && (l = this.rerunTransactions_(i)),
                ...
                t.prototype.update = function(o, t, s) {
                    ...
                    r)
                        et("update() called with empty data.  Don't do anything."),
                        ...
                        this.server_.merge(o.toString(), t, function(t, e) {
                            ...
                            a.eventQueue_.raiseEventsForChangedPath(i, r),
                ...
                t.prototype.runOnDisconnectEvents_ = function() {
                    ...
                    var t, n, i, e = this.generateServerValues(), o = (t = this.onDisconnect_,
                    n = e,
                    i = new Me,
                    t.forEachTree(new Ct(""), function(t, e) {
                        i.remember(t, qe(e, n))
                    }),
                    i), s = [];
                    ...
                    this.onDisconnect_ = new Me,
                    this.eventQueue_.raiseEventsForChangedPath(Ct.Empty, s)
                }
                ,
                ...
                t.prototype.onDisconnectUpdate = function(r, n, i) {
                    var o = this;
                    if (I(n))
                        return et("onDisconnect().update() called with empty data.  Don't do anything."),
                ...
                t.prototype.stats = function(t) {
                    ...
                    "undefined" != typeof console) {
                        var e;
                        e = t ? (this.statsListener_ || (this.statsListener_ = new _n(this.stats_)),
                        this.statsListener_.get()) : this.stats_.get();
              ...
              , Fn = function() {
                function e(t) {
                    this.indexedFilter_ = new $e(t.getIndex()),
                ...
                e.prototype.updateChild = function(t, e, n, r, i, o) {
                    return this.matches(new $t(e,n)) || (n = Ee.EMPTY_NODE),
              ...
              , An = function() {
                function t(t) {
                    this.rangedFilter_ = new Fn(t),
                    this.index_ = t.getIndex(),
                    this.limit_ = t.getLimit(),
                    this.reverse_ = !t.isViewFromLeft()
                }
                return t.prototype.updateChild = function(t, e, n, r, i, o) {
                    return this.rangedFilter_.matches(new $t(e,n)) || (n = Ee.EMPTY_NODE),
                ...
                t.prototype.updateFullNode = function(t, e, n) {
                    ...
                    if (e.isLeafNode() || e.isEmpty())
                        ...
                        for (var c = !1; i.hasNext(); ) {
                            s = i.getNext();
                            !c && u(a, s) <= 0 && (c = !0),
                            c && o < this.limit_ && u(s, h) <= 0 ? o++ : r = r.updateImmediateChild(s.name, Ee.EMPTY_NODE)
                        }
                    }
                ...
                t.prototype.fullLimitUpdateChild_ = function(t, e, n, r, i) {
                    ...
                    if (a.hasChild(e)) {
                        for (var c = a.getImmediateChild(e), p = r.getChildAfterChild(this.index_, u, this.reverse_); null != p && (p.name == e || a.hasChild(p.name)); )
                            p = r.getChildAfterChild(this.index_, p, this.reverse_);
                        var d = null == p ? 1 : o(p, h);
                        if (l && !n.isEmpty() && 0 <= d)
                            return null != i && i.trackChildChange(Xe.childChangedChange(e, n, c)),
                        ...
                        return null != p && this.rangedFilter_.matches(p) ? (null != i && i.trackChildChange(Xe.childAddedChange(p.name, p.node)),
                        f.updateImmediateChild(p.name, p.node)) : f
                    }
                    return n.isEmpty() ? t : l && 0 <= o(u, h) ? (null != i && (i.trackChildChange(Xe.childRemovedChange(u.name, u.node)),
                    i.trackChildChange(Xe.childAddedChange(e, n))),
                    a.updateImmediateChild(e, n).updateImmediateChild(u.name, Ee.EMPTY_NODE)) : t
                }
                ,
                t
            }()
              , Ln = function() {
                ...
                r.prototype.getIndexStartValue = function() {
                    return C(this.startSet_, "Only valid if start has been set"),
                    this.indexStartValue_
                }
                ,
                r.prototype.getIndexStartName = function() {
                    return C(this.startSet_, "Only valid if start has been set"),
                    this.startNameSet_ ? this.indexStartName_ : at
                }
                ,
                ...
                r.prototype.getIndexEndValue = function() {
                    return C(this.endSet_, "Only valid if end has been set"),
                    this.indexEndValue_
                }
                ,
                r.prototype.getIndexEndName = function() {
                    return C(this.endSet_, "Only valid if end has been set"),
                    this.endNameSet_ ? this.indexEndName_ : ht
                }
                ,
                ...
                r.prototype.getLimit = function() {
                    return C(this.limitSet_, "Only valid if limit has been set"),
                    this.limit_
                }
                ,
                ...
                r.prototype.limitToFirst = function(t) {
                    ...
                    return e.limitSet_ = !0,
                    e.limit_ = t,
                    e.viewFrom_ = r.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_LEFT,
                    e
                }
                ,
                r.prototype.limitToLast = function(t) {
                    ...
                    return e.limitSet_ = !0,
                    e.limit_ = t,
                    e.viewFrom_ = r.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_RIGHT,
                    e
                }
                ,
                r.prototype.startAt = function(t, e) {
                    ...
                    n.indexStartName_ = null != e ? (n.startNameSet_ = !0,
                    e) : (n.startNameSet_ = !1,
                    ""),
                    n
                }
                ...
                r.prototype.endAt = function(t, e) {
                    ...
                    void 0 === t && (t = null),
                    n.indexEndValue_ = t,
                    n.indexEndName_ = void 0 !== e ? (n.endNameSet_ = !0,
                    e) : (n.endNameSet_ = !1,
                    ""),
                    n
                }
                ...
                r.prototype.getQueryObject = function() {
                    var t = r.WIRE_PROTOCOL_CONSTANTS_
                      , e = {};
                    if (this.startSet_ && (e[t.INDEX_START_VALUE] = this.indexStartValue_,
                    this.startNameSet_ && (e[t.INDEX_START_NAME] = this.indexStartName_)),
                    this.endSet_ && (e[t.INDEX_END_VALUE] = this.indexEndValue_,
                    this.endNameSet_ && (e[t.INDEX_END_NAME] = this.indexEndName_)),
                    this.limitSet_) {
                        e[t.LIMIT] = this.limit_;
                        var n = this.viewFrom_;
                        "" === n && (n = this.isViewFromLeft() ? t.VIEW_FROM_LEFT : t.VIEW_FROM_RIGHT),
                        e[t.VIEW_FROM] = n
                    }
                    return this.index_ !== ue && (e[t.INDEX] = this.index_.toString()),
                    e
                }
                ,
                ...
                r.prototype.toRestQueryStringParameters = function() {
                    ...
                    return this.isDefault() || (t = this.index_ === ue ? e.PRIORITY_INDEX : this.index_ === Re ? e.VALUE_INDEX : this.index_ === te ? e.KEY_INDEX : (C(this.index_ instanceof Pe, "Unrecognized index type!"),
                    this.index_.toString()),
                    n[e.ORDER_BY] = m(t),
                    this.startSet_ && (n[e.START_AT] = m(this.indexStartValue_),
                    this.startNameSet_ && (n[e.START_AT] += "," + m(this.indexStartName_))),
                    this.endSet_ && (n[e.END_AT] = m(this.indexEndValue_),
                    this.endNameSet_ && (n[e.END_AT] += "," + m(this.indexEndName_))),
              ...
              , Mn = function(n) {
                ...
                o.prototype.getKey = function() {
                    return k("Reference.key", 0, 0, arguments.length),
                    this.path.isEmpty() ? null : this.path.getBack()
                }
                ,
                o.prototype.child = function(t) {
                    var e, n, r, i;
                    return k("Reference.child", 1, 1, arguments.length),
                    "number" == typeof t ? t = String(t) : t instanceof Ct || (null === this.path.getFront() ? (e = "Reference.child",
                    i = !(n = 1),
                    (r = t) && (r = r.replace(/^\/*\.info(\/|$)/, "/")),
                    jt(e, n, r, i)) : jt("Reference.child", 1, t, !1)),
                    new o(this.repo,this.path.child(t))
                }
                ,
                ...
                o.prototype.update = function(t, e) {
                    if (k("Reference.update", 1, 2, arguments.length),
                    Kt("Reference.update", this.path),
                    Array.isArray(t)) {
                        for (var n = {}, r = 0; r < t.length; ++r)
                            n["" + r] = t[r];
                        t = n,
                        ot("Passing an Array to Firebase.update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")
                    }
                    Ut("Reference.update", 1, t, this.path, !1),
                    F("Reference.update", 2, e, !0);
                    var i = new l;
                ...
                o.prototype.setWithPriority = function(t, e, n) {
                    if (k("Reference.setWithPriority", 2, 3, arguments.length),
                    Kt("Reference.setWithPriority", this.path),
                    qt("Reference.setWithPriority", 1, t, this.path, !1),
                    Vt("Reference.setWithPriority", 2, e, !1),
                    F("Reference.setWithPriority", 3, n, !0),
                ...
                ,
                o.prototype.remove = function(t) {
                    return k("Reference.remove", 0, 1, arguments.length),
                    Kt("Reference.remove", this.path),
                    F("Reference.remove", 1, t, !0),
                    this.set(null, t)
                }
                ,
                o.prototype.transaction = function(t, r, e) {
                    if (k("Reference.transaction", 1, 3, arguments.length),
                    Kt("Reference.transaction", this.path),
                    F("Reference.transaction", 1, t, !1),
                    F("Reference.transaction", 2, r, !0),
                    function(t, e, n, r) {
                        if ((!r || void 0 !== n) && "boolean" != typeof n)
                            throw new Error(x(t, e, r) + "must be a boolean.")
                    ...
                    return this.repo.startTransaction(this.path, t, function(t, e, n) {
                        t ? i.reject(t) : i.resolve(new Gt(e,n)),
                ...
                o.prototype.push = function(t, e) {
                    ...
                    F("Reference.push", 2, e, !0);
                    var n, r = this.repo.serverTime(), i = Xt(r), o = this.child(i), s = this.child(i);
                ...
                o.prototype.onDisconnect = function() {
                    return Kt("Reference.onDisconnect", this.path),
            ...
            Ae.__referenceConstructor = Mn,
            sn.__referenceConstructor = Mn;
            var Wn, qn, Qn = function() {
                ...
                return i.prototype.subTree = function(t) {
                    for (var e, n = t instanceof Ct ? t : new Ct(t), r = this; null !== (e = n.getFront()); ) {
                        r = new i(e,r,b(r.node_.children, e) || new Qn),
                        n = n.popFront()
                    }
                    return r
                }
            ...
            (qn = Wn || (Wn = {}))[qn.RUN = 0] = "RUN",
            qn[qn.SENT = 1] = "SENT",
            qn[qn.COMPLETED = 2] = "COMPLETED",
            qn[qn.SENT_NEEDS_ABORT = 3] = "SENT_NEEDS_ABORT",
            qn[qn.NEEDS_ABORT = 4] = "NEEDS_ABORT",
            xn.MAX_TRANSACTION_RETRIES_ = 25,
            xn.prototype.transactions_init_ = function() {
            ...
            xn.prototype.startTransaction = function(t, e, n, r) {
                ...
                if (void 0 === h) {
                    ...
                    Qt("transaction failed: Data returned ", h, s.path),
                    s.status = Wn.RUN;
                    ...
                    l.setValue(c);
                    var p = void 0;
                    if ("object" == typeof h && null !== h && w(h, ".priority"))
                        p = b(h, ".priority"),
                        C(Wt(p), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.");
                    else
                        p = (this.serverSyncTree_.calcCompleteEventCache(t) || Ee.EMPTY_NODE).getPriority().val();
                    p = p;
            ...
            xn.prototype.sendTransactionQueue_ = function(a, h) {
                for (var u = this, t = h.map(function(t) {
                    ...
                    var o = h[i];
                    C(o.status === Wn.RUN, "tryToSendTransactionQueue_: items in queue should all be run."),
                    o.status = Wn.SENT,
                    o.retryCount++;
                ...
                this.server_.put(c.toString(), l, function(t) {
                    ...
                    if ("ok" === t) {
                        for (var n = [], r = 0; r < h.length; r++) {
                            if (h[r].status = Wn.COMPLETED,
                            e = e.concat(u.serverSyncTree_.ackUserWrite(h[r].currentWriteId)),
                            h[r].onComplete) {
                        ...
                        u.pruneCompletedTransactionsBelowNode_(u.transactionQueueTree_.subTree(a)),
                        u.sendReadyTransactions_(),
                        u.eventQueue_.raiseEventsForChangedPath(a, e);
                        for (r = 0; r < n.length; r++)
                            gt(n[r])
                    } else {
                        if ("datastale" === t)
                            for (r = 0; r < h.length; r++)
                                h[r].status === Wn.SENT_NEEDS_ABORT ? h[r].status = Wn.NEEDS_ABORT : h[r].status = Wn.RUN;
                        else {
                            ot("transaction at " + c.toString() + " failed: " + t);
                            for (r = 0; r < h.length; r++)
                                h[r].status = Wn.NEEDS_ABORT,
                                h[r].abortReason = t
                        }
                ...
                if (0 !== t.length) {
                    for (var n, r = [], i = [], o = t.filter(function(t) {
                        ...
                        var a = t[s]
                          ...
                          , u = !1
                          , l = void 0;
                        if (C(null !== h, "rerunTransactionsUnderNode_: relativePath should not be null."),
                        a.status === Wn.NEEDS_ABORT)
                            u = !0,
                            l = a.abortReason,
                            i = i.concat(this.serverSyncTree_.ackUserWrite(a.currentWriteId, !0));
                        else if (a.status === Wn.RUN)
                            if (a.retryCount >= xn.MAX_TRANSACTION_RETRIES_)
                                u = !0,
                                l = "maxretry",
                                i = i.concat(this.serverSyncTree_.ackUserWrite(a.currentWriteId, !0));
                            else {
                        ...
                        t[s].onComplete))
                            if ("nodata" === l) {
                                ...
                                r.push(t[s].onComplete.bind(null, new Error(l), !1, null))
                    }
            ...
            xn.prototype.pruneCompletedTransactionsBelowNode_ = function(t) {
                ...
                if (n) {
                    for (var r = 0, i = 0; i < n.length; i++)
                        n[i].status !== Wn.COMPLETED && (n[r] = n[i],
                        r++);
                    n.length = r,
                    t.setValue(0 < n.length ? n : null)
                }
                t.forEachChild(function(t) {
                ...
                if (null !== e) {
                    for (var n = [], r = [], i = -1, o = 0; o < e.length; o++)
                        if (e[o].status === Wn.SENT_NEEDS_ABORT)
                            ;
                        else if (e[o].status === Wn.SENT)
                            C(i === o - 1, "All SENT items should be at beginning of queue."),
                            e[i = o].status = Wn.SENT_NEEDS_ABORT,
                            e[o].abortReason = "set";
                        else if (C(e[o].status === Wn.RUN, "Unexpected transaction status in abort"),
                        e[o].unwatcher(),
            ...
            ;
            var Vn, Hn = "databaseURL", Bn = function() {
                function t() {
                    this.repos_ = {},
                ...
                t.prototype.databaseFromApp = function(t, e) {
                    ...
                    var r = Ot(n)
                      , i = r.repoInfo;
                    return Yt("Invalid Firebase Database URL", 1, r),
                    r.path.isEmpty() || it("Database URL must point to the root of a Firebase Database (not including a child path)."),
                    this.createRepo(i, t).database
                }
                ,
                t.prototype.deleteRepo = function(t) {
                    var e = b(this.repos_, t.app.name);
                    e && b(e, t.repoInfo_.toURLString()) === t || it("Database " + t.app.name + "(" + t.repoInfo_ + ") has already been deleted."),
                    t.interrupt(),
                ...
                t.prototype.createRepo = function(t, e) {
                    ...
                    return r && it("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),
                    r = new xn(t,this.useRestClient_,e),
                    n[t.toURLString()] = r
                }
                ,
                ...
                function t(t) {
                    (this.repo_ = t)instanceof xn || it("Don't call new Database() directly - please use firebase.database()."),
                    this.root_ = new Mn(t,Ct.Empty),
                    this.INTERNAL = new Kn(this)
                }
                ...
                t.prototype.ref = function(t) {
                    ...
                    t instanceof Mn ? this.refFromURL(t.toString()) : void 0 !== t ? this.root_.child(t) : this.root_
                }
                ,
                t.prototype.refFromURL = function(t) {
                    var e = "database.refFromURL";
                    this.checkDeleted_(e),
                    k(e, 1, 1, arguments.length);
                    var n = Ot(t);
                    Yt(e, 1, n);
                    var r = n.repoInfo;
                    return r.host !== this.repo_.repoInfo_.host && it(e + ": Host name does not match the current database: (found " + r.host + " but expected " + this.repo_.repoInfo_.host + ")"),
                ...
                return t.prototype.delete = function() {
                    ...
                    h = function() {
                        return e(this, function(t) {
                            ...
                            Bn.getInstance().deleteRepo(this.database.repo_),
            ...
            ;
            var Gn, Xn = Rn, $n = Tt, Jn = Object.freeze({
                DataConnection: zn,
        ...
        new Error("Cannot instantiate firebase-database - be sure to load firebase-app.js first.")
    }
});
