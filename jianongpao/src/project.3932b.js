        ...
        cc.Class({
            ...
            init: function() {
                ...
                0 == e) {
                    ...
                    this.titleLabel.string = "Gold Awards!",
        ...
        cc.Class({
            ...
            onSkipBtnClick: function() {
                ...
                setLoadingVisible(true, true, function () {
                    self.onSkipBtnClick2();
                })
            },
            onSkipBtnClick2: function() {
                var t = this
            ...
            onReTryBtnClick2: function() {
                var self = this;
                setLoadingVisible(true, true, function () {
                    self.onReTryBtnClick2();
                })
            },
            ...
            onMoreGameBtnClick2: function() {
                var self = this;
                setLoadingVisible(true, true, function () {
                    self.onMoreGameBtnClick2();
                })
            },
            ...
            onTryAgainClick2: function() {
                var self = this;
                setLoadingVisible(true, true, function () {
                    self.onTryAgainClick2();
                })
            },
        ...
        cc.Class({
            ...
            onStartBtnClick: function() {
                if (!Window.IS_First) {
                    ...
                    this.onStartBtnClick2();
                }
                else {
                    var self = this;
                    setLoadingVisible(true, true, function () {
                        self.onStartBtnClick2();
                    })
                }
            },
            onStartBtnClick2: function() {
    ...
    WinUI: [function(t, e, n) {
        ...
        cc.Class({
            ...
            onNextLevelBtnClick: function() {
                var self = this;
                setLoadingVisible(true, true, function () {
                    self.onNextLevelBtnClick2();
                })
            },
            onNextLevelBtnClick2: function() {
