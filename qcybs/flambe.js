...
flambe.embed = function(k, w) {
    ...
    if (null == x)
        throw Error("Could not find element [id=" + w + "]");
    ...
    for (h = 0; h < k.length; ++h)
        switch (r = k[h],
        (n = r.match(/\.(\w+)(\?|$)/)) && (n = n[1].toLowerCase()),
        n) {
        case "swf":
            if ((null == p || "flash" == p) && swfobject.hasFlashPlayerVersion(flambe.FLASH_VERSION))
                return h = document.createElement("div"),
                h.id = w + "-swf",
                x.appendChild(h),
                "undefined" == typeof $flambe_expose && (window.$flambe_expose = function(h, n) {
...
var swfobject = function() {
    ...
    function x(a) {
        if (typeof l.addEventListener != j)
            l.addEventListener("load", a, !1);
        else if (typeof d.addEventListener != j)
            d.addEventListener("load", a, !1);
        else if (typeof l.attachEvent != j)
            V(l, "onload", a);
        ...
        if (0 < a)
            for (var b = 0; b < a; b++) {
                ...
                if (0 < e.pv[0]) {
                    var d = q(c);
                    if (d)
                        if (E(u[b].swfVersion) && !(e.wk && 312 > e.wk))
                            z(c, !0),
                            f && (g.success = !0,
                            g.ref = h(c),
                            f(g));
                            ...
                            for (var i = {}, d = d.getElementsByTagName("param"), o = d.length, m = 0; m < o; m++)
                                "movie" != d[m].getAttribute("name").toLowerCase() && (i[d[m].getAttribute("name")] = d[m].getAttribute("value"));
                            I(g, i, c, f)
                        } else
                            U(d),
                            f && f(g)
                ...
                f) {
                    if ((c = h(c)) && typeof c.SetVariable != j)
                        g.success = !0,
                        g.ref = c;
                    f(g)
                }
    ...
    function h(a) {
        var b = null;
        if ((a = q(a)) && "OBJECT" == a.nodeName)
            typeof a.SetVariable != j ? b = a : (a = a.getElementsByTagName(s)[0]) && (b = a);
        return b
    }
    function n() {
    ...
    function I(a, b, c, f) {
        ...
        var g = q(c);
        if (g) {
            "OBJECT" == g.nodeName ? (B = J(g),
            G = null) : (B = g,
            G = c);
            a.id = O;
            if (typeof a.width == j || !/%$/.test(a.width) && 310 > parseInt(a.width, 10))
                a.width = "310";
            if (typeof a.height == j || !/%$/.test(a.height) && 137 > parseInt(a.height, 10))
                a.height = "137";
    ...
    function U(a) {
        if (e.ie && e.win && 4 != a.readyState) {
            ...
            a.parentNode.replaceChild(J(a), a)
    }
    function J(a) {
        var b = d.createElement("div");
        if (e.win && e.ie)
    ...
    function L(a, b, c) {
        ...
        if (e.wk && 312 > e.wk)
            return f;
        if (g)
            if (typeof a.id == j && (a.id = c),
            e.ie && e.win) {
                var h = "", i;
                for (i in a)
                    a[i] != Object.prototype[i] && ("data" == i.toLowerCase() ? b.movie = a[i] : "styleclass" == i.toLowerCase() ? h += ' class="' + a[i] + '"' : "classid" != i.toLowerCase() && (h += " " + i + '="' + a[i] + '"'));
                i = "";
                for (var o in b)
                    b[o] != Object.prototype[o] && (i += '<param name="' + o + '" value="' + b[o] + '" />');
                ...
                for (var m in a)
                    a[m] != Object.prototype[m] && ("styleclass" == m.toLowerCase() ? o.setAttribute("class", a[m]) : "classid" != m.toLowerCase() && o.setAttribute(m, a[m]));
                for (h in b)
                    b[h] != Object.prototype[h] && "movie" != h.toLowerCase() && (a = o,
                    i = h,
                    m = b[h],
        ...
        if (!e.ie || !e.mac) {
            ...
            if (g) {
                ...
                if (!t || M != c)
                    ...
                    t = g.appendChild(f),
                    e.ie && e.win && typeof d.styleSheets != j && 0 < d.styleSheets.length && (t = d.styleSheets[d.styleSheets.length - 1]),
                    M = c;
    ...
    var j = "undefined", s = "object", D = "application/x-shockwave-flash", O = "SWFObjectExprInst", l = window, d = document, v = navigator, T = !1, C = [function() {
        T ? r() : p()
    }
    ], u = [], H = [], A = [], B, G, K, N, y = !1, F = !1, t, M, R = !0, e = function() {
        var a = typeof d.getElementById != j && typeof d.getElementsByTagName != j && typeof d.createElement != j
          ...
          , e = [0, 0, 0]
          , i = null;
        if (typeof v.plugins != j && typeof v.plugins["Shockwave Flash"] == s) {
            if ((i = v.plugins["Shockwave Flash"].description) && !(typeof v.mimeTypes != j && v.mimeTypes[D] && !v.mimeTypes[D].enabledPlugin))
                T = !0,
                g = !1,
                i = i.replace(/^.*\s+(\S+\s+\S+$)/, "$1"),
                e[0] = parseInt(i.replace(/^(.*)\..*$/, "$1"), 10),
                e[1] = parseInt(i.replace(/^.*\.(.*)\s.*$/, "$1"), 10),
                e[2] = /[a-zA-Z]/.test(i) ? parseInt(i.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
        } else if (typeof l.ActiveXObject != j)
            try {
                var h = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                if (h && (i = h.GetVariable("$version")))
                    g = !0,
                    i = i.split(" ")[1].split(","),
    ...
    (function() {
        e.w3 && ((typeof d.readyState != j && "complete" == d.readyState || typeof d.readyState == j && (d.getElementsByTagName("body")[0] || d.body)) && k(),
        y || (typeof d.addEventListener != j && d.addEventListener("DOMContentLoaded", k, !1),
    ...
    return {
        ...
        embedSWF: function(a, b, c, d, g, h, i, o, m, k) {
            ...
            e.w3 && !(e.wk && 312 > e.wk) && a && b && c && d && g ? (z(b, !1),
            w(function() {
                c += "";
                d += "";
                var e = {};
                ...
                if (i && typeof i === s)
                    for (var r in i)
                        l.flashvars = typeof l.flashvars != j ? l.flashvars + ("&" + r + "=" + i[r]) : r + "=" + i[r];
                if (E(g))
                    q = L(e, l, b),
                    e.id == b && z(b, !0),
                    p.success = !0,
        ...
        expressInstallCallback: function() {
            if (F) {
                var a = q(O);
                a && B && (a.parentNode.replaceChild(B, a),
                G && (z(G, !0),
                e.ie && e.win && (B.style.display = "block")),
                K && K(N));
                F = !1
            }
        }
