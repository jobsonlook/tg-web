...
!function(e) {
    ...
    function o(t) {
        ...
        i.addEventListener("click", function(n) {
            ...
            h.links.active() && !t.link && e.open("http://wanted5games.com/play?utm_source=" + t.distribution + "&utm_medium=onlinegame&utm_content=splash&utm_campaign=html5game")
        }),
        t.sound) {
    ...
    function a() {
        return u["ad-rotation"] ? 10 != u.portal && u["ad-timer"] && Math.round((new Date).getTime() / 1e3) - m["ad-timer"] > u["ad-timer"] ? (t("the ad-timer is higher then " + u["ad-timer"]),
        m["ad-count"] = 0,
      ...
      , h = {
        ...
        logos: {
            ...
            list: function() {
                ...
                u.logos ? u.logos : {
                    vertical: "./assets/img/logo-vertical.png",
                    horizontal: "./assets/img/logo-horizontal.png"
                }
            }
        },
        info: {
