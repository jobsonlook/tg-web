...
// var _typeof3 = _interopRequireDefault(_typeof);//require("../@babel/runtime/helpers/typeof"));
function _typeof2(o) {
...
function _typeof(obj) {
    if (typeof Symbol === "function" && (0, _typeof3.default)(Symbol.iterator) === "symbol") {
        ...
        _typeof = function _typeof(obj) {
            return obj && typeof Symbol === "function" && obj.constructor === Symbolnode && obj !== Symbol.prototype ? "symbol" : (0, 
...
!function(t, e) {
            ...
            value: function parse(t, n) {
                ...
                t._anis.length = g, h = 0; h < g; h++) {
                    ...
                    for (v.totalKeyframeDatasLength = 0, l = 0; l < A; l++) {
                        ...
                        S.interpolationMethod.length = C, o = 0; o < C; o++) {
    ...
    var o = 
    /* */
    function(_e$EventDispatcher) {
        _inherits(o, _e$EventDispatcher);
        function o() {
            var _this;
            _classCallCheck(this, o);
            _this = _possibleConstructorReturn(this, _getPrototypeOf(o).call(this)), _this.isCache = !0, 
            _this.playbackRate = 1, _this._destroyed = !1, _this._currentAnimationClipIndex = -1, 
            _this._currentKeyframeIndex = -1, _this._currentTime = 0, _this._overallDuration = Number.MAX_VALUE, 
            _this._stopWhenCircleFinish = !1, _this._elapsedPlaybackTime = 0, _this._startUpdateLoopCount = -1, 
            _this._cachePlayRate = 1, _this.cacheFrameRate = 60, _this.returnToZeroStopped = !1;
            return _this;
        }
        _createClass(o, [ {
    ...
    var _ = 
    /* */
    function(_e$Resource) {
        _inherits(_, _e$Resource);
        function _() {
            var _this2;
            _classCallCheck(this, _);
            _this2 = _possibleConstructorReturn(this, _getPrototypeOf(_).call(this)), _this2._anis = [], 
            _this2._aniMap = {}, _this2.unfixedLastAniIndex = -1, _this2._fullFrames = null, 
        ...
        _createClass(_, [ {
            ...
            value: function getOriginalDataUnfixedRate(t, e, i) {
                ...
                for (var r = 0, s = 0, n = a.length, h = 0; s < n; s++) {
                    ...
                    } else for (r = 0; r < l.keyframeWidth; ) {
                        r += l.interpolationMethod[r](l, r, e, h + r, o.data, u, o.dData, o.duration, o.nextData);
                    }
                    h += l.keyframeWidth;
                }
    ...
    function() {
        ...
        _createClass(c, [ {
            ...
            value: function update() {
                ...
                this.parentBone) {
                    if (this.inheritRotation && this.inheritScale) i = this.resultTransform.getMatrix(), 
                ...
                if (g._tempVerticleArr.length = 0, o = g._tempVerticleArr, this.deformData && this.deformData.length > 0) {
                    ...
                    for (f = 0, M = r.length; f < M; ) {
                        for (c = r[f++] + f, p = 0, d = 0; f < c; f++) {
                            n = t[r[f]], h = u[x] + this.deformData[D++], l = u[x + 1] + this.deformData[D++], 
                    ...
                    for (c = r[f++] + f, p = 0, d = 0; f < c; f++) {
                        n = t[r[f]], h = u[x], l = u[x + 1], y = u[x + 2], p += (h * n.a + l * n.c + n.tx) * y, 
    ...
    function() {
        ...
        _createClass(A, [ {
            ...
            value: function _applyIk3(t, i, a, r, s, n) {
                if (0 == n) return;
                var h, l;
                var o = i.resultMatrix.a * i.length, u = i.resultMatrix.b * i.length, _ = o * o + u * u, p = Math.sqrt(_);
                var d = t.resultMatrix.tx, c = t.resultMatrix.ty, m = i.resultMatrix.tx, x = i.resultMatrix.ty, y = m - d, g = x - c;
                var f = y * y + g * g, M = Math.sqrt(f), D = (y = a - t.resultMatrix.tx) * y + (g = r - t.resultMatrix.ty) * g, v = Math.sqrt(D);
                if (p + M <= v || v + p <= M || v + M <= p) {
                    var I;
                    m = d + (I = p + M <= v ? 1 : -1) * (a - d) * M / v, x = c + I * (r - c) * M / v;
                } else {
                    var _t2 = (f - _ + D) / (2 * D), _e = Math.sqrt(f - _t2 * _t2 * D) / v, _i = d + y * _t2, _a = c + g * _t2, _r = -g * _e, _n = y * _e;
    ...
    function() {
        ...
        _createClass(T, [ {
            ...
            value: function computeWorldPositions(t, e, i, a, r, s, n) {
                ...
                if (D--, y -= 4, this.computeWorldVertices2(t, e, 2, y, m, 0), this._debugKey) for (x = 0; x < m.length; ) {
                ...
                if (s && (g *= l), n) for (x = 0; x < a; x++) {
                    f[x] *= l;
                }
                var Y, K = this._segments, X = 0;
                for (x = 0, o = 0, u = 0, Y = 0; x < a; x++, o += 3) {
                    if ((_ = g += p = f[x]) < 0) this.addBeforePosition(_, h, 0, M, o); else if (_ > l) this.addAfterPosition(_ - l, h, y - 4, M, o); else {
                        for (;;u++) {
                            if (!(_ > (c = I[u]))) {
    ...
    function() {
        function C(t, e) {
            ...
            this.target = e[t.targetIndex], i = 0, a = t.boneIndexs.length; i < a; i++) {
                this._bones.push(e[t.boneIndexs[i]]);
            }
    ...
    function(_e$Sprite) {
        ...
        function F() {
            ...
            var e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
            _classCallCheck(this, F);
            _this3 = _possibleConstructorReturn(this, _getPrototypeOf(F).call(this)), _this3._boneMatrixArray = [], 
            _this3._lastTime = 0, _this3._currAniIndex = -1, _this3._pause = !0, _this3._aniClipIndex = -1, 
            _this3._clipIndex = -1, _this3._skinIndex = 0, _this3._skinName = "default", _this3._aniMode = 0, 
            _this3._index = -1, _this3._total = -1, _this3._indexControl = !1, _this3._eventIndex = 0, 
            _this3._drawOrderIndex = 0, _this3._drawOrder = null, _this3._lastAniClipIndex = -1, 
            _this3._lastUpdateAniClipIndex = -1, _this3._playAudio = !0, _this3._soundChannelArr = [], 
            t && _this3.init(t, e);
            return _this3;
        }
        _createClass(F, [ {
            ...
            value: function init(t) {
                ...
                var a, r, s, n, h = 0;
                if (1 == i) for (this._graphicsCache = [], h = 0, a = t.getAnimationCount(); h < a; h++) {
                ...
                a = t.pathArr.length; h < a; h++) {
                    r = t.pathArr[h], s = new T(r, this._boneList), (n = this._boneSlotDic[r.name]) && ((s = new T(r, this._boneList)).target = n), 
                    this._pathDic[r.name] = s;
                }
                if (t.tfArr.length > 0) for (this._tfArr = [], h = 0, a = t.tfArr.length; h < a; h++) {
            ...
            value: function _onStop() {
                ...
                if (i && this._eventIndex < i.length) for (;this._eventIndex < i.length; this._eventIndex++) {
            ...
            value: function _parseSrcBoneMatrix() {
                ...
                this._boneSlotArray = this._templet.boneSlotArray; else {
                    ...
                    for (t = 0, i = s.length; t < i; t++) {
                        a = s[t], null == (r = this._bindBoneBoneSlotDic[a.parent]) && (this._bindBoneBoneSlotDic[a.parent] = r = []), 
            ...
            value: function _onAniSoundStoped(t) {
                for (var e, i = this._soundChannelArr.length, a = 0; a < i; a++) {
                    ((e = this._soundChannelArr[a]).isStopped || t) && (!e.isStopped && e.stop(), this._soundChannelArr.splice(a, 1), 
                    i--, a--);
                }
            }
        }, {
            ...
            value: function _createGraphics() {
                ...
                g = this._ikArr.length; m < g; m++) {
                    (T = this._ikArr[m]).name in b && (T.bendDirection = b[T.name]), T.name in C && (T.mix = C[T.name]), 
                    T.apply();
                }
                if (this._pathDic) for (var F in this._pathDic) {
                    (S = this._pathDic[F]).apply(this._boneList, s);
                }
                if (this._tfArr) for (m = 0, y = this._tfArr.length; m < y; m++) {
                    this._tfArr[m].apply();
                }
                ...
                if (B && B.length > 0) {
                    ...
                    m = 0, g = this._boneSlotArray.length; m < g; m++) {
                ...
                if (this._drawOrder) for (m = 0, g = this._drawOrder.length; m < g; m++) {
                    k = I[(l = this._boneSlotArray[this._drawOrder[m]]).name], P = A[l.name], isNaN(k) || -2 == k || (this._templet.attachmentNames ? l.showDisplayByName(this._templet.attachmentNames[k]) : l.showDisplayByIndex(k)), 
                ...
                } else for (m = 0, g = this._boneSlotArray.length; m < g; m++) {
                    k = I[(l = this._boneSlotArray[m]).name], P = A[l.name], isNaN(k) || -2 == k || (this._templet.attachmentNames ? l.showDisplayByName(this._templet.attachmentNames[k]) : l.showDisplayByIndex(k)), 
            ...
            value: function _setDeform(t, e, i, a) {
                var r, s, n, h, l, o;
                if (t && t) for (h = 0, l = t.deformSlotDataList.length; h < l; h++) {
                    for (r = t.deformSlotDataList[h], o = 0; o < r.deformSlotDisplayList.length; o++) {
                        n = i[(s = r.deformSlotDisplayList[o]).slotIndex], s.apply(a, n), e[s.slotIndex] || (e[s.slotIndex] = {}), 
            ...
            value: function paused() {
                if (!this._pause) {
                    if (this._pause = !0, this._player && (this._player.paused = !0), this._soundChannelArr.length > 0) for (var t, e = this._soundChannelArr.length, i = 0; i < e; i++) {
            ...
            value: function resume() {
                if (this._indexControl = !1, this._pause) {
                    if (this._pause = !1, this._player && (this._player.paused = !1), this._soundChannelArr.length > 0) for (var t, i = this._soundChannelArr.length, a = 0; a < i; a++) {
            ...
            value: function destroy() {
                var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !0;
                _get(_getPrototypeOf(F.prototype), "destroy", this).call(this, t), this._templet._removeReference(1), 
    ...
    function(_ref) {
        ...
        function U() {
            var _this4;
            _classCallCheck(this, U);
            _this4 = _possibleConstructorReturn(this, _getPrototypeOf(U).apply(this, arguments)), 
            _this4._graphicsCache = [], _this4.srcBoneMatrixArr = [], _this4.ikArr = [], _this4.tfArr = [], 
            _this4.pathArr = [], _this4.boneSlotDic = {}, _this4.bindBoneBoneSlotDic = {}, _this4.boneSlotArray = [], 
            _this4.skinDataArray = [], _this4.skinDic = {}, _this4.subTextureDic = {}, _this4.isParseFail = !1, 
            _this4.drawOrderAniArr = [], _this4.eventAniArr = [], _this4.attachmentNames = null, 
            _this4.deformAniArr = [], _this4.skinSlotDisplayDataArr = [], _this4._isParseAudio = !1, 
            _this4._isDestroyed = !1, _this4._rate = 30, _this4.isParserComplete = !1, _this4.aniSectionDic = {}, 
            _this4._textureDic = {}, _this4.mBoneArr = [];
            return _this4;
        }
        _createClass(U, [ {
            key: "loadAni",
            ...
            key: "parse",
            value: function parse(t) {
                _get(_getPrototypeOf(U.prototype), "parse", this).call(this, t), this.event(e.Event.LOADED, this), 
            ...
            value: function _parseTexturePath() {
                if (this._isDestroyed) this.destroy(); else {
                    ...
                    for (t = 0; t < r; t++) {
                        i = this._path + n[2 * t], s = n[2 * t + 1], a.getFloat32(), a.getFloat32(), a.getFloat32(), 
            ...
            value: function _parsePublicExtData() {
                ...
                for (i = 0; i < Y; i++) {
                    (E = []).push(o.getUint16()), E.push(o.getUint16()), E.push(o.getUint16()), E.push(o.getUint16()), 
                    this.aniSectionDic[i] = E;
                }
                var K, X = o.getInt16(), W = {};
                for (i = 0; i < X; i++) {
                    R = new c(), 0 == i ? K = R : R.root = K, R.d = t ? -1 : 1, O = o.readUTFString(), 
                    V = o.readUTFString(), R.length = o.getFloat32(), 1 == o.getByte() && (R.inheritRotation = !1), 
                ...
                for (i = 0; i < H; i++) {
                    (z = new d()).scX = o.getFloat32(), z.skX = o.getFloat32(), z.skY = o.getFloat32(), 
                    z.scY = o.getFloat32(), z.x = o.getFloat32(), z.y = o.getFloat32(), 8 === this.tMatrixDataLen && (z.skewX = o.getFloat32(), 
                    z.skewY = o.getFloat32()), Q.push(z), (R = this.mBoneArr[i]).transform = z;
                }
                ...
                for (i = 0; i < ct; i++) {
                    ...
                    for (var yt = 0; yt < mt; yt++) {
                        for ((lt = new f()).skinName = o.getUTFString(), xt[lt.skinName] = lt, at = o.getInt16(), 
                        a = 0; a < at; a++) {
                            for (ot = new M(), lt.deformSlotDataList.push(ot), rt = o.getInt16(), r = 0; r < rt; r++) {
                                for (ut = new D(), ot.deformSlotDisplayList.push(ut), ut.slotIndex = o.getInt16(), 
                                ut.attachment = o.getUTFString(), st = o.getInt16(), s = 0; s < st; s++) {
                                    for (1 == o.getByte() ? ut.tweenKeyList.push(!0) : ut.tweenKeyList.push(!1), nt = o.getFloat32(), 
                                    ut.timeList.push(nt), _t = [], ut.vectices.push(_t), ht = o.getInt16(), n = 0; n < ht; n++) {
                ...
                for (i = 0; i < St; i++) {
                    for (It = o.getInt16(), Dt = [], a = 0; a < It; a++) {
                        (At = new I()).name = o.getUTFString(), this._isParseAudio && (At.audioValue = o.getUTFString()), 
                        At.intValue = o.getInt32(), At.floatValue = o.getFloat32(), At.stringValue = o.getUTFString(), 
                        At.time = o.getFloat32(), Dt.push(At);
                    }
                    this.eventAniArr.push(Dt);
                }
                var Tt = o.getInt16();
                if (Tt > 0) for (this.attachmentNames = [], i = 0; i < Tt; i++) {
                    this.attachmentNames.push(o.getUTFString());
                }
                var bt, Ct, Ft = o.getInt16();
                for (i = 0; i < Ft; i++) {
                    (bt = new g()).name = o.readUTFString(), bt.parent = o.readUTFString(), bt.attachmentName = o.readUTFString(), 
                    bt.srcDisplayIndex = bt.displayIndex = o.getInt16(), bt.templet = this, this.boneSlotDic[bt.name] = bt, 
                ...
                for (i = 0; i < Kt; i++) {
                    for ((wt = new w()).name = Vt[Yt++], Lt = o.getUint8(), a = 0; a < Lt; a++) {
                        ...
                        r = 0; r < Ut; r++) {
                            ...
                            if ((Bt = o.getUint16()) > 0) for (Pt.uvs = [], s = 0; s < Bt; s++) {
                                Pt.uvs.push(o.getFloat32());
                            }
                            if ((Et = o.getUint16()) > 0) for (Pt.weights = [], s = 0; s < Et; s++) {
                                Pt.weights.push(o.getFloat32());
                            }
                            if ((Rt = o.getUint16()) > 0) for (Pt.triangles = [], s = 0; s < Rt; s++) {
                                Pt.triangles.push(o.getUint16());
                            }
                            if ((Nt = o.getUint16()) > 0) for (Pt.vertices = [], s = 0; s < Nt; s++) {
                                Pt.vertices.push(o.getFloat32());
                            }
                            if ((Ot = o.getUint16()) > 0) for (Pt.lengths = [], s = 0; s < Ot; s++) {
            ...
            value: function destroy() {
                ...
                _get(_getPrototypeOf(U.prototype), "destroy", this).call(this), e.ILaya.loader.clearRes(this._skBufferUrl);
            }
        }, {
            key: "getAniNameByIndex",
            value: function getAniNameByIndex(t) {
    ...
    function(_e$Sprite2) {
        ...
        function B() {
            ...
            var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
            _classCallCheck(this, B);
            _this5 = _possibleConstructorReturn(this, _getPrototypeOf(B).call(this)), _this5._start = 0, 
            _this5._Pos = 0, _this5._ended = !0, _this5._loadedImage = {}, _this5._endFrame = -1, 
            _this5.interval = 30, _this5._ids = {}, _this5._idOfSprite = [], _this5._reset(), 
            _this5._playing = !1, _this5._parentMovieClip = t, t ? (_this5._isRoot = !1, _this5._movieClipList = t._movieClipList, 
            _this5._movieClipList.push(_assertThisInitialized(_this5))) : (_this5._movieClipList = [ _assertThisInitialized(_this5) ], 
            _this5._isRoot = !0, _this5._setBitUp(e.Const.DISPLAY));
            return _this5;
        }
        _createClass(B, [ {
            key: "destroy",
            ...
            value: function updates() {
                var t, e;
                if (!this._parentMovieClip) for (e = this._movieClipList.length, t = 0; t < e; t++) {
            ...
            value: function _parseFrame(t) {
                ...
                this._curIndex > t && t < this._preIndex && (this._reset(!0), u.pos = this._Pos); this._curIndex <= t && !this._ended; ) {
                    switch (u.getUint16()) {
                      case 12:
