...
!function () {
        ...
        function () {
            ...
            _createClass(t, [{
                ...
                value: function t() {
                    ...
                    var s = new Date(), i = s.getFullYear(), h = s.getMonth() + 1, e = s.getDate(), a = i + "-";
                    if (h < 10 && (a += "0"), a += h + "-", e < 10 && (a += "0"), a += e, _t) {
                        a += " ";
                        var p = s.getHours(), n = s.getMinutes(), l = s.getSeconds();
                ...
                value: function g(t, s) {
                    ...
                    for (var h = 0; h < i; h++) {
                        var e = parseInt(t[h]), a = parseInt(s[h]);
                        if (e > a) return 1;
                        if (e < a) return -1;
                    }
                    return 0;
                ...
                value: function m(t, s, i) {
                    return [["moveTo", i, 0], ["lineTo", t - i, 0], ["arcTo", t, 0, t, i, i], ["lineTo", t, s - i], ["arcTo", t, s, t - i, s, i], ["lineTo", i, s], ["arcTo", 0, s, 0, s - i, i], ["lineTo", 0, i], ["arcTo", 0, 0, i, 0, i], ["closePath"]];
                }
            }, {
                key: "S",
                ...
                value: function D(t, s) {
                    var i = this.k(t, s), h = Math.acos(t / i);
                ...
                value: function T(t, s, i) {
                    var h = s.x - t.x, e = s.y - t.y, a = s.z - t.z, p = Math.max(Math.abs(h), Math.abs(e), Math.abs(a)), n = this.o(p / i) + 1;
        ...
        function (_Laya$Script3D) {
            ...
            _createClass(e, [{
                ...
                value: function onAwake() {
                    var t = this.owner, s = t.getChildAt(0).getComponent(Laya.Animator), i = new Laya.Vector3(.5, 1.8, .5), h = t.addComponent(Laya.Rigidbody3D), e = new Laya.BoxColliderShape(i.x, i.y, i.z);
                ...
                value: function onUpdate() {
                    var t = Laya.timer.delta, s = t / 1e3, e = this.It, a = A.instance.Vt;
                    if (A.instance.Yt && e.active && !this.xt) {
                        if (this.Ct += t, this.lt) if (this.ot > 0) this.ot -= t; else {
                            var _t3 = this.Ht(this.It.transform.position, this.It.transform.localRotationEulerY), _s2 = this.Kt(_t3);
                            null != _s2 ? this.pt != _s2.id ? (this.pt = _s2.id, this.nt = !1, this.Jt = !1,
                                -1 == _s2.name.indexOf("NoWait") && 100 * Math.random() < this.rt && (this.ot = this._t + h._(Math.random() * this.ft)),
                        ...
                        if ((this.$ || this.Tt) && this.gt && !A.instance.Gt.Xt) {
                            ...
                            if (this.lt || this.st) A.instance.Gt.Qt || (A.instance.Zt[this.q + 1].x = _t4); else {
                        ...
                        if (A.instance.Gt.Qt && (this.at != this.$ ? (this.at = this.$, this.et = this.Ct) : this.Ct > this.et + 500 && (this.et = this.Ct,
                            ...
                            var _t7 = new Date().getTime(), _s6 = 2e3;
                ...
                value: function ls(s, i) {
                    ...
                    var a = A.instance.Vt, p = a.ms[i];
                    if (i >= a.ms.length - 1) return [p, a.Fs[i]];
                    var n = a.ms[i + 1], l = (s - a.Ss[i]) / (a.Ss[i + 1] - a.Ss[i]);
                    Laya.Vector3.lerp(p, n, l, this.bt);
                    var o = h.N(a.Fs[i], a.Fs[i + 1], l), r = A.instance.Ms[this.kt];
                ...
                value: function Kt(s) {
                    ...
                    for (var _e = 0; _e < i.length; _e++) {
                        ...
                        var _p = -_a.transform.rotationEuler.y * t.P, _n = h.D(s.x - _a.transform.position.x, s.z - _a.transform.position.z), _l = h.k(s.x - _a.transform.position.x, s.z - _a.transform.position.z), _o = _n - _p, _r = _l * Math.cos(_o), _2 = _l * Math.sin(_o), _f = s.y - _a.transform.position.y, _y = .5;
        ...
        function (_Laya$Script) {
            ...
            _createClass(p, [{
                ...
                value: function onEnable() {
                    var t = ["#FF49A1", "#F74AFF", "#FFE54E", "#8CFF53", "#50E9FF", "#BD48FE"], s = this.owner;
                    s.rotation = 0;
                    var i = a.o(20 * Math.random()) + 20, h = a.o(20 * Math.random()) + 20;
                ...
                value: function onAwake() {
                    ...
                    var h = function h(s) {
                        if (this.Ps = !1, t.y < i.Rs) Laya.Tween.to(t, {
                            y: i.Rs
                        }, 200); else if (t.y > i.Ns) Laya.Tween.to(t, {
                            y: i.Ns
                        }, 200); else {
                            var _h5 = Date.now() - this.Gs, _e2 = (s.stageY - this.zs) / _h5 * 150;
                            1 == i.Is && (_e2 = 0 - _e2);
                            var _a2 = t.y - _e2;
        ...
        function (_Laya$Scene) {
            ...
            _createClass(o, [{
                ...
                value: function onEnable() {
                    ...
                    var s = Laya.stage.height - this.Us[0].y - i.H, h = 1260;
                ...
                value: function hi(t, s, i) {
                    ...
                    for (var _p2 = 0; _p2 < t.length; _p2++) {
                        ...
                        if (_n2.ui = _r2, -1 == e.indexOf(t[_p2].ti)) {
                            var _s13 = !1;
                            if (1 == t[_p2].Is && A.instance.Gt.di >= t[_p2].si && (e.push(t[_p2].ti), _s13 = !0),
                                !_s13) {
            ...
            _createClass(y, [{
                ...
                value: function onEnable() {
                    ...
                    for (var _i3 = 0; _i3 < 11; _i3++) {
                        var _h6 = void 0, _e3 = void 0, _a3 = void 0, _p3 = new Laya.Sprite();
    ...
    var d =
        ...
        function () {
            ...
            _createClass(d, [{
                ...
                value: function ae() {
                    var _this14 = this;
                    var t = this._e.bind(this), s = this.fe.bind(this), i = this.ye.bind(this), h = this.ue.bind(this);
                ...
                value: function fe(t) {
                    ...
                    if (this.oe = !s.find(function (t) {
                        ...
                        }), m.instance) for (var _t12 = this.ie; _t12 < m.instance.Yh.length; _t12++) {
                ...
                value: function _e(t) {
                    ...
                    this.ne = t.frameId, t.frameId > 1 && !this.pe && (this.pe = !0, this.be()), (t.actionList || []).forEach(function (t) {
                        var s = JSON.parse(t), i = A.instance;
                        if (_this20.de != s.id) {
                ...
                value: function onEnable() {
                    ...
                    this.y = i.H, this.btn.on(Laya.Event.CLICK, this, function (t) {
                        ...
                        this.Ri.size(Laya.stage.width, Laya.stage.height), this.Ri.y = -this.y, this.Ri.on(Laya.Event.CLICK, this, function (t) {
                            ...
                            // }));
                        }), null == i.U && (this.rili.visible = !1), this.btn.y += i.H, this.fight.y += i.H,
                ...
                value: function G() {
                    if (A.instance.Gt) {
                        ...
                        _t24 < A.instance.Gt.Oi ? (this.ticket.visible = !1, this.timekk.visible = !0, this.timetxt.text = M.i(M._((A.instance.Gt.Oi - _t24) / 1e3))) : (this.ticket.visible = !0,
                            this.timekk.visible = !1), this.rili.visible || null != i.U || (this.rili.visible = !1);
                    }
                }
            }, {
                key: "Ba",
    ...
    function v() {
        this.fa = !1, this.Xt = !1, this.da = 0, this.pa = !0, this.Sa = !1, this.vt = new Laya.Vector3(0, 0, 0),
            ...
            this._i = [[], []], this.vi = 0, this.jh = "", this.Za = [[7, 6], [9, 10], [3, 4], [5, 33], [31, 31], [8, 8], [9, 34, 19], [27, 16], [21, 35, 20], [22, 10], [25, 34, 12]],
            this.De = 35, this.$a = [[1e3, 60, 1e3, 9e3, 60, 10], [1e3, 30, 5e3, 5e3, 50, 10], [0, 50, 2e3, 5e3, 40, 10], [500, 40, 1e3, 4e3, 40, 10], [500, 30, 1e3, 3e3, 30, 10], [0, 0, 0, 0, 0, 0]],
            this.Hi = "", this.Yi = 0;
    }
    function b(t) {
    ...
    var A =
        ...
        function () {
            ...
            _createClass(A, [{
                key: "pp",
                value: function pp() {
                    console.log(Laya.version), Laya.stage.height > 1334 && (i.H = .5 * (Laya.stage.height - 1334),
                        i.K = i.H - x._(750 / window.innerWidth * 50), i.K < 0 && (i.K = 0)), console.log(window.innerWidth, window.innerHeight, window.devicePixelRatio),
                        console.log(Laya.stage.width, Laya.stage.height, i.H, i.K);
                    ...
                    var s = t.addChild(new Laya.Sprite3D()), h = s.addChild(new Laya.Sprite3D()), e = h.addChild(new Laya.Camera(0, .3, 1e3));
                    ...
                    Laya.loader.load("cnf.json", Laya.Handler.create(this, (res) => {
                        // platform.getInstance().startup("Fun-Race-3d", res["id"], () => {//zs
                            var yad = new Laya.Image();
                            yad.skin = "images/yad.png";
                            yad.bottom = 0;
                            yad.centerX = 0;
                            yad.zOrder = 1000;
                            // yad.on(Laya.Event.MOUSE_DOWN, this, () => { platform.getInstance().navigate("GAME", "LOGO") });
                            window["yad"] = yad;
                ...
                value: function $i() {
                    ...
                    for (var _t26 = 0; _t26 < 6; _t26++) {
                        var _s25 = new Laya.Sprite(), _i11 = Laya.Sprite.fromImage("img/eye.png");
                ...
                value: function Xi() {
                    ...
                    var p = Laya.Loader.getRes("res/Assets/kp/Animation/Sea-Sea.lani"), n = new Laya.AnimatorState();
                    n.name = "sea", n.clip = p;
                    var l = h.addComponent(Laya.Animator), o = new Laya.AnimatorControllerLayer("BaseLayer");
                ...
                value: function Gi() {
                    var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
                    if (this.Yt = !1, this.Ms && this.Ms.length > 0) for (var _t29 = 1; _t29 < this.Ms.length - 1; _t29++) {
                        this.Ms[_t29].destroy();
                    }
                    var s = this.Gt.Za, h = [];
                    if (t) for (var _s28 = 0; _s28 < t.length; _s28++) {
                        h.push("res/Level" + t[_s28] + ".lh");
                    } else if (this.Gt.Ga > s.length) for (var _t30 = 0; _t30 < this.Gt.Ua.length; _t30++) {
                        h.push("res/Level" + this.Gt.Ua[_t30] + ".lh");
                    } else for (var _t31 = 0; _t31 < s[this.Gt.Ga - 1].length; _t31++) {
                ...
                value: function Dp() {
                    ...
                    for (var _i12 = 0; _i12 < p; _i12++) {
                        ...
                        var _l3 = _e6.getChildByName("Line"), _o3 = _l3.numChildren;
                        _i12 == p - 1 && (_o3 = 2);
                        for (var _s29 = 0; _s29 < _o3; _s29++) {
                            if (_s29 > 0 || 0 == _i12) {
                                ...
                                if (_h11 > 1) {
                                    var _s30 = a.ms[_h11 - 1].x - a.ms[_h11 - 2].x, _i13 = a.ms[_h11 - 1].z - a.ms[_h11 - 2].z, _e7 = x.k(_s30, _i13);
                                    0 == _e7 && (_e7 = .001);
                ...
                value: function jp(t) {
                    ...
                    if (s) for (var _t36 = 0; _t36 < s.numChildren; _t36++) {
                        ...
                        if ("Ground" == _i15.name || _i15.name.startsWith("B")) {
                            ...
                            for (var _s33 = 0; _s33 < _t37; _s33++) {
                                var _t38 = _i15.getChildAt(_s33), _h13 = _t38.getComponent(Laya.Rigidbody3D);
                                if (null == _h13) {
                ...
                value: function Ap() {
                    if (this.Gt.Qh[0].active = !1, this.Gt.Qh[1].active = !1, this.kt = 0, this.Ep(),
                        ...
                        this.Pa) for (var _t39 = 0; _t39 < this.Ms.length; _t39++) {
                ...
                value: function ji() {
                    ...
                    setLoadingVisible(true, true, () => {
                        self.Ia(), Laya.Scene.open("scenes/platform.scene");
                        for (var _t41 = 0; _t41 < self.Ms.length; _t41++) {
                            self.Ms[_t41].active = !1;
                        }
                        self.vp.active = !0, self.fs.addChild(self.vp), self.wp[0].visible = !0, self.Gt.ma < 2 ? (self.vp.getChildByName("Platform2").active = !1,
                            self.vp.getChildByName("Cam").transform.localPositionX = .75, self.wp[0].x = 145) : (self.vp.getChildByName("Platform2").active = !0,
                                self.vp.getChildByName("Cam").transform.localPositionX = 0, self.wp[0].x = 30),
                            self.It.transform.position = self.Gt.vt, self.It.transform.localRotationEuler = self.Gt.vt,
                            self.It.transform.localRotationEulerY = 180, self.It.transform.localPositionX = 1.5;
                    })
                }
            }, {
                key: "Cp",
                ...
                value: function Ls() {
                    ...
                    if (this.vp.active = !1, this.fs.removeChild(this.vp), this.Gt.Wt) {
                        ...
                        for (var _s35 = 0; _s35 < this.Gt.ma; _s35++) {
                            ...
                            var _i17 = void 0, _h14 = this.Gt.Qh[this.Gt.Va[_s35]].getComponent(e);
                ...
                value: function Rp() {
                    ...
                    for (var _s36 = 0; _s36 < this.Gt.ma; _s36++) {
                        ...
                        _s36 < 2 ? ((_i18 = this.Gt.Qh[_s36]).getChildAt(0).getChildByName("Man").skinnedMeshRenderer.material.albedoColor = new Laya.Vector4(1, 1, 1, .7),
                            ...
                            _i18.active = !0;
                        var _h15 = void 0, _e8 = this.Gt.Te[_s36];
                ...
                value: function Ip() {
                    ...
                    if (i.J.us("win"), i.J.wh(), this.Gt.fa = !1, this.mp.visible = !1, this.je.visible = !1,
                        ...
                        if (this.Gt.ma--, -1 == this.Gt.os[0].q && (this.Gt.ma = 0), this.Gt.ma > 0 || this.Gt.Wt); else {
                        ...
                        this.Gt.Wt ? i.J.Ot.Ut([{
                            ...
                            this.Wi()), this.Gt.Wt ? (this.je.visible = !0, 0 == this.Gt.Ee && (this.Gt.Ee = 9e3)) : Laya.timer.once(3e3, this, function () {
                                if (_this35.Gt.ma > 0) {
                                    var _t52 = _this35.Gt.Qh[0].getComponent(e), _s39 = _this35.Gt.Qh[1].getComponent(e);
                ...
                value: function G() {
                    ...
                    if (this.Gt.Wt && this.Gt.Ee > 0) if (this.Gt.Ee -= t, this.Gt.Ee <= 0) this.Bp ? this.Ae() : this.rs(); else {
                    ...
                    if (this.Fp > -1e3) {
                        if (this.Fp -= t, this.Fp <= -1e3) this.gp[3].visible = !1; else if (this.Fp <= 0) this.gp[3].visible || (this.Yt = !0,
                            ...
                            this.Gt.da = 0, this.Gt.Ka = 0, i.J.gh()); else {
                ...
                key: "Pp",
                value: function Pp(t) {
                    var s = t / 1e3, i = this.Vt, h = this.np, e = this.lp, a = this.It;
                    if (0 == this.wi.wt && this.Gt.fa || B.instance && (B.instance.zp.visible = !1),
                        this.wi.xt) this.Bp || this.Ip(), h.transform.localPositionX = x.C(h.transform.localPositionX, a.transform.localPositionX, 3 * s),
                            ...
                            e.transform.localPositionZ = x.C(e.transform.localPositionZ, -5.9, 2 * s); else {
                        var _s45 = this.wi.Mt;
                        if (_s45 != this.Mt) {
                            this.Mt = _s45;
                ...
                key: "Tp",
                value: function Tp(t) {
                    var s = this.np, i = this.lp, h = this.It, e = t / 1e3;
                    if (this.Np) {
                        var _t64 = this.Np;
                ...
                value: function Ni() {
                    ...
                    var s = ["Rex", "IHax", "Asaurus Rex", "Uber", "?", "OMG", "LOL", "LMAO", "lam", "Milk", "MindOf", "Gamer",
                        "The Gamer", "Dr", "Popper", "Big", "LoveSong", "Ltls Ye", "Person",
                        "Captain", "Total", "The Dude", "The Gaming", "Gaming With", "Mr Game", "Ms Game",
                        "Final Hero", "???", "Command of Truth", "Space and Thunder", "Doubt and Zombies",
                        "Deadbot", "Bodymind", "UItraland", "Farwatch", "Halelith", "Eoweraron", "Nydareven", "Zerrac", "Acisien",
                        , "Kaigoch", "Peadon", "Demon、", "Chihiro", "Yor most precious", "trammels", "Tenderness", "starry", "Warm summer", "Fairy", "Dressed in a red skirt"], i = [];
                    ...
                    if (this._p.visible = !0, this.yp.visible = !0, this.cp.visible = !0, 1 == t ? (this._p.y = 400 + i.H,
                        ...
                        1 == t) this.Gt.di < 3 ? this.cp.graphics.drawRect(10, 10, 180, 50, "#A2BFCF") : 1 == this.Gt.ma ? (this.cp.graphics.drawRect(10, 10, 85, 50, "#FB9738"),
                            this.cp.graphics.drawRect(110, 10, 85, 50, "#A2BFCF")) : (this.cp.graphics.drawRect(10, 10, 85, 50, "#A2BFCF"),
                                this.cp.graphics.drawRect(110, 10, 85, 50, "#A2BFCF")); else {
                        var _t65 = this.Gt.di;
                ...
                key: "ba",
                value: function ba() {
                    var t = this.Gt._i[0].length, s = this.Gt._i[1].length;
                ...
                key: "Hp",
                value: function Hp() {
                    if (0 == this.ss.length) for (var _t76 = 0; _t76 < 12; _t76++) {
                        var _s53 = new Laya.Sprite(), _i26 = Laya.Sprite.fromImage("img/coink.png");
            ...
            _createClass(R, [{
                ...
                value: function G() {
                    ...
                    if (t > 1e3 && (t = 1e3), this.Ct += t, this.Ct >= 6e3) {
                        ...
                        var _t80 = [], _s55 = 0, _h19 = 0, _e10 = [1, 3, 7, 9, 11, 14, 16], _a6 = [2, 4, 6, 10, 12, 13, 15];
                        ...
                        if (this.si != _t81 && (this.si = _t81, this.Kp.text = "Number of people:(" + _t81 + "/100)"),
                            ...
                            for (var _s56 = this.Jp; _s56 < _t81; _s56++) {
                                var _t82 = this.Vi[_s56], _i30 = C.F(this.Yh[_s56], {
                                    fontFamily: "Arial",
                                    fontSize: 32,
                                    fill: "#000000",
                                    valign: "middle",
    ...
    var P =
        ...
        function (_Laya$Scene10) {
            ...
            function P() {
                var _this40;
                _classCallCheck(this, P);
                _this40 = _possibleConstructorReturn(this, _getPrototypeOf(P).call(this));
                _this40.loadScene("scenes/platform");
                    _this40.y = i.H;
                var t = _this40.tips;
            ...
            _createClass(P, [{
                ...
                value: function G() {
                    var t = Laya.timer.delta;
                    if (this.Ct += t, this.Ct >= this.qp) A.instance.Ls(); else {
        ...
        function (_Laya$Scene11) {
            ...
            _createClass(W, [{
                ...
                value: function onEnable() {
                    ...
                    var a = this.txt1.width + this.txt2.width + t, p = (this.content.width - a) / 2;
            ...
            _createClass(U, [{
                ...
                value: function onEnable() {
                    ...
                    for (var _t84 = 0; _t84 < s; _t84++) {
                        var _i31 = void 0, _h21 = A.instance.Gt.os[_t84], _e11 = "";
    ...
    /* */ function () {
            function _class() {
                ...
                var t = new Laya.Sprite(), s = V.F("LOADING...", {
                    fontFamily: "Arial",
                    fontSize: 40,
                    fill: "#ffffff",
                    align: "center",
