var __extends = this && this.__extends || function() {
    ...
    return function(t, i) {
        ...
        e(t, i),
        t.prototype = null === i ? Object.create(i) : (a.prototype = i.prototype,
        new a)
    }
}();
!function() {
    function e(t, i, a) {
        ...
        for (var n = "function" == typeof require && require, l = 0; l < a.length; l++)
            o(a[l]);
        return o
    }
    return e
        ...
        var a = e("../manager/PoolMgr")
          ...
          , s = function(e) {
            ...
            t.prototype.init = function(e, i, l, s) {
                ...
                this.rotat = 10,
                this.gnumAdd = 1.5,
                this.speedMinus = .01) : 2 == l && (this.num = 15,
                this.rotat = 10,
                this.gnumAdd = .6,
                this.speedMinus = .02);
                for (var r = 0; r < this.num; r++) {
                    ...
                    p.img.height = 38));
                    var d = 1;
                    switch (1 == l && (d = 1 * Math.random() + .2),
                    p.img.pivotX = .5 * p.img.width,
                    p.img.pivotY = .5 * p.img.height,
                    p.scaleX = d,
                    p.scaleY = d,
                    p.x = e.x,
                    p.y = e.y,
            ...
            t.prototype.update = function() {
                ...
                this.stayTime > 60 && (Laya.timer.clear(this, this.update),
                this.removeChildren(),
                this.removeSelf(),
                a.PoolMgr.recover(n["default"].POOLNAME.BombLZ, this))
            }
        ...
        var a = e("../model/Global")
          , o = function(e) {
            ...
            t.prototype.init = function(e) {
                1 == e ? (this.img = new Laya.Image(a["default"].BulletUrl + "bullet1.png"),
                this.img.width = 54,
                this.img.height = 54) : 2 == e && (this.img = new Laya.Image(a["default"].PanelUrl + "mainUi_money.png"),
                this.img.width = 30,
                this.img.height = 30),
        ...
        var a = e("../model/Player")
          ...
          , S = function() {
            ...
            e.prototype.initLocalData = function() {
                var e = Laya.LocalStorage.getItem(o["default"].LocalStorage.curLevel);
                e && (this.curLevel = Number(e)),
                0 == this.curLevel && (this.curLevel = 1),
                console.log("this.curLevel   ", this.curLevel);
                var t = Laya.LocalStorage.getItem(o["default"].LocalStorage.user_maxLevel);
                t && (a["default"].Instance.maxLevel = Number(t));
                var i = Laya.LocalStorage.getItem(o["default"].LocalStorage.batteryPos);
                i && (this.batteryPos = i.split(",")),
                i = Laya.LocalStorage.getItem(o["default"].LocalStorage.CannonPos),
                i && (this.cannonPos = i.split(",")),
                console.log("缓存炮台： ", this.batteryPos, this.cannonPos);
                var n = Laya.LocalStorage.getItem(o["default"].LocalStorage.user_gold);
                n && (a["default"].Instance.gold = Number(n));
                var l = (new Date).getMonth() + 1
                  , s = (new Date).getDate();
                if (Laya.LocalStorage.getItem(o["default"].LocalStorage.getGold_num)) {
                    var r = JSON.parse(Laya.LocalStorage.getItem(o["default"].LocalStorage.getGold_num));
                    l == r.mon && s == r.day ? a["default"].Instance.todayGetGoldNum = r.num : this.getGoldNumLocalData()
                } else
                    this.getGoldNumLocalData();
                var p = Laya.LocalStorage.getItem(o["default"].LocalStorage.techLevel);
                p && (a["default"].Instance.techLevelArr = p.split(","));
                var d = Laya.LocalStorage.getItem(o["default"].LocalStorage.offLineTime);
                if (d) {
                    var u = new Date
                ...
                var h = Laya.LocalStorage.getItem(o["default"].LocalStorage.guide);
                h && (a["default"].Instance.showGuide = Number(h),
                2 == a["default"].Instance.showGuide && (a["default"].Instance.guideStop = !0));
                var c = Laya.LocalStorage.getItem(o["default"].LocalStorage.giftEquip);
                c && (a["default"].Instance.giftEquipArr = c.split(","));
                var f = Laya.LocalStorage.getItem(o["default"].LocalStorage.giftEquipEffect);
                f && (a["default"].Instance.giftEffectEquipArr = f.split(","),
                a["default"].Instance.setGiftData());
                var m = Laya.LocalStorage.getItem(o["default"].LocalStorage.giftBag);
                m && (a["default"].Instance.giftBagArr = m.split(","));
                var y = Laya.LocalStorage.getItem(o["default"].LocalStorage.giftBagEffect);
                y && (a["default"].Instance.giftEffectBagArr = y.split(","))
            }
            ,
            e.prototype.saveOfflineTime = function() {
                var e = new Date;
                Laya.LocalStorage.setItem(o["default"].LocalStorage.offLineTime, e.getTime().toString())
            }
            ,
            e.prototype.getGoldNumLocalData = function() {
                ...
                Laya.LocalStorage.setItem(o["default"].LocalStorage.getGold_num, JSON.stringify(i))
            }
            ,
            ...
            e.prototype.showOfflineDialog = function() {
                if (!this.hasShowOffline && (this.hasShowOffline = !0,
                this.offlineGold >= 1)) {
                    var e = new f["default"];
                    e.popup()
                }
            ...
            e.prototype.onStart = function() {
                ...
                Laya.stage.height > 1500 && (this.LevelLayer.y = 70,
                this.ComposeLayer.y -= 20),
                this.refreshFightingCapacity(),
                this.failUi = new h["default"],
                this.failUi.x = .5 * (Laya.stage.width - this.failUi.width),
                s["default"].Instance.init(),
                this.successState = !0,
                a["default"].Instance.showGuide <= 3 ? (this.guide = new m["default"],
                a["default"].Instance.showGuide <= 1 ? this.guide.nextStep() : this.failUi.startShow()) : this.failUi.startShow(),
            ...
            e.prototype.nextLevel = function() {
                ...
                this.posArr = [],
                0 == this.curLevel && (this.curLevel = 1),
                this.curBlockLevelData = p["default"].BlockLevelDic.getValue(this.curLevel),
                this.curBlockLevelData && this.curBlockLevelData.boss) {
                    if (1 == this.curBlockLevelData.type)
                        this.createBigLine();
            ...
            e.prototype.createLine = function() {
                ...
                var i = Math.floor(5 * Math.random() + 4)
                  ...
                  , l = this.redPackage(i)
                  , s = !1;
                2 == this.curBlockLevelData.type && (this.curLevelNoLineAdd >= this.curLevelNoLine ? (this.curLevelNoLineAdd = 0,
                s = !0) : (s = Math.random() <= this.curLevelRedChance ? !0 : !1,
                s ? this.curLevelNoLineAdd = 0 : this.curLevelNoLineAdd++));
                for (var p = 0; i > p; p++) {
                ...
                this.lineIndex++,
                2 == this.curLevel && 2 == a["default"].Instance.showGuide && a["default"].Instance.guideStop && (this.successState = !0,
                e.Instance.guide.nextStep(),
                a["default"].Instance.guideStop = !1)
            }
            ,
            ...
            e.prototype.redPackage = function(e) {
                for (var t = 1, i = [], a = this.hpSum, o = 1; e > o; o++) {
                    var n = (a - (e - o) * t) / (e - o);
            ...
            e.prototype.checkNeibour = function(e, t, i) {
                ...
                case 1:
                    if (0 == t)
                        return !0;
                    if (this.posArr[e] && null != this.posArr[e][t - 1])
                        return !0;
                    break;
                case 2:
                    if (this.posArr[e + 1] && null != this.posArr[e + 1][t])
                        return !0;
                    break;
                case 3:
                    if (7 == t)
            ...
            e.prototype.autoAttack = function(e) {
                for (var t, i, a, o = 0; o < this.batteryArr.length; o++)
                    if (t = this.batteryArr[o]) {
                        if (t.target && this.posArr[t.target.line] && null != this.posArr[t.target.line][t.target.index])
                            t.targetDis = d.utils.dis(t.x, t.y + this.ComposeLayer.y + this.ComposeLayer.sp_box.y, t.target.x, t.target.y);
                        else {
                            for (var n = null, l = 0, s = 0; s < this.blockArr.length && (a = this.blockArr[s],
                            !(this.fullLineArr.length > 0 && a.line > this.fullLineArr[0])); s++)
                                if (null == n)
                                    n = a,
                        ...
                        null != i && (i.y = t.y + this.ComposeLayer.y + this.ComposeLayer.sp_box.y,
                        this.bulletLayer.addChild(i),
            ...
            e.prototype.showNext = function(e) {
                var t = this;
                if (this.failUi.removeSelf(),
                this.failUi.mouseEnabled = !1,
                e)
                    this.nextLevel();
                else {
                    for (var i = void 0, a = 0; a < this.batteryArr.length; a++)
                        i = this.batteryArr[a],
            ...
            e.prototype.onFrameLoop = function() {
                ...
                if (!this.failState && !this.pouseGame) {
                    ...
                    if (!this.successState) {
                        for (var d = 0; d < this.blockArr.length; d++)
                            l = this.blockArr[d],
                            l.move();
                        if (!e.Instance.curBlockLevelData)
                            return;
                        ...
                        this.blockMove >= u && (this.blockMove = 0,
                        this.lineIndex < this.curBlockLevelData.lines - 1 && (1 == this.curBlockLevelData.type ? this.createBigLine() : this.createLine()))
                    }
                    if (l = this.blockArr[0],
                    l && this.ComposeLayer.y - l.y - 150 <= l.radius ? (this.ComposeLayer.imgWarn.visible = !0,
                    this.ComposeLayer.imgWarn1.x += 3,
                    this.ComposeLayer.imgWarn1.x > 750 && (this.ComposeLayer.imgWarn1.x = -747),
                    this.ComposeLayer.imgWarn2.x += 3,
                    this.ComposeLayer.imgWarn2.x > 750 && (this.ComposeLayer.imgWarn2.x = -747)) : this.ComposeLayer.imgWarn.visible = !1,
                    l && this.ComposeLayer.y + this.ComposeLayer.imgWarn.y - l.y <= l.radius) {
                        this.failState = !0,
                        ...
                        Laya.LocalStorage.setItem(o["default"].LocalStorage.curLevel, this.curLevel.toString());
                        for (var h = void 0, c = 0; c < this.batteryArr.length; c++)
                            h = this.batteryArr[c],
                            h.failHide();
                        ...
                        void setTimeout(function() {
                            for (var e, a = 0; a < t.blockArr.length; a++)
                                e = t.blockArr[a],
                                e.clear(!1);
                            t.blockArr.splice(0),
                            t.posArr = [],
                    ...
                    if (o["default"].isAutoSynthesis && (this.autoSynthesisFrame++,
                    this.autoSynthesisFrame >= 60 && (this.autoSynthesisFrame = 0,
                    o["default"].autoSynthesis_totalTime <= 0 ? (o["default"].autoSynthesis_totalTime = 0,
                    o["default"].isAutoSynthesis = !1) : this.ComposeLayer.autoCompose())),
                    this.successState)
                        for (var h = void 0, c = 0; c < this.batteryArr.length; c++)
                            h = this.batteryArr[c],
                            h.target = null,
                        ...
                        r = s["default"].Instance.touchStatus && s["default"].Instance.clickPos.y < this.ComposeLayer.y + e.Instance.ComposeLayer.imgWarn.y ? this.targetAttack(r) : this.autoAttack(r);
                    for (var c = 0; r > c; c++)
                        if (i = this.bulletArr[c],
                        i.forward(),
                        i.y > this.ComposeLayer.y + 200)
                            i.clear(),
                            this.bulletArr.splice(c, 1),
                            r--;
                        else {
                            for (var u = 0, f = 0, m = 0, y = !1, v = !1, I = this.blockArr.length, d = 0; I > d && (l = this.blockArr[d],
                            !(this.fullLineArr.length > 0 && l.line > this.fullLineArr[0])); d++)
                                if (u = i.radius + l.radius + 10,
                                f = Math.abs(i.x - l.x),
                                m = Math.abs(i.y - l.y),
                                u >= f && u >= m) {
                                    y = !0,
                                    ...
                                    v && (this.bulletArr.splice(c, 1),
                                    r--);
                                    var b = l.hited(i.attack);
                                    b && (this.posArr && this.posArr[l.line] && this.posArr[l.line][l.index] && (this.posArr[l.line][l.index] = null),
                                    this.blockArr.splice(d, 1),
                                    I--,
                                    this.fullLineArr.length > 0 && l.line == this.fullLineArr[0] && this.fullLineArr.shift());
                                    break
                                }
                            this.lineIndex == this.curBlockLevelData.lines - 1 && (0 != I || this.successState || (this.successState = !0,
                            this.lastLevel = this.curLevel,
                            this.curLevel++,
                            Laya.LocalStorage.setItem(o["default"].LocalStorage.curLevel, this.curLevel.toString()),
                            this.curLevel > a["default"].Instance.maxLevel && (a["default"].Instance.maxLevel = this.curLevel,
                            Laya.LocalStorage.setItem(o["default"].LocalStorage.user_maxLevel, a["default"].Instance.maxLevel.toString())),
                            3 == this.curLevel && this.failGuide.setGuide(4),
                            this.failUi.showSuccess())),
                            y || (v = !1,
                            i.x <= i.radius ? v = i.changeAngle(p.COLLISIONDIR.Left) : i.x >= this.bulletLayer.width - i.radius ? v = i.changeAngle(p.COLLISIONDIR.Right) : i.y <= this.LevelLayer.height && (v = i.changeAngle(p.COLLISIONDIR.Top)),
                            v ? (this.bulletArr.splice(c, 1),
                            r--) : this.successState && (i.clear(),
                            this.bulletArr.splice(c, 1),
                            r--))
                        }
                }
            ...
            e.prototype.delayRefreshFightingCapacity = function() {
                for (var t = 0, i = 0; i < this.batteryArr.length; i++)
                    t += this.batteryArr[i].baseAtt * (60 / this.batteryArr[i].fireDis);
                var n = 0;
                ...
                if (a["default"].Instance.fightingCapacity != l) {
                    ...
                    u || (u = new I["default"],
                    u.x = .5 * (Laya.stage.width - u.width)),
                    u.init(p),
        ...
        var a = e("../model/Global")
          ...
          , d = function() {
            ...
            e.loadComplete = function(e) {
                var t = this;
                if (console.log("loadComplete success  ", e),
                e)
                    this.url = a["default"].StaticURL + a["default"].resVersion + "/",
                    this.setMapConfig(),
            ...
            e.setMapConfig = function() {
                ...
                for (var t, i, o = Laya.Loader.getRes(this.url + a["default"].LocalConfigs.TextConfig), r = o.length, d = 0; r > d; d++)
                    i = o[d].id,
                    t = o[d].Des,
                ...
                f && (a["default"].autoSynthesisTime = Number(f[0].DoubleTime),
                a["default"].bulletSoundSpan = Number(f[0].bulletSoundSpan),
                a["default"].bannerADID = f[0].banner,
                a["default"].videoADID = f[0].video,
                s["default"].Instance.shareProbability = f[0].probability,
                a["default"].Version_line = f[0].v,
                a["default"].showBanner = Number(f[0].banner_gailv),
                s["default"].Instance.videoShareArr = f[0].Order.split(","),
                l["default"].Instance.blockHurtOff = Number(f[0].red),
                a["default"].offTime = Number(f[0].offtime),
                a["default"].ip_offtime = Number(f[0].ip_offtime),
                a["default"].ramGiftPropertyArr = f[0].ramGiftProperty.split(","),
                a["default"].ramGiftColorArr = f[0].ramGiftColor.split(","),
                a["default"].rampageSpanArr = f[0].rampageSpan.split(","),
                a["default"].giftUnlockArr = f[0].giftUnlock.split(","),
                a["default"].boomNum = Number(f[0].boom),
                a["default"].bulletNum = Number(f[0].zidan),
                a["default"].giftVideoNum = Number(f[0].giftVideoNum),
                a["default"].showSuuccessLevel = Number(f[0].intera_lvs));
                for (var m, y = Laya.loader.getRes(this.url + a["default"].LocalConfigs.Notenough), v = 0; v < y.length; v++)
                    m = new n.GetGoldData,
                    m.id = Number(y[v].ID),
                ...
                r = x.length;
                for (var L = 0, _ = 0, d = 0; r > d; d++)
                    L = Number(x[d].ID),
                    _ = Number(x[d].Gold),
                    n["default"].OfflineDic.setValue(L, _);
                for (var S, w = Laya.loader.getRes(this.url + a["default"].LocalConfigs.LockBatteryConfig), C = 0; C < w.length; C++)
                    S = new n.LockBatteryData,
                    S.id = Number(w[C].ID),
                ...
                for (var T, D = Laya.loader.getRes(this.url + a["default"].LocalConfigs.GiftConfig), k = 0; k < D.length; k++)
                    T = new p.GiftAttr,
                    T.id = Number(D[k].ID),
            ...
            ,
            e.boomSrc = function() {
                for (var e = 0; e < a["default"].boomNum; e++)
                    a["default"].boomConfigs.push(a["default"].StaticURL + "imgs/boom/" + (e + 1) + ".png");
                for (var t = 0; t < a["default"].bulletNum; t++)
                    a["default"].bulletConfigs.push(a["default"].StaticURL + "imgs/zidan1/" + (t + 1) + ".png");
                o.EventHelper.fire(a["default"].CUSTOMEVENT.LoadComplete)
            }
            ,
        ...
        var a = e("../utils/Dictionary")
          ...
          , l = function() {
            ...
            return e.init = function() {
                ...
                var t = e.instance;
                if (null != t) {
                    if (t.stage = Laya.stage,
                    t.uiLayer = new Laya.View,
                    t.uiLayer.autoSize = !0,
                    t.panelContolDic = new a.Dictionary,
                    console.log("Laya.stage.width ", Laya.Browser.width, "    Laya.stage.height ", Laya.Browser.height, Laya.stage.x, Laya.stage.y),
            ...
            e.prototype.showPanel = function(t, i) {
                ...
                var a = e.instance
                  , o = a.get(t);
                null != o && (a.uiLayer.addChild(o.panel),
                i && (o.panel.scaleX = 0,
                o.panel.scaleY = 0,
                Laya.Tween.to(o.panel, {
                    scaleX: 1,
                    scaleY: 1
          ...
          , g = function() {
            ...
            e.prototype.mouseDown = function(e) {
                if (!this.isMove && !a["default"].Instance.ComposeLayer.isCompose) {
                    ...
                    if (this.targetPos.x > t.x + a["default"].Instance.ComposeLayer.x && this.targetPos.x < a["default"].Instance.ComposeLayer.x + t.x + t.width && this.targetPos.y > this.composseY + (t.height - i.height) && this.targetPos.y < this.composseY + t.height)
                        for (var n = 0; n < a["default"].Instance.ComposeLayer.cannonArr.length; n++) {
                    ...
                    else if (this.targetPos.x > a["default"].Instance.ComposeLayer.x + t.x && this.targetPos.x < a["default"].Instance.ComposeLayer.x + t.x + t.width && this.targetPos.y > this.composseY - 50 && this.targetPos.y < this.composseY + i.y)
                        for (var s = !1, n = 0; n < a["default"].Instance.batteryArr.length; n++) {
                        ...
                        this.targetPos.y > a["default"].Instance.LevelLayer.height && this.targetPos.y < a["default"].Instance.ComposeLayer.y + a["default"].Instance.ComposeLayer.imgWarn.y && (this.targetSp.visible = !0,
                        this.targetSp.pos(this.targetPos.x, this.targetPos.y))
                }
            }
            ,
            e.prototype.mouseMove = function(e) {
                1 == this.touchStatus && (this.moveStatus = !0,
                this.targetPos.x = e.stageX,
                this.targetPos.y = e.stageY,
                this.targetSp.pos(this.targetPos.x, this.targetPos.y),
                this.target && (this.target && (this.target.isAtt = !1),
                this.target.x = e.stageX - this._distance.x,
                this.target.y = e.stageY - this._distance.y,
                o["default"].isAutoSynthesis = !1))
            }
            ,
            e.prototype.mouseUp = function(e) {
                ...
                this.moveStatus) {
                    ...
                    if (e.stageX > a["default"].Instance.ComposeLayer.x + t.x && e.stageX < a["default"].Instance.ComposeLayer.x + t.x + t.width && e.stageY > this.composseY + (t.height - i.height) && e.stageY < this.composseY + t.height) {
                        if (o["default"].autoSynthesis_totalTime > 0 && (o["default"].isAutoSynthesis = !0),
                        this.target) {
                            for (var l = !1, s = 0; s < a["default"].Instance.ComposeLayer.cannonArr.length; s++) {
                            ...
                            if (!l) {
                                for (var c = !1, f = 0; f < a["default"].Instance.ComposeLayer.CannonPosArr.length; f++)
                                    if (Math.abs(this.target.x - a["default"].Instance.ComposeLayer.CannonPosArr[f][0]) < .5 * this.target.width && Math.abs(this.target.y - a["default"].Instance.ComposeLayer.CannonPosArr[f][1]) < .5 * this.target.height) {
                                        if (this.target.name == o["default"].TankName.TargetBattery) {
                                            this.isMove = !0,
                                ...
                                if (!c)
                                    if (Math.abs(this.target.x - a["default"].Instance.ComposeLayer.btn_remove.x) < this.target.width && Math.abs(this.target.y - (a["default"].Instance.ComposeLayer.btn_remove.y - 100)) < this.target.height)
                                        if (this.isRecovery = !0,
                                        this.target.level > a["default"].Instance.techBatteryLevel + 1) {
                            ...
                            this.isRecovery || (this.target && (this.target.name = ""),
                            this.target = null)
                        }
                        ...
                        if (this.target) {
                            for (var l = !1, s = 0; s < a["default"].Instance.batteryArr.length; s++) {
                            ...
                            if (!l) {
                                for (var c = !1, f = 0; f < a["default"].Instance.ComposeLayer.BatteryPosArr.length; f++)
                                    if (Math.abs(this.target.x - a["default"].Instance.ComposeLayer.BatteryPosArr[f][0]) < this.target.width && Math.abs(this.target.y - a["default"].Instance.ComposeLayer.BatteryPosArr[f][1]) < this.target.height)
                                        if (1 == a["default"].Instance.ComposeLayer.batteryDeblockStatus[f]) {
                                            if (d.SoundMgr.playSound(o["default"].SoundConfig.buttonClick),
                                            this.target.name == o["default"].TankName.TargetBattery) {
                                                this.target.isAtt = !0,
                                                a["default"].Instance.ComposeLayer.setStorage(0, this.target.initialPos),
                                ...
                                c || (this.target.name == o["default"].TankName.TargetBattery && (this.target.isAtt = !0),
                                this.target.x = this.target.initialPos[0],
                                this.target.y = this.target.initialPos[1])
                            }
                            this.target.name = "",
                        ...
                        this.target && (this.target.name == o["default"].TankName.TargetBattery && (this.target.isAtt = !0),
                        this.target.x = this.target.initialPos[0],
                        this.target.y = this.target.initialPos[1],
                        this.target.name = "",
                        this.target = null);
            ...
            e.prototype.mouseOut = function() {
                this.touchStatus && (o["default"].autoSynthesis_totalTime > 0 && (o["default"].isAutoSynthesis = !0),
                this.touchStatus = !1,
                this.moveStatus = !1,
                this.target && (this.target.name == o["default"].TankName.TargetBattery && (this.target.isAtt = !0),
                this.target.x = this.target.initialPos[0],
        ...
        var a = e("../model/Global")
          ...
          , r = function() {
            ...
            e.showRewardAd = function(t) {
                ...
                "h5api"in Laya.Browser.window ? (true ? Laya.Browser.window.h5api.playAd(function(t) {
                    Laya.Browser.window.console.log("播放广告回调数据", t),
                    10001 == t.code && o.EventHelper.fire(a["default"].CUSTOMEVENT.WatchADFinish, 0, e.watchType)
                }) : (Laya.Browser.window.console.log("没有广告资源可播放"),
                Laya.Dialog.closeAll(),
                o.EventHelper.fire(a["default"].CUSTOMEVENT.WatchADFinish, 2, e.watchType)),
                Laya.Browser.window.console.log("")) : (Laya.Browser.window.console.log("找不到 4399HTML5 API"),
                Laya.Browser.window.console.log(""),
                Laya.Dialog.closeAll(),
                o.EventHelper.fire(a["default"].CUSTOMEVENT.WatchADFinish, 2, e.watchType))
            }
            ...
            e.showToast = function(e) {
                ...
                t || (t = new l["default"],
                t.x = .5 * (Laya.stage.width - t.width)),
                t.init(e),
            ...
            e.share = function() {
                ...
                "h5api"in Laya.Browser.window ? Laya.Browser.window.h5api.share() : (Laya.Browser.window.console.log("找不到 4399HTML5 API"),
                Laya.Browser.window.console.log(""))
            }
            ,
            e.isLogin = function() {
                if (Laya.Browser.window.console.log(""),
                Laya.Browser.window.console.log("调用 `是否登录`"),
                "h5api"in Laya.Browser.window) {
                    var e = Laya.Browser.window.h5api.isLogin();
                    e ? Laya.Browser.window.console.log("已登录") : Laya.Browser.window.console.log("未登录")
                } else
            ...
            e.login = function() {
                ...
                "h5api"in Laya.Browser.window ? Laya.Browser.window.h5api.login(e) : (Laya.Browser.window.console.log("找不到 4399HTML5 API"),
                Laya.Browser.window.console.log(""))
            }
            ,
            e.getUserAvatar = function() {
                ...
                "h5api"in Laya.Browser.window ? (Laya.Browser.window.h5api.login(function(e) {
                    var t = Laya.Browser.window.h5api.getUserAvatar(e.uId)
                      , i = Laya.Browser.window.h5api.getUserSmallAvatar(e.uId)
                      , a = Laya.Browser.window.h5api.getUserBigAvatar(e.uId);
                    Laya.Browser.window.console.log("用户头像地址：", t),
                    Laya.Browser.window.console.log("用户小头像地址：", i),
                    Laya.Browser.window.console.log("用户大头像地址：", a)
                }),
                Laya.Browser.window.console.log("")) : (Laya.Browser.window.console.log("找不到 4399HTML5 API"),
                Laya.Browser.window.console.log(""))
            }
        ...
        var a = e("./MapData")
          ...
          , l = function() {
            ...
            return e.getRamGift = function() {
                for (var e = 0, t = o["default"].ramGiftPropertyArr.length, i = 0; t > i; i++)
                    e += Number(o["default"].ramGiftPropertyArr[i]);
                for (var l = Math.random() * e, s = 0, p = 0, i = 0; t > i; i++)
                    if (p += Number(o["default"].ramGiftPropertyArr[i]),
                    p >= l) {
                        s = i + 1;
                        break
                    }
                ...
                for (var i = 0; t > i; i++)
                    e += Number(o["default"].ramGiftColorArr[i]);
                var d = Math.random() * e
                  , u = 0;
                p = 0;
                for (var i = 0; t > i; i++)
                    if (p += Number(o["default"].ramGiftColorArr[i]),
                    p >= d) {
                        u = i + 1;
                        break
                    }
        ...
        var a = e("./Global")
          ...
          , l = function() {
            ...
            e.prototype.showVideoOrShare = function() {
                ...
                o["default"].Instance.checkVersion() ? !0 : a["default"].hasVideo ? this.orderIndex >= this.videoShareArr.length ? (this.orderIndex = 0,
                !0) : "2" == this.videoShareArr[this.orderIndex] ? !0 : "1" == this.videoShareArr[this.orderIndex] ? !1 : void 0 : !1
            }
            ,
            e.prototype.setGiftData = function() {
                ...
                for (var t, i = e.Instance.giftEquipArr.length, a = 0; i > a; a++)
                    switch (t = Number(e.Instance.giftEquipArr[a][0])) {
                    case 1:
            ...
            e.prototype.videoOrShareSuccess = function() {
                ...
                Laya.LocalStorage.setItem(a["default"].LocalStorage.user_orderIndex, t + ";" + this.orderIndex.toString())
            }
            ,
            e.prototype.getOrderIndex = function() {
                var e = new Date
                  , t = e.getFullYear().toString() + "," + (e.getMonth() + 1).toString() + "," + e.getDate().toString()
                  , i = Laya.LocalStorage.getItem(a["default"].LocalStorage.user_orderIndex);
                if (null == i)
                    this.orderIndex = 0,
                    Laya.LocalStorage.setItem(a["default"].LocalStorage.user_orderIndex, t + ";0");
                else {
                    var o = i.split(";");
                    t == o[0] ? this.orderIndex = Number(o[1]) : (this.orderIndex = 0,
                    Laya.LocalStorage.setItem(a["default"].LocalStorage.user_orderIndex, t + ";0"))
                }
            }
            ,
            e.prototype.getShareNum = function() {
                var e = new Date
                  , t = e.getFullYear().toString() + "," + (e.getMonth() + 1).toString() + "," + e.getDate().toString()
                  , i = Laya.LocalStorage.getItem(a["default"].LocalStorage.use_shareNum);
                if (null == i)
                    this.shareNum = 1,
                    Laya.LocalStorage.setItem(a["default"].LocalStorage.use_shareNum, t + ";1");
                else {
                    var o = i.split(";");
                    t == o[0] ? this.shareNum = Number(o[1]) : (this.shareNum = 1,
                    Laya.LocalStorage.setItem(a["default"].LocalStorage.use_shareNum, t + ";1"))
                }
            }
            ,
            ...
            e.prototype.addShareNum = function() {
                ...
                var e = new Date
                  , t = e.getFullYear().toString() + "," + (e.getMonth() + 1).toString() + "," + e.getDate().toString();
                Laya.LocalStorage.setItem(a["default"].LocalStorage.use_shareNum, t + ";" + this.shareNum.toString())
            }
            ,
            e
        }();
        ...
        var a = e("../model/Global")
          ...
          , g = function(e) {
            ...
            t.prototype.init = function() {
                ...
                var t = this;
                this.loadImage(a["default"].boomConfigs[e], Laya.Handler.create(t, function() {
                    t.pivotX = .5 * t.width,
                    t.pivotY = .5 * t.height,
            ...
            t.prototype.fireBullet = function() {
                if (this.isAtt) {
                    if (this.fireDisAdd++,
                    a["default"].doubleFire_totalTime > 0 && this.fireDisAdd++,
                    this.fireDisAdd >= this.fireDis) {
                        this.fireDisAdd = 0;
                        var e = n.PoolMgr.getItem(a["default"].POOLNAME.Bullet + this.level);
                        if (e || (e = new o["default"](this.level)),
                        e.reset(),
                        e.x = this.x,
                        e.y = this.y,
                        e.angle = this.rotation,
                        this.fireEffect.alpha = 1,
                        Laya.Tween.to(this.fireEffect, {
                            alpha: 0
                        }, 60),
                        a["default"].doubleFire_totalTime > 0) {
        ...
        var a = e("./Block")
          ...
          , r = function(e) {
            ...
            t.prototype.clear = function(e) {
                ...
                this.die || (this.die = !0,
                e && (this.deathEff(),
                o["default"].Instance.curBlockLevelData && o["default"].Instance.curBlockLevelData.boss && (0 == this.colorType ? o["default"].Instance.killBlockNum += 1 : 1 == this.colorType && (o["default"].Instance.killRedBlockNum += 1)),
                n["default"].doubleGold_totalTime > 0 && (this.gold *= 5),
                l["default"].Instance.gold += 4 * this.gold,
                Laya.LocalStorage.setItem(n["default"].LocalStorage.user_gold, l["default"].Instance.gold.toString()),
                o["default"].Instance.LevelLayer.updateGold()),
                this.removeSelf(),
                s.PoolMgr.recover(n["default"].POOLNAME.BigBlock, this))
            }
            ,
            t
        }(a["default"]);
        ...
        var a = e("../model/Global")
          ...
          , d = function(e) {
            ...
            t.prototype.hited = function(e) {
                ...
                this.hp -= e,
                this.hp < 1 ? (this.clear(),
                !0) : (this.attackedEff(),
                this.text.changeText(r.utils.strShow(this.hp)),
                !1)
            }
            ,
            t.prototype.attackedEff = function() {
                ...
                e.rect.scaleX = 1,
                e.rect.scaleY = 1,
                this.attackedEffBol || (this.attackedEffBol = !0,
                Laya.Tween.to(e.rect, {
                    alpha: 0,
                    scaleX: 1.3,
                    scaleY: 1.3
            ...
            t.prototype.clear = function(e) {
                ...
                this.die || (this.die = !0,
                e && (this.deathEff(),
                l["default"].Instance.curBlockLevelData && l["default"].Instance.curBlockLevelData.boss && (0 == this.colorType ? l["default"].Instance.killBlockNum += 1 : 1 == this.colorType && (l["default"].Instance.killRedBlockNum += 1)),
                a["default"].doubleGold_totalTime > 0 && (this.gold *= 5),
                this.gold = this.gold * (1 + p["default"].gold),
                s["default"].Instance.gold += this.gold,
                Laya.LocalStorage.setItem(a["default"].LocalStorage.user_gold, s["default"].Instance.gold.toString()),
                l["default"].Instance.LevelLayer.updateGold()),
                this.removeSelf(),
                o.PoolMgr.recover(a["default"].POOLNAME.Block, this))
            }
            ,
            t
        }(Laya.Sprite);
        ...
        var a = e("../model/Global")
          ...
          , d = function(e) {
            ...
            t.prototype.init = function() {
                ...
                Laya.loader.load(a["default"].bulletConfigs[e], Laya.Handler.create(this, function(e) {
                    this.texture = e,
            ...
            t.prototype.forward = function() {
                this.angle != this.lastAngle && (this.lastAngle = this.angle,
                this.rotation = this.angle,
                this.speedX = this.speed * Math.sin(this.angle * s.utils.radian),
                this.speedY = -this.speed * Math.cos(this.angle * s.utils.radian)),
                this.x += this.speedX,
                this.y += this.speedY,
                this.trail && (this.trail.x = this.x,
                this.trail.y = this.y,
                this.trail.rotation = this.rotation)
            }
            ,
            t.prototype.changeAngle = function(e) {
                switch (l["default"].Instance.bulletSoundSpanAdd >= a["default"].bulletSoundSpan && (l["default"].Instance.bulletSoundSpanAdd = 0,
                r.SoundMgr.playSound(a["default"].SoundConfig.tanshe)),
                this.angle < 0 ? this.angle = 360 + this.angle : this.angle %= 360,
                e) {
        ...
        var a = e("../model/Global")
          ...
          , l = function(e) {
            ...
            t.prototype.init = function() {
                ...
                this.level > a["default"].boomConfigs.length && (e = a["default"].boomConfigs.length - 1);
                var t = this;
                t.loadImage(a["default"].boomConfigs[e], Laya.Handler.create(t, function() {
                    t.pivotX = .5 * t.width,
                    t.pivotY = .5 * t.height,
    ...
    23: [function(e, t, i) {
        ...
        var a = e("../model/Global")
          ...
          , n = function(e) {
            ...
            t.prototype.init = function() {
                var e = this;
                this.loadImage(a["default"].PanelUrl + "trail.png", Laya.Handler.create(this, function() {
                    e.width *= .3,
                    e.height *= .5,
                    e.pivotX = .5 * e.width
                }))
        ...
        var a = e("./Utils")
          , o = function() {
            ...
            e.prototype.setValue = function(e, t) {
                if (a.utils.isUndefined(e) || a.utils.isUndefined(t))
                    return void 0;
                var i, o = "$" + this.toStr(e), n = this.table[o];
                return a.utils.isUndefined(n) ? (this.nElements++,
                i = void 0) : i = n.value,
                this.table[o] = {
                    key: e,
                    value: t
            ...
            e.prototype.remove = function(e) {
                var t = "$" + this.toStr(e)
                  , i = this.table[t];
                return a.utils.isUndefined(i) ? void 0 : (delete this.table[t],
                this.nElements--,
                i.value)
            }
            ,
        ...
        var o = function() {
            ...
            return e.prototype.notify = function() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                var i, a = this;
                (i = a.callback).call.apply(i, [a.context].concat(e))
            }
            ,
        ...
        var a = e("../manager/PoolMgr")
          ...
          , r = function() {
            ...
            e.prototype.checkShowFailGuide = function() {
                if (this.dieTimes++,
                this.dieTimes > 1)
                    o["default"].doubleFire_totalTime > 0 ? o["default"].halfDifficult_totalTime <= 0 && this.setGuide(1) : this.setGuide(0);
                else {
                    this.timer || (this.timer = new Laya.Timer,
                    this.timer.once(18e4, this, this.onTimer));
            ...
            e.prototype.setGuide = function(e) {
                if (!this.showGuide) {
                    switch (this.showGuide = !0,
                    this.guideType = e,
                    this.timeLine = a.PoolMgr.getItem(o["default"].POOLNAME.TimeLine),
            ...
            e.prototype.clear = function(e) {
                this.showGuide && e == this.guideType && (this.showGuide = !1,
                this.guideType = -1,
                this.imgHand.removeSelf(),
                a.PoolMgr.recover(o["default"].POOLNAME.TimeLine, this.timeLine))
            }
            ,
            e
        }();
    ...
    27: [function(e, t, i) {
        ...
        var a = e("../model/Global")
          ...
          , l = function() {
            ...
            return e.prototype.init = function() {
                var e = Laya.LocalStorage.getItem(a["default"].LocalStorage.RampageDate)
                  , t = new Date
                  , i = t.getFullYear().toString() + "," + (t.getMonth() + 1).toString() + "," + t.getDate().toString()
                  , l = (new Date).getTime();
                if (e)
                    if (e == i) {
                        if (o["default"].Instance.loginDays = Number(Laya.LocalStorage.getItem(a["default"].LocalStorage.LoginDays)),
                        o["default"].Instance.haveRampageTimes = Number(Laya.LocalStorage.getItem(a["default"].LocalStorage.RampageHave)),
                        o["default"].Instance.useRampageTimes = Number(Laya.LocalStorage.getItem(a["default"].LocalStorage.RampageNum)),
                        o["default"].Instance.rampageVideoTimes = Number(Laya.LocalStorage.getItem(a["default"].LocalStorage.RampageVideoTimes)),
                        o["default"].Instance.rampageWaitTimes = Number(Laya.LocalStorage.getItem(a["default"].LocalStorage.RampageWaitTimes)),
                        o["default"].Instance.haveRampageTimes <= 0 && o["default"].Instance.useRampageTimes < a["default"].rampageSpanArr.length && o["default"].Instance.rampageWaitTimes < a["default"].rampageSpanArr.length - 2) {
                            var s = Number(a["default"].rampageSpanArr[o["default"].Instance.useRampageTimes])
                              , r = Number(Laya.LocalStorage.getItem(a["default"].LocalStorage.RampageTime))
                        ...
                        var u = Laya.LocalStorage.getItem(a["default"].LocalStorage.LoginDays)
                          , g = 0;
                        u && (g = Number(u)),
                        o["default"].Instance.loginDays = Number(g) + 1,
                        Laya.LocalStorage.setItem(a["default"].LocalStorage.LoginDays, o["default"].Instance.loginDays.toString()),
                        Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageDate, i),
                        o["default"].Instance.useRampageTimes = 0,
                        Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageNum, o["default"].Instance.useRampageTimes.toString()),
                        o["default"].Instance.haveRampageTimes = 0,
                        Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageHave, o["default"].Instance.haveRampageTimes.toString()),
                        o["default"].Instance.rampageVideoTimes = 0,
                        Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageVideoTimes, o["default"].Instance.rampageVideoTimes.toString()),
                        o["default"].Instance.rampageWaitTimes = 0,
                        Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageWaitTimes, o["default"].Instance.rampageWaitTimes.toString()),
                        Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageTime, l.toString()),
                    ...
                    o["default"].Instance.loginDays = 1,
                    Laya.LocalStorage.setItem(a["default"].LocalStorage.LoginDays, o["default"].Instance.loginDays.toString()),
                    Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageDate, i),
                    o["default"].Instance.useRampageTimes = 0,
                    Laya.LocalStorage.setItem(a["default"].LocalStorage.RampageNum, o["default"].Instance.useRampageTimes.toString()),
          ...
          , d = function(e) {
            ...
            t.prototype.nextStep = function() {
                ...
                if (e >= this.guideSteps.length) {
                    if (r["default"].Instance.showGuide++,
                    Laya.LocalStorage.setItem(s["default"].LocalStorage.guide, r["default"].Instance.showGuide.toString()),
                    this.buyTime < 2 && r["default"].Instance.gold >= p["default"].BulletDic.getValue(1).gold && n["default"].Instance.ComposeLayer.cannonArr.length < 10)
                        return void this.buyTime++;
                    ...
                    t.tip && (this.labDes.text = l["default"].getText(t.tip),
                    this.labDes.pos(t.tipx + n["default"].Instance.ComposeLayer.x, t.tipy)),
                    t.tip1 && (this.labDes1.text = l["default"].getText(t.tip1),
                    this.labDes1.pos(t.tipx1 + n["default"].Instance.ComposeLayer.x, t.tipy1)),
                    t.good && (this.labGood.text = l["default"].getText(t.good),
                    this.labGood.pos(t.goodx + n["default"].Instance.ComposeLayer.x, t.goody)),
                    this.imgHand.visible = !0,
                    0 == e ? (this.imgHand.y = n["default"].Instance.ComposeLayer.y + 256,
                    this.imgHand.x = 289 + n["default"].Instance.ComposeLayer.x,
                    this.timeline.to(this.imgHand, {
                    ...
                    }, 500).play(0, !0)) : 1 == e ? (this.imgHand.y = n["default"].Instance.ComposeLayer.y + 256,
                    this.imgHand.x = 374 + n["default"].Instance.ComposeLayer.x,
                    this.timeline.destroy(),
                    ...
                    }, 500).play(0, !0)) : 2 == e && (window.drawerAd && window.drawerAd.close(),
                    this.imgHand.y = n["default"].Instance.ComposeLayer.y + 493,
                    this.imgHand.x = 466 + n["default"].Instance.ComposeLayer.x,
                    this.imgHand.scaleX = -1,
                    this.imgHand.rotation = 180,
                    this.timeline = new Laya.TimeLine,
                    this.timeline.to(this.imgHand, {
                        scaleX: -.8,
          ...
          , o = function() {
            ...
            return e.getText = function(e, t) {
                ...
                if (null == t)
                    ...
                    for (var n = i.split("#"), l = n.length, s = t.length, r = 0; l > r; r++)
                        o += n[r],
                        s > r && (o += t[r]);
                return o
            }
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , h = function(e) {
            function t(i) {
                ...
                t.Inst = a,
                a.type = i,
                a.btn_time1.text = "+" + o["default"].autoSynthesisTime / 60 + "Minute",
                a.btn_time2.text = "+" + o["default"].autoSynthesisTime / 60 + "Minute",
                a.btn_close.on(Laya.Event.CLICK, a, a.onClose),
                a.label_close.on(Laya.Event.CLICK, a, a.onClose),
                a.btn_autoCompose.visible = !1,
                a.btn_douGold.visible = !1,
                a.btn_douFire.visible = !1,
                a.btn_halfDifficult.visible = !1,
                a.type) {
            ...
            t.prototype.onWatchVideo = function() {
                if (!this.isOntap)
                    if (l.SoundMgr.playSound(o["default"].SoundConfig.buttonClick),
            ...
            t.prototype.setAutoStatus = function() {
                ...
                n["default"].showToast(this.labTitle.text + "time+" + e / 60 + "Minute"),
            ...
            t.prototype.setDoubleGold = function() {
                n["default"].showToast(this.labTitle.text + "time+" + o["default"].autoSynthesisTime / 60 + "Minute"),
            ...
            t.prototype.watchEnd = function(e, t) {
                if (this.isOntap = !1,
                0 == e)
                    switch (n["default"].Instance.aldSendEvent(this.labTitle.text, {
                    ...
                    1 == e ? n["default"].showToast(p["default"].getText("16")) : 2 == e && n["default"].showToast(p["default"].getText("loadFail"))
            }
            ,
            t.prototype.onClose = function() {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , h = function(e) {
            ...
            t.prototype.init = function() {
                ...
                0 == this.type || 2 == this.type ? (this.btn_Get.visible = !0,
                this.btnGetShare.visible = !1,
                this.btnGetVideo.visible = !1,
                this.labDes.text = p["default"].getText("Gift0"),
                this.btn_Get.on(Laya.Event.CLICK, this, this.onGet),
                this.giftBagData = l["default"].getRamGift(),
                this.imgIcon.skin = n["default"].GiftUrl + "kejiui_hexin_" + this.giftBagData.type.toString() + ".png",
                this.labDes1.visible = !1) : 1 == this.type && (this.labDes1.visible = !0,
                this.leftTimes = n["default"].giftVideoNum - d["default"].Instance.rampageVideoTimes,
                console.log("this.leftTimes  ", this.leftTimes),
                this.labDes.text = p["default"].getText("Gift1", [this.leftTimes.toString()]),
                this.btn_Get.visible = !1,
                this.btnGetShare.visible = !1,
                true ? this.btnGetVideo.visible = !0 : this.btnGetVideo.visible = !1,
                this.btnGetVideo.on(Laya.Event.CLICK, this, this.onGetVideo),
                u.EventHelper.register(n["default"].CUSTOMEVENT.WatchADFinish, this.watchEnd, this)),
                r["default"].showBanner()
            }
            ,
            t.prototype.onIconClick = function() {
                if (o.SoundMgr.playSound(n["default"].SoundConfig.buttonClick),
                1 == this.type)
                    r["default"].showToast(p["default"].getText("Gift9"));
                else {
            ...
            ,
            t.prototype.getSuccess = function() {
                (0 == this.type || 2 == this.type) && (this.giftBagData.belong = 1,
                s["default"].Instance.giftPanel.handleBag(this.giftBagData, 0),
                0 == this.type && s["default"].Instance.giftPanel.getReturn(),
                r["default"].showToast(p["default"].getText("GetSuccess")))
            }
            ,
            ...
            ,
            t.prototype.watchEnd = function(e, t) {
                0 == e && (t == r.WATCHTYP.GetGift ? (s["default"].Instance.giftPanel.videoGet(),
                this.onClose()) : 1 == e ? r["default"].showToast(p["default"].getText("16")) : 2 == e && r["default"].showToast(p["default"].getText("loadFail")))
            }
            ,
            t.prototype.onClose = function() {
                o.SoundMgr.playSound(n["default"].SoundConfig.buttonClick),
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , f = function(e) {
            ...
            t.prototype.init = function() {
                ...
                true ? this.btn_surplusNum_video.visible = !0 : this.btn_surplusNum_video.visible = !1,
            ...
            ,
            t.prototype.onWatchVideo = function() {
                return this.isOntap ? void 0 : (c.SoundMgr.playSound(n["default"].SoundConfig.buttonClick),
                p["default"].Instance.aldSendEvent("获取Gold", {
                    "点击按钮": "Click video button"
                }),
                this.num <= 0 ? void p["default"].showToast(u["default"].getText("getGold")) : void (n["default"].videoADID ? o["default"].Instance.watchTypeNum(p.WATCHTYP.GetGold) ? p["default"].showRewardAd(p.WATCHTYP.GetGold) : this.getGoldSucc() : (this.isOntap = !0,
                this.getGoldSucc())))
            }
            ,
            t.prototype.watchEnd = function(e, t) {
                t == p.WATCHTYP.GetGold && (this.isOntap = !1,
                0 == e ? (p["default"].Instance.aldSendEvent("获取Gold", {
                    "点击按钮": "成功获取视频"
                }),
                this.getGoldSucc()) : 1 == e ? (p["default"].Instance.aldSendEvent("获取Gold", {
                    "点击按钮": "失败获取视频"
                }),
            ...
            t.prototype.getGoldSucc = function() {
                ...
                Laya.LocalStorage.setItem(n["default"].LocalStorage.user_gold, o["default"].Instance.gold.toString()),
            ...
            ,
            t.prototype.onClose = function() {
                this.isOntap || (c.SoundMgr.playSound(n["default"].SoundConfig.buttonClick),
                this.close(),
                s["default"].Instance.successState = !1,
                this.btn_surplusNum_video.off(Laya.Event.CLICK, this, this.onWatchVideo),
                d.EventHelper.remove(n["default"].CUSTOMEVENT.WatchADFinish, this.watchEnd, this),
                this.btn_close.off(Laya.Event.CLICK, this, this.onClose),
                this.label_close.off(Laya.Event.CLICK, this, this.onClose),
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , l = function(e) {
            ...
            t.prototype.init = function() {
                var e = this
                  , t = "";
                1 == this.type ? (this.labTitle.text = o["default"].getText("14"),
                t = n["default"].PanelUrl + "GunmountUI_1.png") : 2 == this.type && (this.labTitle.text = o["default"].getText("15"),
                t = n["default"].PanelUrl + "upgradeIcon.png"),
                this.imgBattery.loadImage(t, Laya.Handler.create(this, function() {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , g = function(e) {
            ...
            t.prototype.init = function() {
                ...
                0 == this.type ? (this.btn_Off.visible = !1,
                this.btn_On.visible = !0) : 1 == this.type ? (this.btn_Off.visible = !0,
                this.btn_On.visible = !1) : 2 == this.type && (this.btn_Off.visible = !1,
                this.btn_On.visible = !1,
                this.btn_decompose.visible = !1),
                ...
                var e = 1
                  , t = 0;
                2 == this.giftBagData.type || 8 == this.giftBagData.type ? (e = .01,
                t = Math.floor(this.giftBagData.effect * e)) : t = this.giftBagData.effect * e,
                this.labDes.text = s["default"].getText("GiftDes" + this.giftBagData.type.toString(), [t.toString()]);
                for (var i, a, o = 0, l = this.imgInfo.numChildren, p = 0; l > p; p++)
                    i = this.imgInfo.getChildAt(p),
                    o = 1e3 * this.giftBagData.type + p + 1,
                    a = r["default"].GiftAttrDic.getValue(o),
                    a ? (i.visible = !0,
                    i.text = s["default"].getText("GiftColorDes" + this.giftBagData.type.toString(), [(p + 1).toString(), (a.min * e).toString(), (a.max * e).toString()])) : i.visible = !1;
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , f = function(e) {
            function t(i) {
                ...
                var g = a;
                g.img_battery.loadImage(o["default"].boomConfigs[d], Laya.Handler.create(g, function() {
                ...
                true ? a.btn_double_video.visible = !0 : a.btn_double_video.visible = !1,
            ...
            return __extends(t, e),
            t.prototype.onWatchVideo = function() {
                this.isOntap || (d.SoundMgr.playSound(o["default"].SoundConfig.buttonClick),
                n["default"].Instance.aldSendEvent("Unlock new armor", {
                    "点击按钮": "Click video button"
                }),
            ...
            ,
            t.prototype.watchEnd = function(e, t) {
                t == n.WATCHTYP.NewBattery_Gold && (0 == e ? (n["default"].Instance.aldSendEvent("Unlock new armor", {
                    "点击按钮": "Succeed to get video"
                }),
                this.getGoldSucc(2)) : 1 == e ? (n["default"].Instance.aldSendEvent("Unlock new armor", {
                    "点击按钮": "Failed to get video"
                }),
            ...
            t.prototype.getGoldSucc = function(e) {
                ...
                Laya.LocalStorage.setItem(o["default"].LocalStorage.user_gold, r["default"].Instance.gold.toString()),
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , f = function(e) {
            ...
            t.prototype.init = function() {
                ...
                true ? this.btnThreeGetVideo.visible = !0 : this.btnThreeGetVideo.visible = !1,
            ...
            t.prototype.watchEnd = function(e, t) {
                if (t == d.WATCHTYP.OfflineGold)
                    if (0 == e) {
                        ...
                        1 == e ? d["default"].showToast(u["default"].getText("4")) : 2 == e && d["default"].showToast(u["default"].getText("loadFail"))
            }
            ,
            t.prototype.close = function() {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , p = function(e) {
            ...
            t.prototype.onSubmit = function() {
                n.SoundMgr.playSound(l["default"].SoundConfig.buttonClick);
                for (var e = 0, t = 0; t < this.box.numChildren; t++) {
                ...
                0 == e ? o["default"].showToast(r["default"].getText("suggest1")) : (o["default"].showToast(r["default"].getText("suggest2")),
                o["default"].Instance.aldSendEvent("投诉建议", {
                    "点击按钮": "提交按钮"
                }),
                this.clear(),
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , y = function(e) {
            ...
            t.prototype.init = function() {
                ...
                var e = Math.random();
                e <= d["default"].Instance.curBlockLevelData.winGift ? (this.imgGold.x = 243,
                this.imgGift.visible = !0,
                this.giftBagData = g["default"].getRamGift(),
                this.imgGiftIcon.skin = l["default"].GiftUrl + "kejiui_hexin_" + this.giftBagData.type.toString() + ".png",
                this.labLV.text = "Lv:" + this.giftBagData.color.toString(),
                this.labQuality.text = p["default"].getText("GiftColor" + this.giftBagData.color.toString()),
                d["default"].Instance.giftPanel.handleBag(this.giftBagData, 0)) : (this.imgGift.visible = !1,
                this.imgGold.x = 317),
            ...
            ,
            t.prototype.onWatchVideo = function() {
                this.isOntap || (s.SoundMgr.playSound(l["default"].SoundConfig.buttonClick),
                r["default"].Instance.aldSendEvent("boss过关弹出", {
                    "点击按钮": "Click video button"
                }),
                l["default"].videoADID ? o["default"].Instance.watchTypeNum(r.WATCHTYP.BossPass) ? r["default"].showRewardAd(r.WATCHTYP.BossPass) : (this.btn_surplusNum_video.visible = !1,
                this.imgGift.visible && this.deathEff(2)) : this.isOntap = !0)
            }
            ,
            t.prototype.watchEnd = function(e, t) {
                t == r.WATCHTYP.BossPass && (this.isOntap = !1,
                0 == e ? (r["default"].Instance.aldSendEvent("boss过关弹出", {
                    "点击按钮": "成功获取视频"
                }),
                this.btn_surplusNum_video.visible = !1,
                this.imgGift.visible && this.deathEff(2)) : 1 == e ? (r["default"].Instance.aldSendEvent("boss过关弹出", {
                    "点击按钮": "失败获取视频"
                }),
            ...
            t.prototype.deathEff = function(e) {
                ...
                var i = this.imgGold.x
                  , a = this.imgGold.y;
                if (t.init(new Laya.Point(i,a), 2, 2),
                d["default"].Instance.LevelLayer.addChild(t),
                o["default"].Instance.gold += this.gold,
                Laya.LocalStorage.setItem(l["default"].LocalStorage.user_gold, o["default"].Instance.gold.toString()),
                d["default"].Instance.LevelLayer.updateGold(),
                2 == e) {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , _ = function(e) {
            ...
            t.prototype.initData = function() {
                var e = Laya.LocalStorage.getItem(o["default"].LocalStorage.BatteryLevel);
                e && (p["default"].Instance.batteryLevel = Number(e)),
                Laya.LocalStorage.getItem(o["default"].LocalStorage.autoComposeTime) && (o["default"].autoSynthesis_totalTime = Number(Laya.LocalStorage.getItem(o["default"].LocalStorage.autoComposeTime))),
                Laya.LocalStorage.getItem(o["default"].LocalStorage.doubleGoldTime) && (o["default"].doubleGold_totalTime = Number(Laya.LocalStorage.getItem(o["default"].LocalStorage.doubleGoldTime))),
                Laya.LocalStorage.getItem(o["default"].LocalStorage.doubleFireTime) && (o["default"].doubleFire_totalTime = Number(Laya.LocalStorage.getItem(o["default"].LocalStorage.doubleFireTime))),
                Laya.LocalStorage.getItem(o["default"].LocalStorage.halfDifficultTime) && (o["default"].halfDifficult_totalTime = Number(Laya.LocalStorage.getItem(o["default"].LocalStorage.halfDifficultTime)))
            }
            ,
            t.prototype.init = function() {
                this.timeline = new Laya.TimeLine,
                ...
                for (var e = ((this.sp_box.width - 80) / 4,
                0); 5 > e; e++) {
                ...
                this.setBatteryLock();
                for (var a = 0; a < this.BatteryPosArr.length; a++)
                    1 == this.batteryDeblockStatus[a] && this.createBattery(Number(s["default"].Instance.batteryPos[a]), this.BatteryPosArr[a]);
                for (var n = 0; n < this.CannonPosArr.length; n++)
                    this.createNewCannon(Number(s["default"].Instance.cannonPos[n]), this.CannonPosArr[n]);
                this.updateCreate(),
            ...
            t.prototype.checkGold = function() {
                ...
                if (p["default"].Instance.gold >= e ? this.img_hot1.visible = !0 : this.img_hot1.visible = !1,
                s["default"].Instance.curLevel < 11)
                    this.img_hot2.visible = !1;
                else {
                    for (var t = [], i = 0; i < p["default"].Instance.techLevelArr.length; i++) {
                        ...
                        var l = void 0
                          , r = void 0;
                        0 == i ? (l = a,
                        r = o.paotai_gold) : 1 == i ? (l = o.fire_effect,
                        r = o.fire_gold) : 2 == i && (l = o.outline_effect,
                        r = o.outline_gold),
                        t.push(r)
                    }
                    for (var d = !1, u = 0; u < t.length; u++)
                        if (p["default"].Instance.gold >= t[u]) {
                            d = !0,
            ...
            t.prototype.updateImg = function() {
                ...
                var t = this;
                this.img_battery.loadImage(o["default"].boomConfigs[e], Laya.Handler.create(t, function() {
            ...
            t.prototype.getLockBatteryPos = function() {
                for (var e = [], t = 0, i = 1; i < o["default"].unlockConfig.length; i++)
                    p["default"].Instance.maxLevel - 1 == o["default"].unlockConfig[i].ID && (1 == i ? e = this.BatteryPosArr[1] : 2 == i ? e = this.BatteryPosArr[3] : 3 == i ? e = this.BatteryPosArr[0] : 4 == i ? e = this.BatteryPosArr[4] : 5 == i && (e = [this.btn_tech.x, this.btn_tech.y]),
                    t = Number(o["default"].unlockConfig[i].type));
                return {
                    pos: e,
                    type: t
                }
            ...
            t.prototype.setBatteryLock = function() {
                for (var e = this, t = 0; t < o["default"].unlockConfig.length; t++)
                    p["default"].Instance.maxLevel - 1 >= Number(o["default"].unlockConfig[t].ID) && (0 == t ? this.batteryDeblockStatus[2] = 1 : 1 == t ? this.batteryDeblockStatus[1] = 1 : 2 == t ? this.batteryDeblockStatus[3] = 1 : 3 == t ? this.batteryDeblockStatus[0] = 1 : 4 == t && (this.batteryDeblockStatus[4] = 1));
                for (var t = 0; t < e.sp_box_battery.numChildren; t++) {
                    var i = e.sp_box_battery.getChildAt(t)
                      , a = i.getChildByName("fontItem")
                      , n = void 0;
                    if (a || (n = i.getChildByName("fontUI"),
                    a = new x["default"](0,"center"),
                    a.name = "fontItem",
                    a.pos(n.x, n.y),
                    n.visible = !1,
                    i.addChild(a)),
                    1 == e.batteryDeblockStatus[t]) {
                        var l = i.getChildByName("lock");
                        l.visible = !1,
                        a && i.removeChild(a)
                    } else
                        "sp2" == i.name ? this.setBatteryLevelShow(1, a) : "sp3" == i.name ? this.setBatteryLevelShow(2, a) : "sp4" == i.name ? this.setBatteryLevelShow(3, a) : "sp5" == i.name && this.setBatteryLevelShow(4, a)
                }
            }
            ,
            t.prototype.setBatteryLevelShow = function(e, t) {
                t && (t.setNumStr(o["default"].unlockConfig[e].ID),
                p["default"].Instance.maxLevel - 1 >= Number(o["default"].unlockConfig[e - 1].ID) && p["default"].Instance.maxLevel - 1 < Number(o["default"].unlockConfig[e].ID) ? t.visible = !0 : t.visible = !1)
            }
            ,
            ...
            t.prototype.nextGuide = function() {
                s["default"].Instance.guide && !p["default"].Instance.guideStop && (1 == p["default"].Instance.showGuide ? s["default"].Instance.guide.hide() : (p["default"].Instance.showGuide++,
                Laya.LocalStorage.setItem(o["default"].LocalStorage.guide, p["default"].Instance.showGuide.toString()),
                s["default"].Instance.guide.nextStep()))
            }
            ,
            ...
            t.prototype.setStorage = function(e, t) {
                ...
                if (-1 != i) {
                    ...
                    Laya.LocalStorage.setItem(o["default"].LocalStorage.batteryPos, a)
                } else {
                    for (var n = 0; n < this.CannonPosArr.length; n++)
                        if (this.CannonPosArr[n][0] == t[0] && this.CannonPosArr[n][1] == t[1]) {
                            i = n;
                            break
                        }
                    ...
                    Laya.LocalStorage.setItem(o["default"].LocalStorage.CannonPos, a)
                }
            }
            ,
            t.prototype.eff = function(e, t, i) {
                if (e && t) {
                    ...
                    Laya.timer.once(300, a, function() {
                        ...
                        e.clear(),
                        t.clear(),
                        0 == i ? (a.createNewCannon(o, n, 1),
                        a.nextGuide()) : 1 == i && a.createBattery(o, n, 1),
            ...
            t.prototype.createNew = function() {
                if (y.SoundMgr.playSound(o["default"].SoundConfig.buttonClick),
                !this.isCompose)
                    if (this.nextGuide(),
                    s["default"].Instance.failGuide.clear(2),
                    this.cannonArr.length >= 10) {
                        if (r["default"].showToast(I["default"].getText("compose3")),
                        !(o["default"].autoSynthesis_totalTime > 0) && true) {
                        ...
                        for (var a = s["default"].Instance.cannonPos.length, n = 0; a > n; n++)
                            if ("0" == s["default"].Instance.cannonPos[n]) {
            ...
            t.prototype.createNew2 = function() {
                ...
                o["default"].autoSynthesis_totalTime > 0 && (o["default"].isAutoSynthesis = !0);
                for (var e = s["default"].Instance.cannonPos.length, t = 0; e > t; t++)
                    if ("0" == s["default"].Instance.cannonPos[t]) {
            ...
            t.prototype.consumeGold = function(e, t) {
                ...
                Laya.LocalStorage.setItem(o["default"].LocalStorage.user_gold, p["default"].Instance.gold.toString()),
                s["default"].Instance.LevelLayer.updateGold()
            }
            ,
            t.prototype.batteryUpgrade = function(e) {
                ...
                Laya.LocalStorage.setItem(o["default"].LocalStorage.BatteryLevel, e.toString())
            }
            ,
            t.prototype.autoCompose = function() {
                if (!this.isCompose)
                    if (this.cannonArr.length > 1) {
                        for (var e = !1, t = 999, i = this.levelDic.keys().length, a = void 0, n = void 0, l = 0; i > l; l++)
                            a = this.levelDic.keys()[l],
                            n = this.levelDic.getValue(a),
                            n >= 2 && t > a && (t = a,
                            e = !0);
                        if (e) {
                            i = this.cannonArr.length;
                            for (var s = 0, r = void 0, p = void 0, l = 0; i > l; l++)
                                if (0 == s && this.cannonArr[l].level == t)
                                    p = this.cannonArr[l],
                                    s++;
            ...
            t.prototype.loopAutoCountdown = function(e) {
                ...
                o["default"].autoSynthesis_totalTime <= 0 && (Laya.timer.clear(this, this.loopAutoCountdown),
                this.sp_auto.visible = !0,
                r["default"].showToast(I["default"].getText("TimeType8")),
                this.img_autoCountdown.mask = null),
                Laya.LocalStorage.setItem(o["default"].LocalStorage.autoComposeTime, o["default"].autoSynthesis_totalTime.toString())
            }
            ,
            ...
            t.prototype.loopDoubleGoldCountdown = function(e) {
                ...
                o["default"].doubleGold_totalTime <= 0 && (Laya.timer.clear(this, this.loopDoubleGoldCountdown),
                this.btn_douGold.visible = !0,
                r["default"].showToast(I["default"].getText("TimeType9")),
                this.img_goldCountdown.mask = null),
                Laya.LocalStorage.setItem(o["default"].LocalStorage.doubleGoldTime, o["default"].doubleGold_totalTime.toString())
            }
            ,
            ...
            t.prototype.loopDoubleFireCountdown = function(e) {
                ...
                o["default"].doubleFire_totalTime <= 0 && (Laya.timer.clear(this, this.loopDoubleFireCountdown),
                this.btn_douFire.visible = !0,
                r["default"].showToast(I["default"].getText("TimeType10")),
                this.img_fireCountdown.mask = null,
                s["default"].Instance.refreshFightingCapacity()),
                Laya.LocalStorage.setItem(o["default"].LocalStorage.doubleFireTime, o["default"].doubleFire_totalTime.toString())
            }
            ,
            ...
            t.prototype.loopHalfDifficultCountdown = function(e) {
                ...
                o["default"].halfDifficult_totalTime <= 0 && (Laya.timer.clear(this, this.loopHalfDifficultCountdown),
                this.btn_halfDifficult.visible = !0,
                r["default"].showToast(I["default"].getText("TimeType11")),
                this.img_halfDifficultCountdown.mask = null),
                Laya.LocalStorage.setItem(o["default"].LocalStorage.halfDifficultTime, o["default"].halfDifficult_totalTime.toString())
            }
            ,
            t.prototype.createAutoSkin = function() {
                if (y.SoundMgr.playSound(o["default"].SoundConfig.buttonClick),
                r["default"].Instance.aldSendEvent("自动合并", {
                    "点击按钮": "icon点击"
                }),
                o["default"].autoSynthesis_totalTime > 3240)
                    r["default"].showToast(I["default"].getText("compose4"));
                else if (true) {
                    var e = new g["default"](h.TimeType.AutoCompose);
                    e.popup()
                } else
                    r["default"].showToast(I["default"].getText("loadFail"))
            }
            ,
            t.prototype.createTech = function() {
                ...
                p["default"].Instance.maxLevel < 11 ? r["default"].showToast(I["default"].getText("compose5")) : (s["default"].Instance.pouseGame = !0,
                null == this.techPanel && (this.techPanel = new f["default"],
                this.techPanel.x = .5 * (Laya.stage.width - this.techPanel.width)),
                Laya.stage.addChild(this.techPanel))
            }
            ,
            t.prototype.onDouGold = function() {
                if (y.SoundMgr.playSound(o["default"].SoundConfig.buttonClick),
                s["default"].Instance.failGuide.clear(4),
                r["default"].Instance.aldSendEvent("icon点击", {
                    "按钮点击": "点击Gold*2"
                }),
                o["default"].doubleGold_totalTime > 3240)
                    r["default"].showToast(I["default"].getText("compose6"));
                else if (true) {
            ...
            t.prototype.onDouFire = function() {
                ...
                s["default"].Instance.failGuide.clear(0),
                o["default"].doubleFire_totalTime > 3240)
                    r["default"].showToast(I["default"].getText("compose6"));
                else if (true) {
            ...
            t.prototype.onHalfDifficult = function() {
                ...
                s["default"].Instance.failGuide.clear(1),
                o["default"].halfDifficult_totalTime > 3240)
                    r["default"].showToast(I["default"].getText("compose6"));
                else if (true) {
    ...
    42: [function(e, t, i) {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , g = function(e) {
            ...
            ,
            t.prototype.showFail2 = function(e) {
                this.mouseEnabled = !0,
                Laya.stage.addChild(this),
                ...
                setTimeout(function() {
                    ...
                    Laya.Tween.to(t.bg, {
                        alpha: 0
                    }, 1e3, null, Laya.Handler.create(t, function() {
            ...
            ,
            t.prototype.showSuccess2 = function() {
                this.mouseEnabled = !1,
                ...
                this.tipBg.visible = !1,
                this.bg.alpha = 0,
                n["default"].Instance.curBlockLevelData && n["default"].Instance.curBlockLevelData.boss ? (true && r["default"].showRewardAd(r.WATCHTYP.NoReward),
                setTimeout(function() {
                    var e = new u["default"];
                    e.popup()
                }, 1e3)) : (this.labText.x = 375,
                this.labText.y = -100,
                this.labText.alpha = 1,
                this.labText.text = o["default"].getText("2"),
                Laya.Tween.to(this.labText, {
                    y: 629
                }, 1e3, null, null),
                Laya.Tween.to(this.labText, {
            ...
            t.prototype.showUnlockBattery = function() {
                ...
                t.length > 0 ? setTimeout(function() {
                    ...
                    i.imgBattery.loadImage(a, Laya.Handler.create(i, function() {
                    ...
                    setTimeout(function() {
                        ...
                        var a = 1e3
                          , r = 0;
                        1 == e.type ? (a = 1e3,
                        r = t[1] + n["default"].Instance.ComposeLayer.y + n["default"].Instance.ComposeLayer.sp_box_battery.y) : 2 == e.type && (a = 1500,
                        r = t[1] + n["default"].Instance.ComposeLayer.y),
                        Laya.Tween.to(i.imgBattery, {
                            x: t[0],
                            y: r
                        }, a, null, Laya.Handler.create(i, function() {
            ...
            t.prototype.flyIcon = function(e) {
                ...
                t.imgBattery.loadImage(i, Laya.Handler.create(t, function() {
                ...
                Laya.Tween.to(t.imgBattery, {
                    x: 123,
                    y: a
                }, 1500, null, Laya.Handler.create(t, function() {
                    l.SoundMgr.playSound(s["default"].SoundConfig.buttonClick),
                    t.imgBattery.visible = !1,
                    t.labText.alpha = 0,
                    t.showUnlockBattery()
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , n = function(e) {
            ...
            t.prototype.init = function(e, t, i) {
                ...
                this.type = e,
                this.sc = i,
                0 == this.type ? (this.urlStr = "common_shadownum_",
                this.spWidth = 16 * this.sc) : 1 == this.type && (this.urlStr = "common_num_",
                this.spWidth = 20 * this.sc)
            }
            ,
            t.prototype.setNumStr = function(e) {
                if (this.str != e) {
                    ...
                    for (var i, a = this, n = 0; t > n; n++)
                        this.spArr[n] ? (i = this.spArr[n],
                        i.name != this.str[n] && (i.loadImage(o["default"].PanelUrl + this.urlStr + this.str[n] + ".png"),
                        i.name = this.str[n])) : (i = new Laya.Sprite,
                        i.loadImage(o["default"].PanelUrl + this.urlStr + this.str[n] + ".png"),
                        i.name = this.str[n],
                        this.spArr.push(i),
                        this.addChild(i)),
                        "left" == a.align ? i.x = a.spWidth * n : "center" == a.align ? i.x = a.spWidth * (n - .5 * t) : "right" == a.align && (i.x = a.spWidth * (n - t)),
                        "K" == this.str[n] || "B" == this.str[n] || "M" == this.str[n] || "G" == this.str[n] || "T" == this.str[n] ? (i.scaleX = i.scaleY = this.sc * this.letterScale,
                        i.y = 5 * this.sc) : (i.scaleX = i.scaleY = this.sc,
                        i.y = 0);
                    for (; this.spArr.length > t; )
                        this.spArr.pop().removeSelf()
                }
            }
            ,
            t.prototype.clear = function() {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , m = function(e) {
            ...
            t.prototype.refreshGiftEquip = function() {
                ...
                for (var e, t, i, a, o, s, r, p, u, g = this.giftEquip.numChildren, h = l["default"].Instance.giftEquipArr.length, c = !0, m = 0; g > m; m++)
                    if (t = this.giftEquip.getChildAt(m),
                    i = t.getChildByName("bg"),
                    a = t.getChildByName("lock"),
                    o = t.getChildByName("icon"),
                    s = t.getChildByName("labLv"),
                    r = t.getChildByName("lockLevel"),
                    p = r.getChildByName("labOpen"),
                    u = this.imgInfo.getChildAt(m),
                    p.text = n["default"].giftUnlockArr[m],
                    l["default"].Instance.maxLevel - 1 >= Number(n["default"].giftUnlockArr[m]))
                        if (i.visible = !0,
                        o.visible = !0,
                        s.visible = !0,
                        a.visible = !1,
                        ...
                        h > m) {
                            ...
                            var v = 1
                              , I = 0;
                            2 == e.type || 8 == e.type ? (v = .01,
                            I = Math.floor(e.effect * v)) : I = e.effect * v,
                        ...
                        a.visible = !1,
                        r.visible = !0,
                        t.on(Laya.Event.CLICK, this, this.onClickEqiupGift, [2, p.text])) : t.on(Laya.Event.CLICK, this, this.onClickEqiupGift, [3]),
                        u.text = ""
            }
            ,
            t.prototype.onClickEqiupGift = function(e, t) {
                ...
                1 == e) {
                    ...
                    2 == e ? s["default"].showToast(f["default"].getText("compose1", [t])) : 3 == e && s["default"].showToast(f["default"].getText("compose2"))
            }
            ,
            t.prototype.onProperty = function() {
                var e = l["default"].Instance.giftEquipArr.length;
                0 >= e ? s["default"].showToast(f["default"].getText("Gift11")) : (this.infoBg.visible = !0,
                this.sp_info.visible = !0)
            }
            ,
            ...
            t.prototype.refreshList = function() {
                ...
                for (var t = 0; t < l["default"].Instance.giftBagArr.length; t++)
                    e = new d.GiftBagData,
                    e.index = t,
            ...
            t.prototype.handleBag = function(e, t) {
                ...
                case 1:
                    ...
                    Laya.LocalStorage.setItem(n["default"].LocalStorage.giftEquip, l["default"].Instance.giftEquipArr.toString()),
                    Laya.LocalStorage.setItem(n["default"].LocalStorage.giftEquipEffect, l["default"].Instance.giftEffectEquipArr.toString()),
                    this.refreshList(),
                ...
                case 2:
                    ...
                    break;
                case 3:
                    1 == e.belong ? (l["default"].Instance.giftBagArr.splice(e.index, 1),
                    l["default"].Instance.giftEffectBagArr.splice(e.index, 1),
                    this.refreshList()) : 2 == e.belong && (l["default"].Instance.giftEquipArr.splice(e.index, 1),
                    l["default"].Instance.giftEffectEquipArr.splice(e.index, 1),
                    l["default"].Instance.setGiftData(),
                    this.refreshGiftEquip(),
                    Laya.LocalStorage.setItem(n["default"].LocalStorage.giftEquip, l["default"].Instance.giftEquipArr.toString()),
                    Laya.LocalStorage.setItem(n["default"].LocalStorage.giftEquipEffect, l["default"].Instance.giftEffectEquipArr.toString())),
                ...
                Laya.LocalStorage.setItem(n["default"].LocalStorage.giftBag, l["default"].Instance.giftBagArr.toString()),
                Laya.LocalStorage.setItem(n["default"].LocalStorage.giftBagEffect, l["default"].Instance.giftEffectBagArr.toString())
            }
            ,
            t.prototype.checkCanEquip = function(e) {
                for (var t, i = this.giftBagDataEquipArr.length, a = 0; i > a; a++)
                    if (t = this.giftBagDataEquipArr[a],
                    t.type == e.type)
                        return t.color < e.color ? (l["default"].Instance.giftEquipArr.splice(t.index, 1),
                        l["default"].Instance.giftEffectEquipArr.splice(t.index, 1),
                        l["default"].Instance.giftEquipArr.push(e.id),
                        l["default"].Instance.giftEffectEquipArr.push(e.effect),
                        l["default"].Instance.giftBagArr.splice(e.index, 1),
                        l["default"].Instance.giftEffectBagArr.splice(e.index, 1),
                        l["default"].Instance.giftBagArr.push(t.id),
                        l["default"].Instance.giftEffectBagArr.push(t.effect),
                        l["default"].Instance.setGiftData(),
                        this.refreshGiftEquip(),
                        Laya.LocalStorage.setItem(n["default"].LocalStorage.giftEquip, l["default"].Instance.giftEquipArr.toString()),
                        Laya.LocalStorage.setItem(n["default"].LocalStorage.giftEquipEffect, l["default"].Instance.giftEffectEquipArr.toString()),
                        ...
                        !1;
                return this.leftHole <= 0 ? (s["default"].showToast(f["default"].getText("Gift2")),
                !1) : !0
            }
            ,
            ...
            t.prototype.onRampage = function() {
                if (o.SoundMgr.playSound(n["default"].SoundConfig.buttonClick),
                l["default"].Instance.haveRampageTimes > 0) {
            ...
            t.prototype.getReturn = function() {
                ...
                Laya.LocalStorage.setItem(n["default"].LocalStorage.RampageHave, l["default"].Instance.haveRampageTimes.toString()),
                l["default"].Instance.useRampageTimes++,
                Laya.LocalStorage.setItem(n["default"].LocalStorage.RampageNum, l["default"].Instance.useRampageTimes.toString()),
                l["default"].Instance.haveRampageTimes <= 0) {
                    var e = (new Date).getTime();
                    Laya.LocalStorage.setItem(n["default"].LocalStorage.RampageTime, e.toString()),
                    this.timeline.gotoTime(0),
                    this.timeline.pause(),
                    l["default"].Instance.useRampageTimes < n["default"].rampageSpanArr.length && l["default"].Instance.rampageWaitTimes < n["default"].rampageSpanArr.length - 2 && (this.rampageCountDown = Number(n["default"].rampageSpanArr[l["default"].Instance.useRampageTimes]),
                    this.rampageTotal = this.rampageCountDown)
                }
                this.startRampageTimer()
            }
            ,
            t.prototype.startRampageTimer = function() {
                l["default"].Instance.haveRampageTimes > 0 ? this.setRampageReady() : (this.labHaveRampage.text = "",
                this.labRampageTime.text = "",
                l["default"].Instance.useRampageTimes < n["default"].rampageSpanArr.length && (this.rampageTimer || (this.rampageTimer = new Laya.Timer),
                this.rampageCountDown > 0 && this.rampageTimer.loop(1e3, this, this.onRampageTimer)))
            }
            ,
            t.prototype.waitGet = function() {
                ...
                Laya.LocalStorage.setItem(n["default"].LocalStorage.RampageWaitTimes, l["default"].Instance.rampageWaitTimes.toString()),
            ...
            t.prototype.videoGet = function() {
                ...
                Laya.LocalStorage.setItem(n["default"].LocalStorage.RampageVideoTimes, l["default"].Instance.rampageVideoTimes.toString()),
            ...
            t.prototype.onRampageTimer = function() {
                if (this.rampageCountDown--,
                this.rampageCountDown <= 0)
                    this.rampageTimer.clear(this, this.onRampageTimer),
                    this.waitGet();
                else {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , h = function(e) {
            ...
            t.prototype.init = function() {
                ...
                this.setLevel();
                for (var u = 0, a = 0; a < this.sp_box.numChildren; a++) {
                ...
                this.text_gold.parent && (this.sp_gold.addChild(this.fontGold),
                this.fontGold.setNumStr(s.utils.strShow(l["default"].Instance.gold)),
                this.fontGold.x = this.text_gold.x,
                this.fontGold.y = this.text_gold.y,
                this.sp_gold.x = .5 * (this.width - (this.fontGold.width + this.fontGold.x)),
                this.text_gold.removeSelf()),
                this.labFightingCapacity.parent && (this.fightBg.addChild(this.fontFightCapacity),
                this.fontFightCapacity.x = this.labFightingCapacity.x,
                this.fontFightCapacity.y = this.labFightingCapacity.y,
                this.labFightingCapacity.removeSelf()),
            ...
            t.prototype.isBossLevel = function(e, t) {
                ...
                if (a && (a.skin = n["default"].PanelUrl + "Topui_bg_1.png"),
                i && i.boss) {
            ...
            t.prototype.setLevel = function() {
                if (this.levelArr = [],
                o["default"].Instance.curLevel < 2)
                    1 == o["default"].Instance.curLevel ? this.levelArr = [0, 1, 2] : 2 == o["default"].Instance.curLevel;
                else
                    for (var e = o["default"].Instance.curLevel - 1, t = o["default"].Instance.curLevel + 1, i = e; t >= i; i++)
            ...
            t.prototype.updateLevel_succ = function() {
                ...
                for (var l = 0, s = 0; s < e.sp_box.numChildren; s++) {
    ...
    47: [function(e, t, i) {
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , n = function(e) {
            ...
            t.prototype.close = function() {
                e.prototype.close.call(this),
                console.log("Close ", o["default"].PanelName.LogoPanel)
            }
            ,
            t
        }(a.ui.LogoPanelUI);
        ...
        var a = e("../../../ui/layaMaxUI")
          ...
          , h = function(e) {
            ...
            t.prototype.clickBuy = function() {
                if (u.SoundMgr.playSound(l["default"].SoundConfig.buttonClick),
                n["default"].Instance.gold >= this.techData.cost) {
                    n["default"].Instance.gold -= this.techData.cost,
                    Laya.LocalStorage.setItem(l["default"].LocalStorage.user_gold, n["default"].Instance.gold.toString());
                    var e = this.techData.curLevel + 1;
                    n["default"].Instance.techLevelArr[this.techData.index.toString()] = e.toString(),
                    Laya.LocalStorage.setItem(l["default"].LocalStorage.techLevel, n["default"].Instance.techLevelArr.toString());
            ...
            t.prototype.refreshList = function() {
                for (var e, t, i, a = [], o = 0; o < s["default"].Instance.techLevelArr.length; o++) {
                    ...
                    var p = void 0
                      , d = void 0;
                    0 == o ? (p = t,
                    d = i.paotai_gold) : 1 == o ? (p = i.fire_effect,
                    d = i.fire_gold) : 2 == o && (p = i.outline_effect,
                    d = i.outline_gold),
                    e.value = p,
    ...
    51: [function(e, t, i) {
        ...
        var a, o = Laya.View, n = Laya.Dialog, l = Laya.ClassUtils.regClass;
        !function(e) {
            var t = function(e) {
                function t() {
                    ...
                    child: [{
                        ...
                        child: [{
                            ...
                            props: {
                                ...
                                width: 505,
                                "var": "labDes",
                                text: "Get auto synthesis to free your hands",
                                height: 31,
                                fontSize: 30,
                                font: "SimHei",
                                color: "#3f3e3e",
                    ...
                    child: [{
                        ...
                        child: [{
                            ...
                            props: {
                                ...
                                width: 505,
                                "var": "labDes",
                                text: "Congratulations on getting a new core",
                                height: 32,
                                fontSize: 30,
                                font: "SimHei",
                                color: "#3f3e3e",
                        ...
                        child: [{
                            ...
                            child: [{
                                ...
                                props: {
                                    ...
                                    width: 365,
                                    "var": "labDes",
                                    text: "Claim Kernels by passing the Boss Stage",
                                    height: 24,
                                    fontSize: 24,
                                    font: "SimHei",
                                    color: "#000000",
