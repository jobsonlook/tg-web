...
fg_api.prototype.adsModule = function() {
    ...
    module.prototype.showClick2PlayOverlay = function(callback, force) {
        ...
        if (self.config.gameParams.header_image && self.config.gameParams.header_image != '') {
            faZepto(M.playBtnContainer).css('background', 'center center url(https://img.cdn.famobi.com/portal/html5games/images/tmp/' + self.config.gameParams.header_image + ')').css('background-size', '100% auto').css('background-size', 'cover').css('background-repeat', 'no-repeat');
        }
        ...
        if (M.adcount < 1) {
            ...
            if (typeof gameLanguages != 'undefined' && gameLanguages.length > 0) {
                ...
                for (var i = 0; i < gameLanguages.length; i++) {
                    ...
                    if (currentLanguage == gameLanguages[i])
                        currentLanguageClass = 'class="selected"';
    ...
    module.prototype.showIMA = function(callback, force) {
        ...
        module.prototype.onAdsManagerLoaded = function(adsManagerLoadedEvent) {
            ...
            faZepto.each(['LOADED', 'IMPRESSION', 'STARTED', 'SKIPPABLE_STATE_CHANGED', 'FIRST_QUARTILE', 'MIDPOINT', 'THIRD_QUARTILE', 'USER_CLOSE', 'SKIPPED', 'COMPLETE', 'ALL_ADS_COMPLETED', 'DURATION_CHANGE', 'CONTENT_RESUME_REQUESTED', 'CLICK'], function(key, value) {
        ...
        myadTagUrl = "https://pubads.g.doubleclick.net/gampad/ads?impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs";
    ...
    module.prototype.showHouseAd = function(callback, force) {
        ...
        M.delayNextAdModal(true);
        var url = '/sda/housead/' + window.famobi_gameID + '/' + window.famobi.config.aid;
    ...
    module.prototype.showTeaser = function(callback) {
        ...
        M.delayNextAdModal(true);
        var url = '/sda/teaser/' + window.famobi_gameID + '/' + window.famobi.config.aid;
        self.iframe.show(url, opts);
...
window.matchMedia || (window.matchMedia = function(c) {
    ...
    a.id = "mediamatchjs";
    D.appendChild(a);
    for (E = c.getComputedStyle && c.getComputedStyle(a) || a.currentStyle; m < I; m++)
...
function mediahack(a, i) {
    function n(a, i) {
        ...
        if (l)
            ...
            for (var i, t = " " + a.className + " ", r = t, e = 0; e < n.length; e++)
                (i = n[e]) && (i += " ",
                ~t.indexOf(" " + i) || (t += i));
...
fg_api.prototype.loginModule = function() {
    ...
    loginPrototype.show = function() {
        self.iframe.show("/account/index?ingameMode=true", {
            mode: "seamless"
        });
    }
    ;
...
fg_api.prototype.navigationModule = function() {
    var self = this, M;
    function module() {
        this.crosspromotionGames = ['smarty-bubbles', 'fruita-crush', 'lovetester', 'jewelish', 'gold-rush', 'jetpack-master', '1010-animals', 'animal-quiz', 'world-cup-penalty', 'burnin-rubber', 'fruita-swipe-2', 'streetrace-fury', 'formula-fever', 'parking-passion', 'street-ball-star', 'orange-ranch', 'back-to-candyland-1', 'flow-free', 'wedding-lily', 'creamy-ice', 'soccer-star-quiz', 'puppy-maker', 'orange-bubbles', 'nut-rush', 'french-apple-pie-vegan', 'mahjong-relax', 'cannons-and-soldiers', 'hiddentastic-mansion', 'treasure-link', 'back-to-candyland-2', 'spider-solitaire', 'civilizations-wars-all-stars', 'pirates-of-islets', 'soccertastic', 'basket-and-ball'];
    }
...
fg_api.prototype.moreGamesOverlay = function(popup) {
    ...
    url = urls[rand];
    this.iframe.show(document.location.protocol + url, {
        'title': 'More Games &ndash; powered by Games1.com'
    });
}
;
...
fg_api.prototype.iframeModule = function() {
    ...
    iframePrototype.postData = function(url, dataObject) {
        var $formElement, k, v, $postIframe, postIframeName;
...
fg_api.prototype.notificationsModule = function() {
    ...
    notificationsModule.prototype.init = function() {
        self.notificationArea = self.createElement('div', {
            'id': 'fg-notifications'
        });
        self.notificationClose = self.createElement('div', {
            'class': 'fg-close-notifications'
        });
...
fg_api.prototype.notificationItem = function(messageObject) {
    ...
    notificationPrototype.init = function(messageObject) {
        ...
        var ctaClass = "";
        if (messageObject.text.indexOf("btn-cta") > 0)
...
fg_api.prototype.paymentModule = function() {
    var self = this, user = {
        id: null
    }, currentHash = null, M, callbacks = {}, newWindow, postData;
    function module() {}
    var TrxManager = {
        KEY: 'payment:trx',
        setTrx: function(id) {
    ...
    function setUpPayment() {
        ...
        self.iframe.subscribePostMessageListener('payment', 'displayWidget', function(data) {
            if (data.error) {
...
fg_api.prototype.userModule = function() {
    var self = this, userKey = 'famobi_user', userData = {
        id: !1
    }, M;
    function module() {}
    module.prototype = {
...
fg_api.prototype.init = function() {
    ...
    self.game = require("game").prepare();
