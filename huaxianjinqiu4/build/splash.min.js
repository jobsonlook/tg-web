...
!function(a) {
    ...
    var c = function() {
        ...
        return c.preloadImages = function(b) {
            var d;
            switch (a.Utils.isOnDevice(b) || c.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "//" + window.location.host + "/orange-games-splash/assets/"),
        ...
        c.openCampaignLink = function(d, e, f) {
            if (a.Utils.isOnDevice(d) || c.isContracted(d) || c.isSpecial(d))
                return null;
            var g, h = a.Utils.getSourceSite(), i = (a.SplashScreen.Preloader.SPLASH_OVERRIDE !== !1 ? a.BrandingDomain[a.SplashScreen.Preloader.SPLASH_OVERRIDE] : a.Utils.getSourceSite(),
            a.Utils.isOnDevice(d) ? "https://" : "//");
        ...
        c.getLogoWithLink = function(b, d) {
            ...
            return a.Utils.isOnDevice(b) || c.isContracted(b) || c.isSpecial(b) || c.isAirfi() || (e.inputEnabled = !0,
            e.input.useHandCursor = !0,
            e.events.onInputUp.add(function() {
...
!function(a) {
    var b = function() {
        ...
        return a.initialize = function(b, c, d, e) {
            ...
            var i = {
                ...
                onReady: function(b) {
                    ...
                    c.width = window.innerWidth.toString(),
                    c.height = window.innerHeight.toString()
                }
            };
        ...
        ,
        a.play = function(b) {
            return null !== a.playerInstance && (a.playerInstance.play(b),
            !0)
        }
        ,
        a.pause = function() {
            return null !== a.playerInstance && (a.playerInstance.pause(),
            !0)
        }
        ,
        a.show = function() {
            return null !== a.playerInstance && (a.container.style.display = "block",
            !0)
        }
        ,
        a.hide = function() {
            return null !== a.playerInstance && (a.pause(),
            a.container.style.display = "none",
            a.onClose.dispatch(),
            !0)
        }
        ...
        a.getCuePoints = function() {
            if (null !== a.playerInstance)
                return a.playerInstance.cuePoints()
        }
        ,
        a
    }();
...
!function(a) {
    ...
    !function(a) {
        var b = function(a) {
            ...
            return __extends(b, a),
            b.prototype.openGame = function() {// this.game.analytics && this.game.analytics.google.sendGenericEvent("MoreGames", "Click", this.id), this.url.indexOf("http://") !== -1 && this.url.replace("http:", "");
    ...
    !function(b) {
        var c = function(c) {
            function d(b, d) {
                ...
                e.logoBtn = e.game.add.button(0, -(e.background.height / 2) + e.offset, a.Branding.LOGO_KEY, function() {
                ...
                e.moreGamesBtn = b.add.button(0, e.background.y + e.background.height / 2 - g.height - e.offset, "", function() {
                    a.Branding.openCampaignLink(e.game, e.gameName, a.UtmTargets.more_games)
                }, e),
            ...
            d.prototype.createItems = function() {
                ...
                var c, e, f, g, h = this.game.cache.getJSON(a.Branding.GAME_ICONS_KEY), i = 3, j = Math.floor(this.size / i - 1.25 * this.offset), k = Math.floor(j + .25 * j), l = 0;
                for (var m in h)
                    h.hasOwnProperty(m) && l < 6 && !this.isCurrentGame(m) && (e = l % i * j + this.offset + l % i * this.offset,
            ...
            d.prototype.show = function() {
                this.visible || (this.game.analytics && (this.game.analytics.google.sendScreenView("moregames"),
                this.game.analytics.google.sendGenericEvent("MoreGames", "Open")),
                this.visible = !0)
            }
            ,
            d.prototype.hide = function() {
                this.visible && (this.visible = !1,
                this.game.analytics && this.game.analytics.google.sendGenericEvent("MoreGames", "Close"),
                this.onClose && this.onClose.dispatch())
            }
            ,
            d.preloadImages = function(b) {
                ...
                for (var d in c)
                    c.hasOwnProperty(d) && (c[d].data.key = d,
                    b.load.image(d, a.Utils.ASSET_LOCATION + "icons/" + d + ".png"))
            }
            ,
            ...
            d.prototype.destroy = function() {
                ...
                this.isDestroyed || (this.overlay.destroy(!0),
                this.overlay = null,
                this.itemGrp.destroy(!0),
                this.itemGrp = null,
                this.menuGrp.destroy(!0),
                this.menuGrp = null,
                this.background.destroy(),
                this.background = null,
                this.closeBtn.destroy(),
                this.closeBtn = null,
                this.moreGamesBtn.destroy(),
                this.moreGamesBtn = null,
                this.moreGamesText.destroy(),
                this.moreGamesText = null,
                this.logoBtn.destroy(),
                this.logoBtn = null,
        ...
        var c = function(b) {
            ...
            c.prototype.setup = function(b, c, d, e) {
                ...
                "auto" !== e) {
                    ...
                    ga("create", "UA-78960661-1", e, "fbrq");
                ...
                for (var i = "brzcrz_local=", j = document.cookie.split(";"), k = 0; k < j.length; k++) {
                    for (var l = j[k]; " " === l.charAt(0); )
                        l = l.substring(1, l.length);
                    if (0 === l.indexOf(i)) {
                        var m = l.substring(i.length, l.length);
                        ga("fbrq.set", "userId", m),
                        ga("fbrq.set", "dimension1", m);
                        break
                    }
                }
                return ga("fbrq.set", "appName", "All"),
                ...
                }(window, document, "script", "./build/main.min.js"),
                ga
            }
            ,
    ...
    !function(b) {
        var c = function(c) {
            ...
            d.prototype.init = function(b) {
                if (this.config = b,
                d.SPLASH_OVERRIDE = "number" == typeof b.splashOverride && b.splashOverride,
                this.game.scale.onSizeChange.add(this.resize, this),
                void 0 === !this.game.load.spine)
                    throw new Error("You tried to play the Splash screen without spine support enabled!");
            ...
            d.prototype.preload = function() {
                ...
                switch (a.Utils.isOnDevice(this.game) || (this.game.load.json(a.Branding.INTERNAL_PORTALS_KEY, a.Utils.ASSET_LOCATION + "json/internal.json?v=" + b),
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.preload = function() {
                if (this.scaleFactor = this.getScale(),
                a.Utils.isTc() || (this.game.load.crossOrigin = "anonymous"),
                a.Branding.isSpecial(this.game))
                    this.game.add.existing(this.background),
            ...
            ,
            d.prototype.create = function() {
                if (a.Branding.isSpecial(this.game))
                    this.game.state.add(b.Neutral.Name, b.Neutral),
    ...
    !function(b) {
        var c = function(c) {
            ...
            d.prototype.resizeObjects = function() {
                this.created && (this.logo.scale.set(.8 * this.scaleFactor),
                this.logo.y = this.game.height / 2 - 100 * this.scaleFactor,
                this.logo.x = this.game.width / 2,
                a.Utils.isOnDevice(this.game) || (this.playButton.x = this.game.width / 2,
                this.playButton.y = this.game.height / 2 + 200 * this.scaleFactor))
            }
            ,
            ...
            d.prototype.animateButton = function() {
                a.Utils.isOnDevice(this.game) || (this.game.tweens.remove(this.buttonTween),
                this.playButton.scale.set(this.scaleFactor),
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.onPreloadedFile = function() {
                Date.now() - this.t > 1e3 && (this.t = Date.now(),
                this.tId++,
                this.tId >= this.preloadTexts.length && (this.tId = 0)),
            ...
            ,
            d.prototype.resizeObjects = function() {
                this.created && (this.logo.scale.set(1.5 * this.scaleFactor),
                ...
                a.Utils.isOnDevice(this.game) || (this.playButton.x = this.game.width / 2,
                this.playButton.y = this.game.height / 2 + 230 * this.scaleFactor))
            }
            ,
            d.prototype.getScale = function() {
                return a.Utils.isOnDevice(this.game) ? this.game.width < 1.5 * d.IdealWidth ? this.game.width / 6 * 4 / d.IdealWidth : 1 : this.game.width < this.game.height ? this.game.width / 6 * 4 / d.IdealWidth : this.game.width / 6 * 3 / d.IdealWidth
    ...
    !function(b) {
        var c = function(c) {
            ...
            d.prototype.onPreloadEnd = function() {
                var b = this;
                this.preloadReady = !0,
                a.Utils.isOnDevice(this.game) ? this.game.time.events.add(Phaser.Timer.SECOND, function() {
                    ...
                    b.clicked || (b.clicked = !0,
                    void 0 !== b.config.mobilePlayClickhandler ? b.config.mobilePlayClickhandler() : b.playClick(),
                    b.game.input.onUp.remove(b.playClick, b))
                }, this),
                this.animateButton())
            }
            ,
            d.prototype.createObjects = function() {
                var a = this;
                this.clouds = this.game.add.sprite(0, 50, "kizi_atlas", "kizi_splash_bg_cloud"),
                this.clouds.scale.set(this.game.width / d.IdealWidth),
                this.clouds.alpha = .5,
                this.monster = this.game.add.sprite(this.game.width / 2, this.game.height / 2, "kizi_atlas"),
                this.monster.animations.add("load", Phaser.Animation.generateFrameNames("kizi_splash_spritesheet-", 0, 3)),
                this.monster.animations.play("load", 6, !0),
                this.monster.scale.set(1.5 * this.scaleFactor),
                this.monster.anchor.set(.5),
                this.playButton = this.game.add.button(this.game.width / 2, .75 * this.game.height, "kizi_atlas", function() {
                    console.log(11111);
                    a.clicked || (a.clicked = !0,
                    void 0 !== a.config.mobilePlayClickhandler ? a.config.mobilePlayClickhandler() : a.playClick(),
                    a.game.input.onUp.remove(a.playClick, a))
                }, this, "kizi_splash_button", "kizi_splash_button", "kizi_splash_button_onpush", "kizi_splash_button"),
                this.playButton.anchor.set(.5),
                this.playButton.scale.set(.6 * this.scaleFactor),
                this.playButton.visible = !1,
                this.created = !0
            ...
            ,
            d.prototype.resizeObjects = function() {
                this.created && (a.Utils.isOnDevice(this.game) || (console.log("resizing"),
                this.monster.scale.set(1.5 * this.scaleFactor),
                this.monster.position.set(this.game.width / 2, this.game.height / 2),
                this.clouds.position.set(0, 50),
                this.clouds.scale.set(this.game.width / d.IdealWidth),
                this.playButton.scale.set(.6 * this.scaleFactor),
                this.playButton.x = this.game.width / 2,
                this.playButton.y = this.game.height / 2 + this.monster.height / 2 - this.playButton.height / 2))
            }
            ,
            ...
            d.prototype.resize = function() {
                this.scaleFactor = this.getScale(),
                this.background.resize(this.scaleFactor),
                this.monster.scale.set(this.scaleFactor),
                this.resizeObjects(),
                this.created && this.preloadReady && this.animateButton()
            }
            ,
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.resizeObjects = function() {
                this.created && (a.Utils.isOnDevice(this.game) || (this.playButton.x = this.game.width / 2,
    ...
    !function(a) {
        var b = function(b) {
            ...
            c.prototype.onPreloadedFile = function() {
                Date.now() - this.t > 2e3 && (this.t = Date.now(),
                this.tId++,
                this.tId >= this.preloadTexts.length && (this.tId = 0)),
                this.preloadText.setText("Spelletje wordt geladen")
            }
            ...
            c.prototype.resizeObjects = function() {
                this.created && (this.bg.x = this.game.width / 2,
                ...
                this.preloadText.scale.set(this.scaleFactor),
                this.playButton.x = this.game.width / 2,
                this.playButton.y = this.game.height / 2 - 50 * this.scaleFactor)
            }
            ,
...
!function(a) {
    ...
    !function(a) {
        var b = function(b) {
            ...
            ,
            c.prototype.resizeObjects = function() {
                this.created && (this.spine.x = this.game.width / 2,
                ...
                this.preloadText.scale.set(this.scaleFactor),
                this.playButton.x = this.game.width / 2,
                this.playButton.y = this.game.height / 2 + 55 * this.scaleFactor)
            }
            ,
            c.prototype.handler = function(a, b) {
                if (!this.clicked && "mouseout" !== b.type) {
...
!function(a) {
    ...
    !function(a) {
        var b = function(b) {
            ...
            ,
            c.prototype.handler = function(a, b) {
                this.clicked || "mouseout" === b.type || (this.clicked = !0,
                this.game.tweens.remove(this.buttonTween),
                this.game.camera.fade(0, 250),
                void 0 !== this.config.mobilePlayClickhandler ? this.config.mobilePlayClickhandler() : this.game.state.start(this.config.nextState),
                this.game.input.onUp.remove(this.handler, this))
            ...
            c.prototype.update = function() {
                ...
                a > 200 && (this.tweenRandomItem(),
                this.dt = Date.now())
            }
            ,
            c.prototype.loadUpdate = function() {
                var a = Date.now() - this.ddt;
                a > 200 && (this.ddt = Date.now(),
                this.tweenRandomItem())
            }
            ,
...
!function(a) {
    var b = function() {
        ...
        return b.getSourceSite = function(c) {
            ...
            return null !== e ? e : (3 === d.split(".").length && (d = d.substr(d.indexOf(".") + 1)),
            d)
        }
        ,
        b.getBrandingDomain = function() {
            if (a.SplashScreen.Preloader.SPLASH_OVERRIDE !== !1)
                return a.SplashScreen.Preloader.SPLASH_OVERRIDE;
        ...
        b.registerAudioUnlocker = function(a) {
            a.device.android && a.device.chrome && a.device.chromeVersion >= 55 && (a.sound.touchLocked = !0,
            a.input.touch.addTouchLockCallback(function() {
    ...
    var c = function() {
        ...
        return b.prototype.init = function(c, d, e, f) {
            ...
            return this.sendEvent(h.toString(), "init", function(a) {
                g.initProcessed = !0,
                a.enabled === !0 && (g.enabled = !0,
                g.timeOffset = (Date.now() / 1e3 | 0) - a.server_ts)
            }),
        ...
        b.prototype.incrementSessionNum = function(b) {
            ...
            c ? a.Utils.LocalStorage.setItem(b.user_id, (parseInt(c) + 1).toString()) : (c = "1",
            a.Utils.LocalStorage.setItem(b.user_id, c))
        }
        ,
        ...
        b.prototype.sendData = function() {
            ...
            if (0 === a.length)
                return this.scheduleSendData(b.SCHEDULE_TIME),
                this;
            try {
                c = JSON.stringify(a)
            } catch (a) {}
        ...
        b.prototype.sendEvent = function(c, d, e) {
            if (void 0 === e && (e = null),
            null === b.instance && null === this.gameKey)
                throw new Error("No instance Available!");
            if (!(c.length < 1)) {
                ...
                a.Utils.postRequest(h, c, g, function(a) {
                    if (a.success === !1 && window.console && console.log(a.message),
                    null != e) {
                        var b = "";
                        try {
        ...
        b.API_URL = ("https:" === document.location.protocol ? "." : ".") + "/",
        b.instance = null,
        b
    }();
    a.GameAnalytics = c
...
!function(a) {
    var b = function() {
        function b(b, c, d, e) {
            ...
            c && c.length > 0 && (this.facebook_id = c,
            this.user_id = c),
...
!function(a) {
    ...
    !function(b) {
        function c(b, c, d, f) {
            ...
            return h.match(/iPad|iPod|iPhone/i) ? (g.platform = a.Platform[0],
            g.device = h.match(/iPad|iPod|iPhone/i)[0],
            g.manufacturer = "Apple",
            g.os_version = a.Platform[0] + " " + h.match(/OS (\b[0-9]+_[0-9]+(?:_[0-9]+)?\b)/)[1].replace(/_/gi, ".")) : h.match(/Android/i) ? (g.platform = a.Platform[1],
            g.device = h.match(/Mobile/i) ? "Phone" : "Tablet",
            g.os_version = a.Platform[1] + " " + h.match(/Android (\d+(?:\.\d+)+);/)[1]) : h.match(/Windows Phone/i) && (g.platform = a.Platform[2],
            g.device = "Windows Phone",
            g.os_version = a.Platform[2] + " " + h.match(/Phone (\d+(?:\.\d+)+);/)[1]),
            g
        }
        ...
        function d() {
            ...
            return c.match(/iPad|iPod|iPhone/i) ? (b.platform = a.Platform[0],
            b.os_version = a.Platform[0] + " " + c.match(/OS (\b[0-9]+_[0-9]+(?:_[0-9]+)?\b)/)[1].replace(/_/gi, ".")) : c.match(/Android/i) ? (b.platform = a.Platform[1],
            b.os_version = a.Platform[1] + " " + c.match(/Android (\d+(?:\.\d+)+);/)[1]) : c.match(/Windows Phone/i) && (b.platform = a.Platform[2],
            b.os_version = a.Platform[2] + " " + c.match(/Phone (\d+(?:\.\d+)+);/)[1]),
            b
        }
    ...
    !function(b) {
        var c = function() {
            ...
            return Object.defineProperty(b.prototype, "data", {
                get: function() {
                    for (var b in this.event)
                        this.event.hasOwnProperty(b) && ("category" === b ? this.annotations[b] = a.Events.Category[this.event[b]] : this.annotations[b] = this.event[b]);
