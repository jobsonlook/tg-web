(window._gsQueue || (window._gsQueue = [])).push(function() {
    ...
    window._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        ...
        a.render = function(t, e, i) {
            ...
            p === this._time && !i)
                return void (f !== this._totalTime && this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || o)));
            if (!this._initted) {
                if (this._init(),
                !this._initted)
                    return;
        ...
        var t = 180 / Math.PI
          ...
          , l = function(t, e, n, a, o) {
            ...
            for (l = 0; w > l; l++)
                ...
                o ? (y = i[l],
                T = s[l],
                x = .25 * (T + y) * e / (a ? .5 : r[l] || .5),
                c = u - (u - _) * (a ? .5 * e : 0 !== y ? x / y : 0),
                m = u + (p - u) * (a ? .5 * e : 0 !== T ? x / T : 0),
          ...
          , u = function(t, e, a, h, u, p) {
            var f, c, m, d, g, v, y, T, x = {}, w = [], b = p || t[0];
    ...
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        var l, _, u, p, f, c, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g, d = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, g = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, v = /[^\d\-\.]/g, y = /(?:\d|\-|\+|=|#|\.)*/g, T = /opacity *= *([^)]*)/, x = /opacity:([^;]*)/, w = /alpha\(opacity *=.+?\)/i, b = /^(rgb|hsl)/, P = /([A-Z])/g, S = /-([a-z])/gi, R = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, k = function(t, e) {
            ...
            s = 5; --s > -1 && void 0 === r[i[s] + t]; )
                ;
            return s >= 0 ? (V = 3 === s ? "ms" : i[s],
            j = "-" + V.toLowerCase() + "-",
            V + t) : null
        }, Z = X.defaultView ? X.defaultView.getComputedStyle : function() {}
        , W = a.getStyle = function(t, e, i, s, r) {
            var n;
            return Y || "opacity" !== e ? (!s && t.style[e] ? n = t.style[e] : (i = i || Z(t, null)) ? (t = i.getPropertyValue(e.replace(P, "-$1").toLowerCase()),
        ...
        E.CSSPropTween = function(t, e, s, r, a, o, h, l, _, u, p) {
          ...
          , ft = a.parseComplex = function(t, e, i, s, r, n, a, o, h, _) {
            ...
            s += "";
            var u, p, f, c, g, v, y, T, x, w, P, S, R = i.split(", ").join(",").split(" "), k = s.split(", ").join(",").split(" "), A = R.length, C = l !== !1;
            for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (R = R.join(" ").replace(M, ", ").split(" "),
            k = k.join(" ").replace(M, ", ").split(" "),
            A = R.length),
            A !== k.length && (R = (n || "").split(" "),
            A = R.length),
            a.plugin = h,
            a.setRatio = _,
            u = 0; A > u; u++)
        ...
        var vt = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(",")
          ...
          , bt = function(t, e, i, s) {
            ...
            var r, n, o, h, l, _, u, p, f, c, m, d, g, v = i ? t._gsTransform || {
                ...
                skewY: 0
            }, y = 0 > v.scaleX, T = 2e-5, x = 1e5, w = -Math.PI + 1e-4, b = Math.PI - 1e-4, P = wt ? parseFloat(W(t, xt, e, !1, "0 0 0").split(" ")[2]) || v.zOrigin || 0 : 0;
            for (yt ? r = W(t, Tt, e, !0) : t.currentStyle && (r = t.currentStyle.filter.match(C),
            ...
            if (p) {
                ...
                v)
                    ...
                    ct = 0; 4 > ct; ct++)
                        ...
                        R = i !== s[S] ? 2 > ct ? -s.ieOffsetX : -s.ieOffsetY : 2 > ct ? f - s.ieOffsetX : m - s.ieOffsetY,
        ...
        dt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D", {
            parser: function(t, e, i, s, n, a, o) {
                if (s._transform)
                    return n;
                var h, l, _, u, p, f, c, m = s._transform = bt(t, r, !0, o.parseTransform), d = t.style, g = 1e-6, v = vt.length, y = o, T = {};
                if ("string" == typeof y.transform && yt)
                    ...
                    null != c)
                        if ("object" == typeof c)
                            ...
                            y.rotation = c;
                    h.rotation = rt("rotation"in y ? y.rotation : "shortRotation"in y ? y.shortRotation + "_short" : "rotationZ"in y ? y.rotationZ : m.rotation * I, m.rotation, "rotation", T),
                    wt && (h.rotationX = rt("rotationX"in y ? y.rotationX : "shortRotationX"in y ? y.shortRotationX + "_short" : m.rotationX * I || 0, m.rotationX, "rotationX", T),
                    h.rotationY = rt("rotationY"in y ? y.rotationY : "shortRotationY"in y ? y.shortRotationY + "_short" : m.rotationY * I || 0, m.rotationY, "rotationY", T)),
        ...
        dt("backgroundPosition", {
            ...
            parser: function(t, e, i, s, n, a) {
                ...
                if (-1 !== d.indexOf("%") != (-1 !== g.indexOf("%")) && (p = W(t, "backgroundImage").replace(R, ""),
                p && "none" !== p)) {
                    for (o = d.split(" "),
                    h = g.split(" "),
        ...
        dt("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, i, s, n, a) {
                ...
                Y ? n = new pt(h,"opacity",o,e - o,n) : (n = new pt(h,"opacity",100 * o,100 * (e - o),n),
                n.xn1 = l ? 1 : 0,
                h.zoom = 1,
                n.type = 2,
                ...
                n.plugin = a,
                n.setRatio = kt),
                l && (n = new pt(h,"visibility",0,0,n,(-1),null,(!1),0,0 !== o ? "inherit" : "hidden",0 === e ? "hidden" : "inherit"),
                n.xs0 = "inherit",
                s._overwriteProps.push(n.n)),
                n
            }
        ...
        dt("className", {
            parser: function(t, e, s, n, a, o, h) {
                ...
                if (a = n._classNamePT = new pt(t,s,0,0,a,2),
                a.setRatio = Ct,
                a.pr = -11,
                i = !0,
                a.b = c,
        ...
        h.parse = function(t, e, i, n) {
            ...
            for (a in e)
                f = e[a],
                h = o[a],
                h ? i = h.parse(t, f, a, this, i, n, e) : (p = W(t, a, r) + "",
                d = "string" == typeof f,
                "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || d && b.test(f) ? (d || (f = ot(f),
                f = (f.length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")"),
                i = ft(v, a, p, f, !0, "transparent", i, 0, n)) : !d || -1 === f.indexOf(" ") && -1 === f.indexOf(",") ? (_ = parseFloat(p),
                ...
                g && (u || 0 === u) && (f = u + _ + m)),
                g && (u += _),
                !_ && 0 !== _ || !u && 0 !== u ? void 0 !== v[a] && (f || "NaN" != f + "" && null != f) ? (i = new pt(v,a,u || _ || 0,0,i,(-1),a,(!1),0,p,f),
                i.xs0 = "none" !== f || "display" !== a && -1 === a.indexOf("Style") ? f : p) : B("invalid " + a + " tween value: " + e[a]) : (i = new pt(v,a,_,u - _,i,0,a,l !== !1 && ("px" === m || "zIndex" === a),0,p,f),
                i.xs0 = m)) : i = ft(v, a, p, f, !0, null, i, 0, n)),
...
function(t) {
    ...
    c("Ticker", function(t, e) {
        var i, s, a, o, h, l = this, u = b(), p = e !== !1 && x, f = function(t) {
            P = b(),
            l.time = (P - u) / 1e3;
            var e, r = l.time - h;
            (!i || r > 0 || t === !0) && (l.frame++,
    ...
    var A = c("TweenLite", function(e, i, s) {
        ...
        (o || e instanceof Array) && "number" != typeof e[0])
            ...
            r = 0; a.length > r; r++)
                ...
                1 === h && this._siblings[r].length > 1 && Y(n, this, null, 1, this._siblings[r])) : (n = a[r--] = A.selector(n),
                "string" == typeof n && a.splice(r + 1, 1)) : a.splice(r--, 1);
        else
            this._propLookup = {},
            this._siblings = z(e, this, !1),
            1 === h && this._siblings.length > 1 && Y(e, this, null, 1, this._siblings);
      ...
      , O = function(t, e) {
        var i, s = {};
        for (i in t)
            X[i] || i in e && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!D[i] || D[i] && D[i]._autoCSS) || (s[i] = t[i],
            delete t[i]);
        t.css = s
    };
    s = A.prototype = new S,
    ...
    S._updateRoot = function() {
        if (E.render((r.time - E._startTime) * E._timeScale, !1, !1),
        ...
        !(r.frame % 120)) {
            ...
            if (i = E._first,
            (!i || i._paused) && A.autoSleep && !L._first && 1 === r._listeners.tick.length) {
                for (; i && i._paused; )
                    i = i._next;
                i || r.sleep()
            }
    ...
    var z = function(t, e, i) {
      ...
      , Y = function(t, e, i, s, r) {
        ...
        for (n = r.length; --n > -1; )
            (o = r[n]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (l = l || U(e, 0, f),
            0 === U(o, l, f) && (u[p++] = o)) : _ >= o._startTime && o._startTime + o.totalDuration() / o._timeScale + 1e-10 > _ && ((f || !o._initted) && 2e-10 >= _ - o._startTime || (u[p++] = o)));
        for (n = p; --n > -1; )
            o = u[n],
            2 === s && o._kill(i, t) && (a = !0),
    ...
    f.plugin = function(t) {
        ...
        }, t.global === !0), o = a.prototype = new B(i);
        o.constructor = a,
        a.API = t.API;
        for (e in n)
...
!function() {
    ...
    o.prototype = {
        ...
        volume: function() {
            ...
            if (0 === r.length)
                return t._volume;
            1 === r.length || 2 === r.length && void 0 === r[1] ? t._getSoundIds().indexOf(r[0]) >= 0 ? o = parseInt(r[0], 10) : e = parseFloat(r[0]) : r.length >= 2 && (e = parseFloat(r[0]),
            o = parseInt(r[1], 10));
            var a;
            if (!(void 0 !== e && e >= 0 && e <= 1))
            ...
            for (var i = 0; i < o.length; i++)
                (a = t._soundById(o[i])) && (a._volume = e,
                r[2] || t._stopFade(o[i]),
            ...
            for (var d = 0; d < o.length; d++)
                if (u = t._soundById(o[d])) {
                    ...
                    var _ = t.seek(o[d])
                      ...
                      , l = 1e3 * s / Math.abs(u._rate);
                    !t._endTimers[o[d]] && u._paused || (t._clearTimer(o[d]),
                    t._endTimers[o[d]] = setTimeout(t._ended.bind(t, u), l)),
                    t._emit("rate", u._id)
                }
            return t
        },
        seek: function() {
            ...
            if (0 === r.length)
                ...
                var a = t._getSoundIds()
                  , i = a.indexOf(r[0]);
                i >= 0 ? o = parseInt(r[0], 10) : (o = t._sounds[0]._id,
                e = parseFloat(r[0]))
            } else
                2 === r.length && (e = parseFloat(r[0]),
                o = parseInt(r[1], 10));
    ...
    Howl.prototype.pannerAttr = function() {
        ...
        if (1 === a.length) {
            if ("object" != typeof a[0])
                return t = r._soundById(parseInt(a[0], 10)),
...
var vis = function() {
    ...
    return function(n) {
        return n && document.addEventListener(e, n),
        !document[i]
    }
}();
vis(function() {
...
function initTiltCheck() {
    isMobile && window.DeviceOrientationEvent ? (window.addEventListener("deviceorientation", startOrientTest, !1),
    window.setTimeout(endOrientTest, 1e3)) : initSplash()
}
function initSplash() {
    gameState = "splash",
...
function getLatestData() {
    totalScore = saveDataHandler.aLevelStore[0],
    totalCoins = saveDataHandler.aLevelStore[1],
    curBike = saveDataHandler.getLatestBike(),
    saveDataHandler.getLastUnlockedLevel() > 0 && (firstRun = !1)
}
function startOrientTest(a) {
    orientTestInc += a.gamma + a.beta + a.alpha
}
function endOrientTest() {
    hasTilt = orientTestInc > 0,
    window.removeEventListener("deviceorientation", startOrientTest, !1),
    3 == saveDataHandler.getControlState() ? controlMethod = hasTilt ? 0 : 1 : (controlMethod = saveDataHandler.getControlState(),
    hasTilt || 0 != controlMethod || (controlMethod = 1)),
    initSplash()
}
function initStartScreen() {
    ...
    levelScore = 0,
    levelNum = 0,
    background = new Elements.Background("titleBg");
    var t, e = {
    ...
    userInput.addHitArea("shopFromStart", butEventHandler, null, "image", o),
    userInput.addHitArea("bikeFromStart", butEventHandler, null, "image", t),
    userInput.addHitArea("playFromStart", butEventHandler, null, "image", e),
    userInput.addHitArea("moreGames", butEventHandler, null, "image", i),
    userInput.addHitArea("credits", butEventHandler, null, "image", s);
    var r = new Array(e,i,s,o,t);
    addMuteBut(r),
    panel = new Elements.Panel(gameState,r),
    panel.startTween1(),
...
function initCreditsScreen() {
    ...
    userInput.addHitArea("resetData", butEventHandler, null, "image", e);
    var i = new Array(t,e);
    addMuteBut(i),
...
function initMapScreen() {
    ...
    userInput.addHitArea("backFromMap", butEventHandler, null, "image", e),
    userInput.addHitArea("shopFromMap", butEventHandler, null, "image", i),
    userInput.addHitArea("bikeFromMap", butEventHandler, null, "image", t);
    ...
    panel.mapPosX = panel.mapPosRealX = Math.max(Math.min(aLevelData[o].x - canvas.width / 2, 1600 - canvas.width), 0),
    panel.mapPosY = panel.mapPosRealY = Math.max(Math.min(aLevelData[o].y - canvas.height / 2, 1111 - canvas.height), 0),
    panel.mapScale = 1,
    canvas.width > 1600 && (panel.mapScale = canvas.width / 1600),
    canvas.height > 1111 && (panel.mapScale = Math.max(canvas.height / 1111, panel.mapScale)),
    panel.startTween1(),
    previousTime = (new Date).getTime(),
...
function initUpgradeScreen() {
    window.famobi_analytics.trackScreen("SCREEN_OTHER", "SCREEN_UPGRADE"),
    gameState = "upgrade",
    ...
    userInput.addHitArea("upgradeLeft", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 - 175 - 45, canvas.height / 2 + 135 - 30, canvas.width / 2 - 175 + 45, canvas.height / 2 + 135 + 30]
    }, !0),
    userInput.addHitArea("upgradeRight", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 + 175 - 45, canvas.height / 2 + 135 - 30, canvas.width / 2 + 175 + 45, canvas.height / 2 + 135 + 30]
    }, !0);
    for (var e = new Array({
        x: canvas.width / 2 - 90,
        ...
        userInput.addHitArea("buyUpgrade", butEventHandler, {
            id: i
        }, "rect", {
            aRect: [e[i].x - 60, e[i].y - 25, e[i].x + 60, e[i].y + 25]
        }, !1);
    userInput.addHitArea("backFromUpgrade", butEventHandler, null, "image", t),
    userInput.addHitArea("bikeFromUpgrade", butEventHandler, null, "image", a);
    var s = new Array(t,a);
    addMuteBut(s),
    panel = new Elements.Panel(gameState,s),
    panel.startTween1(),
...
function initBikeShopScreen(a) {
    ...
    gameState = "bikeShop";
    try {
        window.famobi_analytics.trackScreen(famobi_analytics.SCREEN_SHOP)
    } catch (t) {}
    background = new Elements.Background("garageBg");
    var e = {
        oImgData: assetLib.getData("uiButs"),
    ...
    userInput.addHitArea("bikeShopLeft", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 - 175 - 45, canvas.height / 2 + 135 - 30, canvas.width / 2 - 175 + 45, canvas.height / 2 + 135 + 30]
    }, !0),
    userInput.addHitArea("bikeShopRight", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 + 175 - 45, canvas.height / 2 + 135 - 30, canvas.width / 2 + 175 + 45, canvas.height / 2 + 135 + 30]
    }, !0),
    userInput.addHitArea("buyBike", butEventHandler, null, "rect", {
        aRect: [canvas.width / 2 - 115, canvas.height / 2 + 72 - 30, canvas.width / 2 + 115, canvas.height / 2 + 72 + 30]
    }, !1),
    userInput.addHitArea("backFromBikeShop", butEventHandler, null, "image", e),
    userInput.addHitArea("shopFromBikeShop", butEventHandler, null, "image", i);
    var s = new Array(e,i);
    addMuteBut(s),
    curBikeShopId = a ? curBike : Math.min(curBike + 1, aBikeData.length - 1),
    panel = new Elements.Panel(gameState,s),
    panel.startTween1(),
    previousTime = (new Date).getTime(),
    updateBikeShopScreenEvent()
}
function initTut() {
    gameState = "tut";
    try {
...
function initGame2() {
    ...
    panel.startTween1(),
    road = new Elements.Road,
    bike = new Elements.Bike,
    leftSteer = 0,
    rightSteer = 0,
    manualSteering = 0,
    startDragX = 0,
    ...
    isAccelerating = !1,
    aVehicles = new Array,
    aVehicleLanes = new Array,
    curTime = oGameData.time,
    levelOver = !1,
    engineInc = 0,
    sceneryInc = 0;
    for (var e = 0; e < 4; e++) {
    ...
    for (var e = 0; e < 4; e++)
        oLaneSpeeds["lane" + e] = getSlowLaneSpeed(),
        tweenLaneSpeed(e);
    for (var e = 0; e < 3; e++)
        addVehicle(100 * Math.random() + vehicleStartRowNum);
...
function tweenLaneSpeed(a, t) {
    ...
    var e;
    switch (e = t ? getSlowLaneSpeed() : getRandomLaneSpeed(),
    a) {
    case 0:
        laneTween0 && laneTween0.kill(),
        laneTween0 = TweenLite.to(oLaneSpeeds, 5 * Math.random() + 3, {
            lane0: e,
            ease: "Quad.easeOut",
            onComplete: function() {
                tweenLaneSpeed(0)
        ...
        break;
    case 1:
        laneTween1 && laneTween1.kill(),
        laneTween1 = TweenLite.to(oLaneSpeeds, 5 * Math.random() + 3, {
            lane1: e,
            ease: "Quad.easeOut",
            onComplete: function() {
                tweenLaneSpeed(1)
        ...
        break;
    case 2:
        laneTween2 && laneTween2.kill(),
        laneTween2 = TweenLite.to(oLaneSpeeds, 5 * Math.random() + 3, {
            lane2: e,
            ease: "Quad.easeOut",
            onComplete: function() {
                tweenLaneSpeed(2)
        ...
        break;
    case 3:
        laneTween3 && laneTween3.kill(),
        laneTween3 = TweenLite.to(oLaneSpeeds, 5 * Math.random() + 3, {
            lane3: e,
            ease: "Quad.easeOut",
            onComplete: function() {
                tweenLaneSpeed(3)
...
function clearControl() {
    window.DeviceOrientationEvent && window.removeEventListener("deviceorientation", devOrientHandler, !1),
...
function setControl() {
    ...
    }, !0)) : (userInput.addKey("steerRight", butEventHandler, null, 39),
    userInput.addKey("steerLeft", butEventHandler, null, 37)) : userInput.addHitArea("steerTouch", butEventHandler, {
        isDraggable: !0,
        multiTouch: !0
    }, "rect", {
...
function devOrientHandler(a) {
    oTiltData.gamma = a.gamma,
    oTiltData.beta = a.beta,
    oTiltData.alpha = a.alpha,
    manualSteering = canvas.width > canvas.height ? oTiltData.gamma > 0 ? Math.max(Math.min(oTiltData.beta / 12, 1), -1) : Math.max(Math.min(oTiltData.beta / -12, 1), -1) : oTiltData.beta > 0 ? Math.max(Math.min(oTiltData.gamma / -12, 1), -1) : Math.max(Math.min(oTiltData.gamma / 12, 1), -1)
}
function initPause() {
    gameState = "pause";
    try {
    ...
    road.curveTween && road.curveTween.pause(),
    userInput.addHitArea("resumeGameFromPause", butEventHandler, null, "image", t),
    userInput.addHitArea("restartGameFromPause", butEventHandler, null, "image", e),
    userInput.addHitArea("quitGameFromPause", butEventHandler, null, "image", s);
...
function resumeGame() {
    ...
    gameState = "game",
    engineInc = 0,
    road.curveTween && road.curveTween.resume();
    var a = {
        oImgData: assetLib.getData("uiButs"),
        aPos: [-80, 30],
        align: [1, 0],
...
function butEventHandler(a, t) {
    ...
    case "credits":
        ...
        userInput.removeHitArea("shopFromStart"),
        userInput.removeHitArea("bikeFromStart"),
        userInput.removeHitArea("moreGames"),
    ...
    case "bikeFromStart":
        ...
        break;
    case "mapTouch":
        if (t.isBeingDragged && !t.hasLeft && mapTouchFirst)
            panel.mapPosX = Math.max(Math.min(panel.mapStartX - t.x, 1600 - canvas.width), 0),
            panel.mapPosY = Math.max(Math.min(panel.mapStartY - t.y, 1111 - canvas.height), 0);
        else if (t.isDown && 0 == t.isBeingDragged)
            playSound("click"),
            panel.mapTween && panel.mapTween.kill(),
            panel.mapStartX = panel.mapPosRealX + t.x,
            panel.mapDragX = t.x,
            panel.mapStartY = panel.mapPosRealY + t.y,
            panel.mapDragY = t.y,
            mapTouchFirst = !0;
        else if (mapTouchFirst && (mapTouchFirst = !1,
        Math.abs(panel.mapDragY - t.y) < 10))
            for (var s = 0; s < aLevelData.length; s++) {
                var o, r;
                if (s == saveDataHandler.getLastUnlockedLevel() ? (r = 65,
                o = -65,
                aLevelData[s].y < 200 && (o = 65)) : (o = -45,
                r = 45,
                aLevelData[s].y < 200 && (o = 45)),
                s <= saveDataHandler.getLastUnlockedLevel() && t.x + panel.mapPosX > (aLevelData[s].x - 40) * panel.mapScale && t.x + panel.mapPosX < (aLevelData[s].x + 40) * panel.mapScale && t.y + panel.mapPosY > (aLevelData[s].y + o - r) * panel.mapScale && t.y + panel.mapPosY < (aLevelData[s].y + o + r) * panel.mapScale) {
                    levelNum = s,
                    userInput.removeHitArea("calendarFromMap"),
                    userInput.removeHitArea("backFromMap"),
                    userInput.removeHitArea("shopFromMap"),
                    userInput.removeHitArea("bikeFromMap"),
                    userInput.removeHitArea("mapTouch"),
                    userInput.removeHitArea("mute"),
                    isBonusLevel = !1,
                    firstRun ? initTut() : window.famobi_analytics.trackEvent(famobi_analytics.EVENT_LEVELSTART, {
    ...
    case "playFromTut":
        playSound("click"),
        userInput.removeHitArea("playFromTut"),
        userInput.removeHitArea("controlBut0"),
        userInput.removeHitArea("controlBut1"),
        userInput.removeHitArea("controlBut2"),
        userInput.removeHitArea("mute"),
    ...
    case "upgradeLeft":
        if (curBike > 0)
            for (curBike--,
            playSound("click"); !saveDataHandler.hasBike(curBike) && curBike > 0; )
                curBike--;
        break;
    case "upgradeRight":
        if (curBike < saveDataHandler.getLatestBike())
            for (curBike++,
            playSound("click"); !saveDataHandler.hasBike(curBike) && curBike < saveDataHandler.getLatestBike(); )
                curBike++;
        break;
    case "buyUpgrade":
        if (saveDataHandler.getBikeUpgrade(curBike, t.id) < 5) {
            ...
            totalCoins >= h && (totalCoins -= h,
            saveDataHandler.addUpgrade(curBike, t.id),
            saveDataHandler.setTotalCoins(totalCoins),
    ...
    case "backFromUpgrade":
        ...
        userInput.removeHitArea("bikeFromUpgrade"),
        userInput.removeHitArea("upgradeLeft"),
        userInput.removeHitArea("upgradeRight"),
        userInput.removeHitArea("buyUpgrade"),
    ...
    case "playFromUpgrade":
        ...
        break;
    case "bikeShopLeft":
        curBikeShopId > 0 && (curBikeShopId--,
        playSound("click"),
        saveDataHandler.hasBike(curBikeShopId) && (curBike = curBikeShopId));
        break;
    case "bikeShopRight":
        curBikeShopId < aBikeData.length - 1 && (curBikeShopId++,
        playSound("click"),
        saveDataHandler.hasBike(curBikeShopId) && (curBike = curBikeShopId));
        break;
    case "buyBike":
        if (!saveDataHandler.hasBike(curBikeShopId)) {
            ...
            totalCoins >= h && (totalCoins -= h,
            saveDataHandler.addBike(curBikeShopId),
            saveDataHandler.setTotalCoins(totalCoins),
            saveDataHandler.saveData(),
            curBike = curBikeShopId,
            userInput.removeHitArea("backFromBikeShop"),
            userInput.removeHitArea("shopFromBikeShop"),
            userInput.removeHitArea("bikeShopLeft"),
            userInput.removeHitArea("bikeShopRight"),
            userInput.removeHitArea("buyBike"),
            userInput.removeHitArea("playFromBikeShop"),
            userInput.removeHitArea("mute"),
            initBikeShopScreen(!0),
            playSound("buyBike"))
        }
        break;
    ...
    case "playFromBikeShop":
        saveDataHandler.hasBike(curBikeShopId) && (userInput.removeHitArea("backFromBikeShop"),
        userInput.removeHitArea("shopFromBikeShop"),
        userInput.removeHitArea("bikeShopLeft"),
        userInput.removeHitArea("bikeShopRight"),
        userInput.removeHitArea("buyBike"),
    ...
    case "steerRight":
        ...
        break;
    case "steerTouch":
        t.isDown && !t.isBeingDragged ? (0 == dragState && (startDragX = t.x),
        dragState = 1) : 1 == dragState && t.isBeingDragged ? manualSteering = Math.min(Math.max((startDragX - t.x) / 200, -1), 1) : 1 == dragState && (dragState = 0,
        manualSteering = 0);
        break;
    case "controlBut0":
        playSound("click"),
        controlMethod = 0,
        saveDataHandler.setControlState(controlMethod),
        saveDataHandler.saveData();
        break;
    case "controlBut1":
        playSound("click"),
    ...
    case "playFromLevelComplete":
        ...
        userInput.removeHitArea("shopFromLevelComplete"),
        userInput.removeHitArea("bikeFromLevelComplete"),
        userInput.removeHitArea("mute"),
        initMapScreen();
        break;
    ...
    case "playFromLevelFail":
        playSound("click"),
        userInput.removeHitArea("playFromLevelFail"),
        userInput.removeHitArea("backFromLevelFail"),
        userInput.removeHitArea("shopFromLevelFail"),
        userInput.removeHitArea("bikeFromLevelFail"),
        userInput.removeHitArea("mute"),
    ...
    case "pause":
        ...
        playMusic()) : 2 == audioType && music.pause(),
        ...
        userInput.removeKey("steerRight"),
        userInput.removeKey("steerLeft"),
        window.removeEventListener("deviceorientation", devOrientHandler, !1),
        userInput.removeHitArea("mute"),
        initPause();
        break;
...
function hasCrashed() {
    sound.stop(),
    playSound("crash" + Math.floor(2 * Math.random())),
    playSound("rev0"),
    engineInc = 0,
    lastWhooshLane = -1,
    tweenLaneSpeed(Math.floor(4 * Math.random()), !0),
    road.speed *= .5,
    hud.showCrash(),
    bike.showCrash()
}
...
function initLevelComplete() {
    ...
    playSound("scoreTotal0"),
    background = new Elements.Background("garageBg"),
    1 == audioType && music.fade(music.volume(), .25, 500),
    oGameData.totalLevelScore = Math.round(curTime / 10) + 10 * oGameData.overtakes + 10 * oGameData.speedSecs + oGameData.coins,
    oGameData.totalLevelCoins = Math.round(oGameData.coins + curTime / 10 + oGameData.overtakes + oGameData.speedSecs),
    totalScore = Math.min(totalScore + oGameData.totalLevelScore, 99999),
    totalCoins = Math.min(totalCoins + oGameData.totalLevelCoins, 99999),
    saveDataHandler.setTotalScore(totalScore),
    saveDataHandler.setTotalCoins(totalCoins),
    isBonusLevel ? saveDataHandler.setCalendarComplete() : levelNum == saveDataHandler.getLastUnlockedLevel() && (saveDataHandler.setLevelComplete(levelNum),
    levelNum++),
    saveDataHandler.saveData(),
    ...
    userInput.addHitArea("shopFromLevelComplete", butEventHandler, null, "image", e),
    userInput.addHitArea("bikeFromLevelComplete", butEventHandler, null, "image", a);
    for (var i = new Array(t,e,a), s = 0; s < i.length; s++)
        "undefined" == typeof i[s].noMove && (i[s].doMove = !0),
        i[s].noMove = !0;
    addMuteBut(i),
    panel = new Elements.Panel(gameState,i),
    panel.startLevelCompleteTween(),
    previousTime = (new Date).getTime();
    var o = function() {
        for (var s = 0; s < i.length; s++)
            i[s].doMove && (i[s].noMove = !1),
            i[s].scale = 1;
        userInput.addHitArea("playFromLevelComplete", butEventHandler, null, "image", t),
        userInput.addHitArea("shopFromLevelComplete", butEventHandler, null, "image", e),
        userInput.addHitArea("bikeFromLevelComplete", butEventHandler, null, "image", a)
...
function initLevelFail() {
    ...
    background = new Elements.Background("garageBg"),
    1 == audioType && music.fade(music.volume(), .25, 500),
    oGameData.totalLevelScore = 10 * oGameData.overtakes + 10 * oGameData.speedSecs + oGameData.coins,
    oGameData.totalLevelCoins = Math.round(oGameData.coins) + oGameData.overtakes + oGameData.speedSecs,
    totalScore = Math.min(totalScore + oGameData.totalLevelScore, 99999),
    totalCoins = Math.min(totalCoins + oGameData.totalLevelCoins, 99999),
    saveDataHandler.setTotalScore(totalScore),
    saveDataHandler.setTotalCoins(totalCoins),
    ...
    for (var s = new Array(a,e,i,t), o = 0; o < s.length; o++)
        "undefined" == typeof s[o].noMove && (s[o].doMove = !0),
        s[o].noMove = !0;
    addMuteBut(s),
    panel = new Elements.Panel(gameState,s),
    panel.startLevelCompleteTween(),
    ...
    var r = function() {
        for (var o = 0; o < s.length; o++)
            s[o].doMove && (s[o].noMove = !1),
            s[o].scale = 1;
        userInput.addHitArea("playFromLevelFail", butEventHandler, null, "image", a),
        userInput.addHitArea("backFromLevelFail", butEventHandler, null, "image", t),
        userInput.addHitArea("shopFromLevelFail", butEventHandler, null, "image", e),
        userInput.addHitArea("bikeFromLevelFail", butEventHandler, null, "image", i)
    };
    setTimeout(function() {
...
function addVehicle(a) {
    if ("undefined" == typeof a && (a = vehicleStartRowNum),
    aVehicles.length < 20) {
        var t;
        t = 1 * Math.random() < .25 || isBonusLevel && 1 * Math.random() < .25 ? isBonusLevel ? new Elements.Coin("bonusCoin") : 1 * Math.random() < .85 ? new Elements.Coin("coin") : new Elements.Coin("bonusCoin") : new Elements.Vehicle,
        t.rowNum = a;
        ...
        t.sideMultiplier = aLanePos[e] + .06 * Math.random() - .03,
        t.lane = e,
        aVehicleLanes[e].push(t),
        t.speed = oLaneSpeeds["lane" + e],
        aVehicles.push(t)
    }
}
function raceOver(a) {
    sound.stop(),
    playSound(a ? "stageSuccess" : "raceFail"),
    playSound("rev1"),
    ...
    userInput.removeHitArea("pause"),
    isAccelerating = !1,
    road.curveTween && road.curveTween.kill(),
    a ? (hud.chequeredFlagX = -canvas.width,
    hud.raceEndState = 0,
    TweenLite.to(hud, .3, {
        chequeredFlagX: 0,
        ease: "Back.easeOut"
    ...
    })) : (hud.chequeredFlagX = -canvas.width,
    hud.raceEndState = 1,
    TweenLite.to(hud, .3, {
        chequeredFlagX: 0,
        ease: "Back.easeOut"
...
function updateGameEvent() {
    ...
    engineInc -= delta,
    engineInc <= 0 && !levelOver && (playSound("engine" + aBikeData[curBike].audio),
    engineInc = 1.5 * Math.random() + 6.5),
    levelOver || (curTime = Math.max(Math.round(curTime - 100 * delta), 0)),
    0 != curTime || levelOver || raceOver(!1),
    vehicleRate += road.speed * delta,
    vehicleRate >= vehicleRelease && (addVehicle(),
    vehicleRelease = 130 * Math.random(),
    vehicleRate = 0),
    isBonusLevel ? (ctx.fillStyle = aSkyColours[aLevelData[bonusLevelNum].sky],
    ctx.fillRect(0, 0, canvas.width, canvas.height),
    ctx.fillStyle = aGroundColours[Math.floor(bonusLevelNum / 6)],
    ctx.fillRect(0, road.horizon, canvas.width, canvas.height)) : (ctx.fillStyle = aSkyColours[aLevelData[levelNum].sky],
    ctx.fillRect(0, 0, canvas.width, canvas.height),
    ctx.fillStyle = aGroundColours[Math.floor(levelNum / 6)],
    ctx.fillRect(0, road.horizon, canvas.width, canvas.height)),
    road.update(),
    road.render(),
    bike.update(),
    bike.render(),
...
function updateTutEvent() {
    "tut" == gameState && (delta = getDelta(),
    background.render(),
    panel.update(),
    panel.render(),
    requestAnimFrame(updateTutEvent))
}
function updateLevelComplete() {
    "levelComplete" == gameState && (delta = getDelta(),
    background.render(),
    panel.update(),
    panel.render(),
...
function updateLevelFail() {
    "levelFail" == gameState && (delta = getDelta(),
    background.render(),
    panel.update(),
    panel.render(),
...
function updateUpgradeScreenEvent() {
    "upgrade" == gameState && (delta = getDelta(),
    background.render(),
    panel.update(),
    panel.render(),
...
function updateBikeShopScreenEvent() {
    "bikeShop" == gameState && (delta = getDelta(),
    background.render(),
    panel.update(),
    panel.render(),
    requestAnimFrame(updateBikeShopScreenEvent))
}
...
function loadPreAssets() {
    if (aLangs.length > 1) {
        for (var a = new Array, t = 0; t < aLangs.length; t++)
            a.push({
                id: "lang" + aLangs[t],
...
function initLangSelect() {
    for (var a, t, e, i = 10, s = 0, o = 0, r = 1, h = 0; h < aLangs.length && (a = preAssetLib.getData("lang" + aLangs[h]),
    (h + 1) * (a.img.width * r) + (h + 2) * i < canvas.width); h++)
        s++;
    o = Math.ceil(aLangs.length / s);
    for (var h = 0; h < aLangs.length; h++) {
        a = preAssetLib.getData("lang" + aLangs[h]),
        t = canvas.width / 2 - s / 2 * (a.img.width * r) - (s - 1) / 2 * i,
        t += h % s * (a.img.width * r + i),
        e = canvas.height / 2 - o / 2 * (a.img.height * r) - (o - 1) / 2 * i,
        e += Math.floor(h / s) % o * (a.img.height * r + i),
        ctx.drawImage(a.img, 0, 0, a.img.width, a.img.height, t, e, a.img.width * r, a.img.height * r);
        var n = {
            oImgData: a,
...
function loadAssets() {
    ...
    oImageIds.shopBut = "id6",
    oImageIds.bikeBut = "id7",
    oImageIds.leftBut = "id8",
    oImageIds.rightBut = "id9",
    oImageIds.pauseBut = "id10",
    oImageIds.retryBut = "id11",
    oImageIds.resetBut = "id12",
    oImageIds.controlButOn0 = "id13",
    oImageIds.controlButOn1 = "id14",
    oImageIds.controlButOn2 = "id15",
    oImageIds.smallPlayBut = "id16",
    oImageIds.quitBut = "id17",
    oImageIds.controlButOff0 = "id18",
    oImageIds.controlButOff1 = "id19",
    oImageIds.controlButOff2 = "id20",
    oImageIds.newBikeBut = "id21",
    oImageIds.titleLogo = "id0",
    oImageIds.scoreIcon = "id1",
    oImageIds.coinsIcon = "id2",
    oImageIds.winIcon = "id3",
    oImageIds.winPanel = "id4",
    oImageIds.mapArea0 = "id5",
    oImageIds.mapArea1 = "id6",
    oImageIds.mapArea2 = "id7",
    oImageIds.mapArea3 = "id8",
    oImageIds.mapArea4 = "id9",
    oImageIds.distIcon = "id10",
    oImageIds.previewPanel = "id11",
    oImageIds.loseIcon = "id12",
    oImageIds.losePanel = "id13",
    oImageIds.bikeIcon0 = "id14",
    oImageIds.bikeIcon1 = "id15",
    oImageIds.bikeIcon2 = "id16",
    oImageIds.bikeIcon3 = "id17",
    oImageIds.bikeIcon4 = "id18",
    oImageIds.bikeIcon5 = "id19",
    oImageIds.bikeIcon6 = "id20",
    oImageIds.bikeIcon7 = "id21",
    oImageIds.bikeIcon8 = "id22",
    oImageIds.bikeNameBlack0 = "id23",
    oImageIds.bikeNameBlack1 = "id24",
    oImageIds.bikeNameBlack2 = "id25",
    oImageIds.bikeNameBlack3 = "id26",
    oImageIds.bikeNameBlack4 = "id27",
    oImageIds.bikeNameBlack5 = "id28",
    oImageIds.bikeNameBlack6 = "id29",
    oImageIds.bikeNameBlack7 = "id30",
    oImageIds.bikeNameBlack8 = "id31",
    oImageIds.smallBuyButOn = "id32",
    oImageIds.smallBuyButOff = "id33",
    oImageIds.upgradePanel = "id34",
    oImageIds.bikeNameWhite0 = "id35",
    oImageIds.bikeNameWhite1 = "id36",
    oImageIds.bikeNameWhite2 = "id37",
    oImageIds.bikeNameWhite3 = "id38",
    oImageIds.bikeNameWhite4 = "id39",
    oImageIds.bikeNameWhite5 = "id40",
    oImageIds.bikeNameWhite6 = "id41",
    oImageIds.bikeNameWhite7 = "id42",
    oImageIds.bikeNameWhite8 = "id43",
    oImageIds.bigBuyButOn = "id44",
    oImageIds.bigBuyButOff = "id45",
    oImageIds.bikeShopPanel = "id46",
    oImageIds.calendarBut = "id47",
    oImageIds.tick = "id48",
    oImageIds.smallTimeIcon = "id49",
    oImageIds.smallOvertakesIcon = "id50",
    oImageIds.smallSpeedSecsIcon = "id51",
    oImageIds.smallCoinsIcon = "id52",
    oImageIds.calendarLockedBut = "id53",
    oImageIds.mapBut1 = "id54",
    oImageIds.mapBut2 = "id55",
    oImageIds.mapBut0 = "id56",
    oImageIds.mapBut1Flip = "id57",
    oImageIds.mapBut2Flip = "id58",
    oImageIds.mapBut0Flip = "id59",
    oImageIds.bikeStatBar = "id60",
    oImageIds.bikeUpgradeBar = "id61",
    oImageIds.fingerPoint = "id62",
    oImageIds.speedoPanel = "id0",
    oImageIds.distPanel = "id1",
    oImageIds.bikeDistIcon = "id2",
    oImageIds.distBar = "id3",
    oImageIds.coinsPanel = "id4",
    oImageIds.raceEndMessage0 = "id5",
    oImageIds.raceEndMessage1 = "id6",
    oImageIds.smallTimeIconHud = "id7",
    oImageIds.smallOvertakesIconHud = "id8",
    oImageIds.smallSpeedSecsIconHud = "id9",
    oImageIds.tutDesktop0 = "id10",
    oImageIds.tutDesktop1 = "id11",
    oImageIds.bollard2 = "id0",
    oImageIds.scenery00 = "id1",
    oImageIds.scenery01 = "id2",
    oImageIds.bollard0 = "id3",
    oImageIds.bollard1 = "id3",
    oImageIds.scenery10r = "id4",
    oImageIds.scenery11r = "id5",
    oImageIds.scenery10l = "id6",
    oImageIds.scenery11l = "id7",
    oImageIds.scenery20 = "id8",
    oImageIds.scenery21 = "id9",
    oImageIds.scenery30 = "id10",
    oImageIds.bollard3 = "id11",
    oImageIds.bollard4 = "id0",
    oImageIds.scenery40 = "id12",
    oImageIds.scenery41 = "id13",
    oImageIds.scenery31 = "id14",
    oImageIds.scenery32 = "id15",
    oImageIds.scenery33 = "id16",
    oImageIds.bridge = "id17",
...
function resizeCanvas() {
    ...
    a > t ? canvas.height < minSquareSize ? (canvas.height = minSquareSize,
    canvas.width = minSquareSize * (a / t),
    canvasScale = minSquareSize / t) : canvas.height > maxSquareSize ? (canvas.height = maxSquareSize,
    canvas.width = maxSquareSize * (a / t),
    canvasScale = maxSquareSize / t) : canvasScale = 1 : canvas.width < minSquareSize ? (canvas.width = minSquareSize,
    canvas.height = minSquareSize * (t / a),
    canvasScale = minSquareSize / a) : canvas.width > maxSquareSize ? (canvas.width = maxSquareSize,
    canvas.height = maxSquareSize * (t / a),
    canvasScale = maxSquareSize / a) : canvasScale = 1,
    "game" == gameState)
        userInput.removeHitArea("steerRight"),
        userInput.removeHitArea("steerLeft"),
        userInput.removeHitArea("steerTouch"),
        ...
        saveDataHandler.getCalendarStatus() && levelNum > 0 && userInput.addHitArea("calendarFromMap", butEventHandler, null, "rect", {
            aRect: [canvas.width / 2 - 80 - 50, canvas.height - 40 - 41, canvas.width / 2 + 80 - 50, canvas.height + 40 - 41]
        }, !0),
        panel.mapScale = 1,
        canvas.width > 1600 && (panel.mapScale = canvas.width / 1600),
        ...
        panel.mapPosX = panel.mapPosRealX = Math.max(Math.min(aLevelData[e].x - canvas.width / 2, 1600 - canvas.width), 0),
        panel.mapPosY = panel.mapPosRealY = Math.max(Math.min(aLevelData[e].y - canvas.height / 2, 1111 - canvas.height), 0)
        ...
        if (userInput.removeHitArea("controlBut0"),
        userInput.removeHitArea("controlBut1"),
        userInput.removeHitArea("controlBut2"),
        isMobile) {
            var o = -75;
    ...
    } else if ("pause" == gameState && (userInput.removeHitArea("controlBut0"),
    userInput.removeHitArea("controlBut1"),
    userInput.removeHitArea("controlBut2"),
    isMobile)) {
        var o = -75;
...
function toggleMute() {
    ...
    music.pause()) : (Howler.mute(!1),
    playMusic(),
    "game" == gameState ? music.volume(.5) : music.volume(.25)) : 2 == audioType && (muted ? music.pause() : playMusic())
}
var Utils;
!function(a) {
    var t = function() {
        function a(a, t, e, i, s, o) {
            ...
            for (var r = 0; r < t.length; r++)
                t[r].file.indexOf(".json") != -1 ? this.loadJSON(t[r]) : this.loadImage(t[r]);
        ...
        a.prototype.loadExtraAssets = function(a, t) {
            ...
            for (var e = 0; e < t.length; e++)
                t[e].file.indexOf(".json") != -1 ? this.loadJSON(t[e]) : this.loadImage(t[e])
        }
        ,
        a.prototype.loadJSON = function(a) {
            ...
            e.onreadystatechange = function() {
                4 == e.readyState && 200 == e.status && (t.textData[a.id] = JSON.parse(e.responseText),
                ++t.assetsLoaded,
                t.checkLoadComplete())
            }
            ,
        ...
        a.prototype.loadImage = function(a) {
            ...
            e.onload = function() {
                ...
                0 != i[0] ? (t.oAssetData[a.id].oData.spriteWidth = i[0],
                t.oAssetData[a.id].oData.spriteHeight = i[1]) : (t.oAssetData[a.id].oData.spriteWidth = t.oAssetData[a.id].img.width,
                t.oAssetData[a.id].oData.spriteHeight = t.oAssetData[a.id].img.height),
        ...
        a.prototype.getSpriteSize = function(a) {
            for (var t = new Array, e = "", i = "", s = 0, o = a.lastIndexOf("."), r = !0; r; )
                o--,
                0 == s && this.isNumber(a.charAt(o)) ? e = a.charAt(o) + e : 0 == s && e.length > 0 && "x" == a.charAt(o) ? (o--,
                s = 1,
                i = a.charAt(o) + i) : 1 == s && this.isNumber(a.charAt(o)) ? i = a.charAt(o) + i : 1 == s && i.length > 0 && "_" == a.charAt(o) ? (r = !1,
                t = [parseInt(i), parseInt(e)]) : (r = !1,
                t = [0, 0]);
            return t
        }
        ,
...
!function(a) {
    var t = function() {
        function a(a, t) {
            ...
            a.addEventListener("touchstart", function(a) {
                for (var t = 0; t < a.changedTouches.length; t++)
                    e.hitDown(a, a.changedTouches[t].pageX, a.changedTouches[t].pageY, a.changedTouches[t].identifier)
            }, !1),
            a.addEventListener("touchend", function(a) {
                for (var t = 0; t < a.changedTouches.length; t++)
                    e.hitUp(a, a.changedTouches[t].pageX, a.changedTouches[t].pageY, a.changedTouches[t].identifier)
            }, !1),
            a.addEventListener("touchcancel", function(a) {
                for (var t = 0; t < a.changedTouches.length; t++)
                    e.hitCancel(a, a.changedTouches[t].pageX, a.changedTouches[t].pageY, a.changedTouches[t].identifier)
            }, !1),
            a.addEventListener("touchmove", function(a) {
                for (var t = 0; t < a.changedTouches.length; t++)
                    e.move(a, a.changedTouches[t].pageX, a.changedTouches[t].pageY, a.changedTouches[t].identifier, !0)
            }, !1),
                ...
                for (var o = 0; o < this.aHitAreas.length; o++)
                    if (this.aHitAreas[o].rect) {
                        ...
                        if (t > r + this.aHitAreas[o].area[0] && e > h + this.aHitAreas[o].area[1] && t < r + this.aHitAreas[o].area[2] && e < h + this.aHitAreas[o].area[3]) {
                            if (this.aHitAreas[o].aTouchIdentifiers.push(i),
                            ...
                            !this.aHitAreas[o].oData.isDown) {
                                ...
                                this.aHitAreas[o].oData.x = t,
                                this.aHitAreas[o].oData.y = e,
                                s - this.prevHitTime < 500 && ("game" != gameState || "pause" == this.aHitAreas[o].id) && isBugBrowser)
                                    return;
                ...
                for (var s = 0; s < this.aHitAreas.length; s++)
                    if (this.aHitAreas[s].rect) {
                        ...
                        if (t > o + this.aHitAreas[s].area[0] && e > r + this.aHitAreas[s].area[1] && t < o + this.aHitAreas[s].area[2] && e < r + this.aHitAreas[s].area[3]) {
                            for (var h = 0; h < this.aHitAreas[s].aTouchIdentifiers.length; h++)
                                this.aHitAreas[s].aTouchIdentifiers[h] == i && (this.aHitAreas[s].aTouchIdentifiers.splice(h, 1),
                                h -= 1);
                            0 == this.aHitAreas[s].aTouchIdentifiers.length && (this.aHitAreas[s].oData.isDown = !1,
                            this.aHitAreas[s].oData.multiTouch && (this.aHitAreas[s].oData.x = t,
                            this.aHitAreas[s].oData.y = e,
        ...
        a.prototype.hitCancel = function(a, t, e, i) {
            ...
            e *= canvasScale;
            for (var s = 0; s < this.aHitAreas.length; s++)
                this.aHitAreas[s].oData.isDown && (this.aHitAreas[s].oData.isDown = !1,
                this.aHitAreas[s].aTouchIdentifiers = new Array,
                this.aHitAreas[s].oData.multiTouch && (this.aHitAreas[s].oData.x = t,
                this.aHitAreas[s].oData.y = e,
                this.aHitAreas[s].callback(this.aHitAreas[s].id, this.aHitAreas[s].oData)))
        }
                    ...
                    if (this.aHitAreas[o].rect) {
                        ...
                        if (t > r + this.aHitAreas[o].area[0] && e > h + this.aHitAreas[o].area[1] && t < r + this.aHitAreas[o].area[2] && e < h + this.aHitAreas[o].area[3])
                            ...
                            for (var n = 0; n < this.aHitAreas[o].aTouchIdentifiers.length; n++)
                                this.aHitAreas[o].aTouchIdentifiers[n] == i && (this.aHitAreas[o].aTouchIdentifiers.splice(n, 1),
                                n -= 1);
        ...
        a.prototype.keyDown = function(a) {
            for (var t = 0; t < this.aKeys.length; t++)
                a.keyCode == this.aKeys[t].keyCode && (a.preventDefault(),
                this.aKeys[t].oData.isDown = !0,
                this.aKeys[t].callback(this.aKeys[t].id, this.aKeys[t].oData))
        }
        ,
        a.prototype.keyUp = function(a) {
            for (var t = 0; t < this.aKeys.length; t++)
                a.keyCode == this.aKeys[t].keyCode && (a.preventDefault(),
                this.aKeys[t].oData.isDown = !1,
                this.aKeys[t].callback(this.aKeys[t].id, this.aKeys[t].oData))
        }
        ,
        ...
        a.prototype.removeKey = function(a) {
            for (var t = 0; t < this.aKeys.length; t++)
                this.aKeys[t].id == a && (this.aKeys.splice(t, 1),
                t -= 1)
        }
        ,
        ...
        a.prototype.removeHitArea = function(a) {
            for (var t = 0; t < this.aHitAreas.length; t++)
                this.aHitAreas[t].id == a && (this.aHitAreas.splice(t, 1),
                t -= 1)
        }
        ,
        a.prototype.resetAll = function() {
            for (var a = 0; a < this.aHitAreas.length; a++)
                this.aHitAreas[a].oData.isDown = !1,
...
!function(a) {
    var t = function() {
        function a(a) {
            ...
            this.typeId = a,
            this.oImgData = assetLib.getData(this.typeId)
        }
        return a.prototype.render = function() {
...
!function(a) {
    var t = function() {
        ...
        a.prototype.startLevelCompleteTween = function() {
            ...
            this.endIconX0 = this.endIconX1 = this.endIconX2 = this.endIconX3 = canvas.width / 2,
            this.endIconX4 = canvas.width,
            TweenLite.to(this, .3, {
                endIconX0: 0,
                delay: .2,
                ease: "Quint.easeOut"
        ...
        a.prototype.render = function(a) {
            ...
            case "start":
                var t = .7;
                ctx.save(),
                ctx.translate(canvas.width / 2 + this.posY, canvas.height * t),
                ctx.scale(.75, .5),
            ...
            case "credits":
                ...
                break;
            case "map":
                this.mapPosRealY -= 8 * (this.mapPosRealY - this.mapPosY) * delta,
                this.mapPosRealX -= 8 * (this.mapPosRealX - this.mapPosX) * delta,
                ctx.drawImage(this.oMapImgData.img, this.mapPosRealX, this.mapPosRealY, canvas.width, canvas.height, 0, 0, canvas.width * this.mapScale, canvas.height * this.mapScale);
                var h = saveDataHandler.getLastUnlockedLevel();
                if (h < aLevelData.length) {
                    var n = -80;
                    aLevelData[h].y < 200 && (n = 80),
                    ctx.save(),
                    ctx.translate((aLevelData[h].x - this.mapPosRealX) * this.mapScale, (aLevelData[h].y - this.mapPosRealY + n) * this.mapScale),
                    ctx.scale(.75, .75),
                    ctx.rotate(this.flareRot),
                    ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2),
                    ctx.restore(),
                ...
                for (var m = 0; m < aLevelData.length; m++) {
                    var l = oImageIds.mapBut0
                      , n = -30;
                    m == h ? (l = oImageIds.mapBut1,
                    n = -50) : m < h && (l = oImageIds.mapBut2,
                    n = -42),
                    aLevelData[m].y < 200 && (l = oImageIds.mapBut0Flip,
                    n = 30,
                    m == h ? (l = oImageIds.mapBut1Flip,
                    n = 50) : m < h && (l = oImageIds.mapBut2Flip,
                    n = 42));
                ...
                if (ctx.fillStyle = "rgba(0, 0, 0, 0.5)",
                ctx.fillRect(0, 0, canvas.width, 36),
                ctx.fillRect(0, canvas.height - 36, canvas.width, canvas.height),
                this.displayScoreCoins(),
                saveDataHandler.getCalendarStatus() && saveDataHandler.getLastUnlockedLevel() > 0 && (ctx.save(),
                ctx.translate(canvas.width / 2 - 40 + this.posY, canvas.height - 41),
                ctx.scale(1, .75),
                ctx.rotate(this.flareRot),
                ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2),
                ctx.restore()),
                saveDataHandler.getLastUnlockedLevel() > 0) {
                    var d = oImageIds.calendarBut
                      , g = new Date;
                    saveDataHandler.getCalendarStatus() || (d = oImageIds.calendarLockedBut,
            ...
            case "tut":
                ...
                if (isMobile) {
                    ...
                    if (hasTilt) {
                        S = 0,
                        b = 0 == controlMethod ? "controlButOn0" : "controlButOff0";
                    ...
                    var e = this.oUiButsImgData.oData.oAtlasData[oImageIds[b]].x
                      ...
                      , s = this.oUiButsImgData.oData.oAtlasData[oImageIds[b]].width
                      , o = this.oUiButsImgData.oData.oAtlasData[oImageIds[b]].height;
                    ctx.drawImage(this.oUiButsImgData.img, e, i, s, o, canvas.width / 2 - s / 2 + this.posY + S, canvas.height / 2 - o + 50, s, o),
                    b = 2 == controlMethod ? "controlButOn2" : "controlButOff2";
                    var e = this.oUiButsImgData.oData.oAtlasData[oImageIds[b]].x
                      , i = this.oUiButsImgData.oData.oAtlasData[oImageIds[b]].y
                      , s = this.oUiButsImgData.oData.oAtlasData[oImageIds[b]].width
                      , o = this.oUiButsImgData.oData.oAtlasData[oImageIds[b]].height;
                ...
                ctx.save(),
                ctx.translate(canvas.width + this.posY - 77, canvas.height - 57),
                ctx.scale(.5, .5),
                ctx.rotate(this.flareRot),
                ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2),
                ctx.restore(),
            ...
            case "levelComplete":
                ...
                ctx.drawImage(this.oUiElementsImgData.img, e, i, s, o, canvas.width / 2 + 20 + this.endIconX0, canvas.height / 2 - 165, s, o),
                this.displayTime(canvas.width / 2 + 58 + this.endIconX0, canvas.height / 2 - 162);
                ...
                var t = .7;
                ctx.save(),
                ctx.translate(canvas.width / 2 + this.posY, canvas.height / 2 + 130),
                ctx.rotate(this.flareRot),
                ctx.scale(.85, .6),
                ctx.rotate(this.flareRot),
                ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2),
            ...
            case "levelFail":
                ...
                if (totalCoins < 50) {
                    ...
                    var t = .7;
                    ctx.save(),
                    ctx.translate(canvas.width - 95 + this.posY, canvas.height - 40),
                    ctx.scale(1, .6),
                    ctx.rotate(this.flareRot),
                    ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2),
                    ctx.restore(),
            ...
            case "upgrade":
                ...
                for (var m = 0; m < A.length; m++)
                    if (saveDataHandler.getBikeUpgrade(curBike, m) < 5) {
                        ...
                        totalCoins >= x && (k = oImageIds.smallBuyButOn,
                        ctx.save(),
                        ctx.translate(A[m].x + this.posY, A[m].y),
                        ctx.scale(.6, .2),
                        ctx.rotate(this.flareRot),
                        ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2),
                        ctx.restore(),
            ...
            case "bikeShop":
                ...
                if (saveDataHandler.hasBike(curBikeShopId)) {
                    ...
                    if (totalCoins >= x) {
                        ...
                        var t = .7;
                        ctx.save(),
                        ctx.translate(canvas.width / 2 + this.posY, canvas.height / 2 + 72),
                        ctx.scale(1, .5),
                        ctx.rotate(this.flareRot),
                        ctx.drawImage(this.oTopFlareImgData.img, -this.oTopFlareImgData.img.width / 2, -this.oTopFlareImgData.img.height / 2),
                        ctx.restore(),
        ...
        a.prototype.displayTime = function(a, t) {
            ...
            var i, s = Math.floor(curTime / 6e3).toString(), o = Math.floor((curTime - 6e3 * Math.floor(curTime / 6e3)) / 100).toString();
            o.length < 2 && (o = "0" + o);
            var r = curTime.toString().charAt(curTime.toString().length - 2) + curTime.toString().charAt(curTime.toString().length - 1);
            r.length < 2 && (r = "0" + r);
            for (var h = 0; h < 2; h++) {
                if (i = parseFloat(s.charAt(h)),
                s.length < 2) {
                    if (0 == h)
                        continue;
        ...
        a.prototype.displayScoreCoins = function() {
            ...
            for (ctx.drawImage(this.oUiElementsImgData.img, t, e, i, s, canvas.width / 2 - 222 - this.posY - 27, 6, i, s),
...
!function(a) {
    var t = function() {
        function t() {
            this.segNum = 600,
            this.horizon = 0,
            this.roadTileHeight = 500,
            this.scrollY = 0,
            this.steerXcentre = -1539,
            this.steerEaseX = 0,
            this.roadHeight = 380,
            ...
            this.scrollInc = 0,
            this.skyScale = 1,
            isBonusLevel ? (this.oRoadImgData = assetLib.getData("road" + Math.floor(bonusLevelNum / 6)),
            this.oSkyImgData = assetLib.getData("sky" + aLevelData[bonusLevelNum].sky)) : (this.oRoadImgData = assetLib.getData("road" + Math.floor(levelNum / 6)),
            this.oSkyImgData = assetLib.getData("sky" + aLevelData[levelNum].sky)),
            ...
            for (var t = 30, a = 0; a < t; a++)
                this.addScenery(),
                this.aScenery[a].rowNum = (this.segNum - vehicleStartRowNum) / t * (t - 1 - a) + vehicleStartRowNum;
            this.minSpeed = aBikeData[curBike].minSpeed + .9 * saveDataHandler.getBikeUpgrade(curBike, 0),
            this.maxSpeed = aBikeData[curBike].maxSpeed + .9 * saveDataHandler.getBikeUpgrade(curBike, 1),
            this.accRate = aBikeData[curBike].accRate + .1 * saveDataHandler.getBikeUpgrade(curBike, 2),
            this.steerRate = aBikeData[curBike].steerRate + 100 * saveDataHandler.getBikeUpgrade(curBike, 3),
            this.maxSteer = aBikeData[curBike].maxSteer,
            this.raceDist = getRaceDist(),
            0 != levelNum || isBonusLevel ? this.speed = this.minSpeed : this.speed = this.minSpeed,
            this.steerX = this.steerXcentre,
            this.changeCurve()
        }
        return t.prototype.addScenery = function() {
            var t;
            this.sceneryDir++,
            t = new a.Scenery(assetLib.getData("scenery"),this.sceneryDir % 2),
            t.y = this.horizon,
            this.aScenery.push(t)
        }
        ,
        ...
        t.prototype.update = function() {
            this.speed;
            this.sceneryInc += this.speed * delta,
            this.sceneryInc > 5.7 && (this.sceneryInc = 0,
            this.addScenery()),
            isAccelerating ? this.speed -= (this.speed - this.maxSpeed) * (this.accRate * delta) : this.speed -= (this.speed - this.minSpeed) * (this.accRate * delta),
            oGameData.dist += this.speed / this.raceDist / 18e4 * (60 * delta),
            0 == oGameData.levelStage && oGameData.dist >= 1 / 3 && !levelOver ? (hud.hitCheckPoint(),
            oGameData.levelStage = 1) : 1 == oGameData.levelStage && oGameData.dist >= 2 / 3 && !levelOver ? (hud.hitCheckPoint(),
            oGameData.levelStage = 2) : 2 == oGameData.levelStage && oGameData.dist >= 1 && !levelOver && raceOver(!0),
            this.scrollY -= 1.5 * this.speed * delta,
            this.scrollY < 0 && (this.scrollY += 500),
            1 == controlMethod ? rightSteer + leftSteer == 1 ? this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, this.maxSteer) : rightSteer + leftSteer == -1 ? this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, -this.maxSteer) : this.steerEaseX < 0 ? this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, 0) : this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, 0) : 0 != controlMethod && 2 != controlMethod || (0 == manualSteering || levelOver ? this.steerEaseX < 0 ? this.steerEaseX = Math.min(this.steerEaseX + this.steerRate * delta, 0) : this.steerEaseX = Math.max(this.steerEaseX - this.steerRate * delta, 0) : this.steerEaseX = Math.max(Math.min(this.steerEaseX + manualSteering * this.steerRate * delta, Math.abs(manualSteering) * this.maxSteer), -Math.abs(manualSteering) * this.maxSteer)),
            this.aRowData[this.segNum - 1].x - (canvas.width / 2 + bike.x) < -3900 ? (0 == hud.crashAlpha && hasCrashed(),
            this.steerEaseX = this.maxSteer) : this.aRowData[this.segNum - 1].x - (canvas.width / 2 + bike.x) > -120 && (0 == hud.crashAlpha && hasCrashed(),
            this.steerEaseX = -this.maxSteer),
            this.steerX += (this.steerEaseX + road.curve * (6 * this.speed)) * delta,
            this.roadHeight = 380 - 20 * this.wheelie - bike.crashY,
            this.horizon = canvas.height - this.roadHeight,
            this.lane = Math.floor((this.aRowData[this.segNum - 1].x - (canvas.width / 2 + bike.x) + 120) / -945),
            this.scrollInc = this.curve * (.75 * this.speed) * delta,
            this.scrollX += this.scrollInc,
            this.scrollX < 0 && (this.scrollX += 525)
        }
        ,
        t.prototype.render = function() {
            ...
            for (var e = 0; e < this.segNum; e++)
                this.tempInc = e,
                this.easeInc = 1 * (this.tempInc /= this.segNum) * Math.pow(this.tempInc, 15),
                this.nextRow = e + 1,
                this.segHeightAfter = 1 * (this.nextRow /= this.segNum) * Math.pow(this.nextRow, 15) - this.easeInc,
                this.aRowData[e].x = this.steerX * this.easeInc + canvas.width / 2 - 2 * (this.easeInc + this.segHeightAfter) * this.oRoadImgData.oData.spriteWidth / 2 - 25 + (this.segNum - e) * this.curve,
                this.aRowData[e].y = this.horizon + this.easeInc * this.roadHeight,
                this.aRowData[e].scale = 8 * (this.easeInc + this.segHeightAfter) * this.oRoadImgData.oData.spriteWidth + 50,
                0 == t && (this.rowId = e),
                t += this.segHeightAfter * this.roadHeight,
                t > 1 && (ctx.drawImage(this.oRoadImgData.img, 0, this.rowId * a + this.scrollY, this.oRoadImgData.oData.spriteWidth, a, this.aRowData[this.rowId].x, this.aRowData[this.rowId].y, this.aRowData[this.rowId].scale, t + 1),
                t = 0);
            this.skyScale = canvas.width / (this.oSkyImgData.img.width / 2),
            ctx.drawImage(this.oSkyImgData.img, this.scrollX % 525, 0, this.oSkyImgData.img.width, this.oSkyImgData.img.height, 0, canvas.height - road.roadHeight - this.oSkyImgData.img.height * this.skyScale + 131.25 * this.skyScale, this.oSkyImgData.img.width * this.skyScale, this.oSkyImgData.img.height * this.skyScale),
            isBonusLevel ? ctx.fillStyle = aFenceColours[Math.floor(bonusLevelNum / 6)] : ctx.fillStyle = aFenceColours[Math.floor(levelNum / 6)];
            for (var i, s, o, r, h, n, e = this.aScenery.length - 1; e >= 0; e--)
                this.aScenery[e].x = this.aRowData[Math.floor(this.aScenery[e].rowNum)].x + this.aRowData[Math.floor(this.aScenery[e].rowNum)].scale * this.aScenery[e].sideMultiplier,
                this.aScenery[e].bollardX = this.aRowData[Math.floor(this.aScenery[e].rowNum)].x + this.aRowData[Math.floor(this.aScenery[e].rowNum)].scale * this.aScenery[e].bollardSideMultiplier,
                this.aScenery[e].y = this.aRowData[Math.floor(this.aScenery[e].rowNum)].y,
                this.aScenery[e].scale = (this.aRowData[Math.floor(this.aScenery[e].rowNum)].scale - 40) / 275,
                this.aScenery[e].tempInc = this.aScenery[e].rowNum - vehicleStartRowNum,
                this.aScenery[e].perspSpeed = 1 * (this.aScenery[e].tempInc /= this.segNum - vehicleStartRowNum) * Math.pow(this.aScenery[e].tempInc, 5) + 0,
                this.aScenery[e].scale > .04 && (this.aScenery[e].render(),
                1 == this.aScenery[e].bollardSideMultiplier ? (ctx.beginPath(),
                ctx.moveTo(s, o - 15 * i),
                ctx.lineTo(this.aScenery[e].bollardX, this.aScenery[e].y - 15 * this.aScenery[e].scale),
                ctx.lineTo(this.aScenery[e].bollardX, this.aScenery[e].y - 10 * this.aScenery[e].scale),
                ctx.lineTo(s, o - 10 * i),
                ctx.closePath(),
                ctx.fill()) : 0 == this.aScenery[e].bollardSideMultiplier && (ctx.beginPath(),
                ctx.moveTo(h, n - 15 * r),
                ctx.lineTo(this.aScenery[e].bollardX, this.aScenery[e].y - 15 * this.aScenery[e].scale),
                ctx.lineTo(this.aScenery[e].bollardX, this.aScenery[e].y - 10 * this.aScenery[e].scale),
                ctx.lineTo(h, n - 10 * r),
                ctx.closePath(),
                ctx.fill()),
                this.aScenery[e].renderBollard()),
                1 == this.aScenery[e].bollardSideMultiplier ? (i = this.aScenery[e].scale,
                s = this.aScenery[e].bollardX,
                o = this.aScenery[e].y) : 0 == this.aScenery[e].bollardSideMultiplier && (r = this.aScenery[e].scale,
                h = this.aScenery[e].bollardX,
                n = this.aScenery[e].y),
                this.aScenery[e].rowNum += (this.speed + 150 * this.aScenery[e].perspSpeed) * delta * 1,
                this.aScenery[e].rowNum >= this.segNum && this.aScenery.splice(e, 1);
            aVehicles.sort(function(a, t) {
                return a.y - t.y
            });
            for (var e = 0; e < aVehicles.length; e++) {
                if (aVehicles[e].x = this.aRowData[Math.floor(aVehicles[e].rowNum)].x + this.aRowData[Math.floor(aVehicles[e].rowNum)].scale * aVehicles[e].sideMultiplier,
                aVehicles[e].y = this.aRowData[Math.floor(aVehicles[e].rowNum)].y,
                aVehicles[e].scale = (this.aRowData[Math.floor(aVehicles[e].rowNum)].scale - 30) * this.roadScaleMultiplier / 1e3,
                aVehicles[e].tempInc = aVehicles[e].rowNum - vehicleStartRowNum,
                aVehicles[e].perspSpeed = 1 * (aVehicles[e].tempInc /= this.segNum - vehicleStartRowNum) * Math.pow(aVehicles[e].tempInc, 5) + 0,
                aVehicles[e].rowNum += (this.speed / 2 - aVehicles[e].speed + 150 * aVehicles[e].perspSpeed) * delta * 1.6,
                aVehicles[e].update(),
                aVehicles[e].scale > .03 && aVehicles[e].render(),
                aVehicles[e].rowNum >= this.segNum) {
                    for (var m = 0; m < aVehicleLanes[aVehicles[e].lane].length; m++)
                        aVehicleLanes[aVehicles[e].lane][m] == aVehicles[e] && aVehicleLanes[aVehicles[e].lane].splice(m, 1);
                    "vehicle" != aVehicles[e].typeId || aVehicles[e].overtaken || playSound("overtake" + Math.floor(3 * Math.random())),
                    aVehicles.splice(e, 1),
                    e -= 1
                }
...
!function(a) {
    var t = function() {
        function a() {
            switch (this.x = 0,
            this.y = 0,
            this.changeLaneInc = 0,
            this.overtaken = !1,
            this.typeId = "vehicle",
            this.hasWhooshed = !1,
            this.id = Math.floor(6 * Math.random()),
            this.oVehicleImgData = assetLib.getData("vehicle" + this.id),
            this.id) {
            case 0:
                this.offsetY = -13;
                break;
            ...
            this.scale = .01,
            this.changeLaneTime = 10 * Math.random() + 1
        }
        ...
        a.prototype.laneFree = function(a) {
            var t = a;
            if (oLaneSpeeds[a] < oLaneSpeeds[this.lane] - 5 || oLaneSpeeds[a] > oLaneSpeeds[this.lane] + 5)
                return t = this.lane;
        ...
        a.prototype.update = function() {
            if (this.changeLaneInc += delta,
            this.changeLaneInc >= this.changeLaneTime && this.rowNum < road.segNum - 85) {
                this.changeLaneInc = 0,
                this.changeLaneTime = 10 * Math.random() + 3;
                var a = this.getNewLane();
                if (a != this.lane) {
                    for (var t = 0; t < aVehicleLanes[this.lane].length; t++)
                        if (aVehicleLanes[this.lane][t] == this) {
                            aVehicleLanes[this.lane].splice(t, 1),
                            aVehicleLanes[a].push(this);
                            break
                        }
                    this.lane = a,
                    TweenLite.to(this, 3, {
            ...
            this.speed = oLaneSpeeds["lane" + this.lane],
            this.rowNum > road.segNum - 150 && this.lane == road.lane && 0 == hud.crashAlpha && !levelOver ? (hud.showWhoosh((1 - (road.segNum - this.rowNum) / 150) / 2 + .5),
            this.hasWhooshed || lastWhooshLane == this.lane || (playSound("inDraft"),
            this.hasWhooshed = !0,
            lastWhooshLane = this.lane)) : this.hasWhooshed = !1,
            this.rowNum > road.segNum - 5 && !levelOver && (this.x > canvas.width / 2 + bike.x - 300 && this.x < canvas.width / 2 + bike.x + 300 && 0 == hud.crashAlpha ? (hasCrashed(),
            this.overtaken = !0) : this.x > canvas.width / 2 + bike.x - 600 && this.x < canvas.width / 2 + bike.x + 600 && !this.overtaken && (this.overtaken = !0,
            hud.addBanner("overtakes")))
        }
        ,
...
!function(a) {
    var t = function() {
        function a() {
            ...
            this.rotEase = 0,
            this.crashY = 0,
            this.aOffsetY = new Array((-10),20,(-20),(-20),0,(-20),50,10,20),
            this.jiggleY = 0,
            this.oBikeImgData = assetLib.getData("bike" + curBike)
        }
        return a.prototype.showCrash = function() {
            this.crashTween && this.crashTween.kill(),
            this.crashY = 150,
            this.crashTween = TweenLite.to(this, 3, {
                crashY: 0,
        ...
        ,
        a.prototype.update = function() {
            this.jiggleY = 2 * Math.random() - 1,
            1 == controlMethod ? rightSteer + leftSteer == 1 && 1 != this.lastSteer ? (this.rotTween && this.rotTween.kill(),
            this.rotTween = TweenLite.to(this, .5, {
                rotation: -8 * radian,
                ease: "Back.easeOut"
            }),
            this.strafeTween && this.strafeTween.kill(),
            this.strafeTween = TweenLite.to(this, 1, {
                x: 60,
                ease: "Quad.easeOut"
            }),
            this.lastSteer = rightSteer + leftSteer) : rightSteer + leftSteer == -1 && this.lastSteer != -1 ? (this.rotTween && this.rotTween.kill(),
            this.rotTween = TweenLite.to(this, .5, {
                rotation: 8 * radian,
                ease: "Back.easeOut"
            }),
            ...
            this.lastSteer = rightSteer + leftSteer) : rightSteer + leftSteer == 0 && 0 != this.lastSteer && (this.rotTween && this.rotTween.kill(),
            this.rotTween = TweenLite.to(this, 1, {
                rotation: 0,
                ease: "Back.easeOut"
            }),
            this.strafeTween && this.strafeTween.kill(),
            ...
            this.lastSteer = rightSteer + leftSteer) : 0 != controlMethod && 2 != controlMethod || (0 == manualSteering || levelOver ? (this.rotation -= (this.rotation - 0) * (3 * delta),
            this.x -= (this.x - 0) * (3 * delta)) : (this.rotation -= (this.rotation - 10 * -manualSteering * radian) * (10 * delta),
            this.x -= (this.x - 60 * manualSteering) * (5 * delta)))
        }
        ,
        a.prototype.render = function() {
            ctx.save(),
            ctx.translate(canvas.width / 2 + this.x, canvas.height + this.crashY + this.jiggleY),
            ctx.rotate(this.rotation),
            ctx.scale(1.5, 1.5),
            ctx.drawImage(this.oBikeImgData.img, -this.oBikeImgData.img.width / 2, -this.oBikeImgData.img.height + 170 + this.aOffsetY[curBike]),
            ctx.restore()
        }
        ,
        a
...
!function(a) {
    var t = function() {
        ...
        return a.prototype.createTextObjects = function() {
            for (var a in assetLib.textData.langText.text[curLang])
                this.oTextData[a] = {},
        ...
        a.prototype.getCharData = function(a, t) {
            for (var e = new Array, i = 0; i < a.length; i++) {
                e[i] = new Array;
                for (var s = 0; s < a[i].length; s++)
                    for (var o = 0; o < assetLib.textData["fontData" + t].text.chars["char"].length; o++)
                        a[i][s].charCodeAt() == assetLib.textData["fontData" + t].text.chars["char"][o]["@id"] && e[i].push(assetLib.textData["fontData" + t].text.chars["char"][o])
            }
            return e
        }
        ,
        a.prototype.renderText = function(a) {
            var t, e = this.oTextData[a.text].aLineData, i = this.oTextData[a.text].oFontImgData, s = 0, o = 0, r = 0, h = 1, n = 0;
            ...
            for (var l = 0; l < e.length; l++) {
                t = 0,
                "centre" == a.alignX && (s = this.oTextData[a.text].aLineWidths[l] / 2),
                ...
                for (var d = 0; d < e[l].length; d++) {
                    var g = e[l][d]["@x"]
                      ...
                      , u = e[l][d]["@width"]
                      , I = e[l][d]["@height"];
                    a.anim && (n = Math.sin(this.inc + d / 2) * (I / 15 * m)),
                    ctx.drawImage(i.img, g, c, u, I, a.x + (t + parseInt(e[l][d]["@xoffset"]) - s) * m, a.y + (parseInt(e[l][d]["@yoffset"]) + l * this.oTextData[a.text].lineHeight + l * r - o) * m + n, u * m, I * m),
                    t += parseInt(e[l][d]["@xadvance"])
                }
            }
        }
        ,
...
!function(a) {
    var t = function() {
        function a() {
            this.crashAlpha = 0,
            this.whooshAlpha = 0,
            this.speedSecsTimer = 0,
            this.bannerId = 0,
            this.bonusTimeX = -200,
            this.bonusTimeY = 95,
            this.coinJiggle = 0,
            this.chequeredFlagX = -1e3,
            this.scrollX = canvas.width * Math.random() * .8 + .1,
            this.beepTimeTarg = 600,
            this.oImgData = assetLib.getData("hudElements"),
            this.oNumbersImgData = assetLib.getData("numbers"),
            this.oCrashImgData = assetLib.getData("crash"),
            this.oWhooshImgData = assetLib.getData("whoosh"),
            this.oSunImgData = assetLib.getData("sun"),
        ...
        a.prototype.hitCheckPoint = function() {
            curTime += this.getBonusTime(),
            this.bonusType = 1,
            this.bonusTime = this.getBonusTime(),
            playSound("stageSuccess")
        }
        ,
        a.prototype.setBonusTimeTween = function() {
            var a, t = this;
            canvas.width > 1.5 * canvas.height ? (this.bonusTimeY = 60,
            a = canvas.width / 2 + 82) : (this.bonusTimeY = 95,
            a = canvas.width / 2 - 45),
            this.bonusTimeX = -200,
            this.bonusTween && this.bonusTween.kill(),
            this.bonusTween = TweenLite.to(this, .3, {
                bonusTimeX: a,
                ease: "Back.easeOut",
                onComplete: function() {
        ...
        a.prototype.addBanner = function(a) {
            ...
            case "bonusCoin":
                ...
                break;
            case "overtakes":
                playSound("closePass" + Math.floor(3 * Math.random())),
                10 * Math.random() < 1 && playSound("horn" + Math.floor(2 * Math.random())),
                oGameData.overtakes += 1,
                curTime += 25,
                this.bonusType = 0,
                this.bonusTime = 25,
                this.setBonusTimeTween();
                break;
            case "speedSecs":
        ...
        a.prototype.showWhoosh = function(a) {
            this.whooshAlpha = Math.random() * (.2 * a) + .8 * a,
            isAccelerating = !0
        }
        ,
        a.prototype.update = function() {
            isAccelerating ? (this.speedSecsTimer += delta,
            this.speedSecsTimer > 1 && (this.speedSecsTimer = 0,
            this.addBanner("speedSecs"))) : this.speedSecsTimer = 0
        }
        ,
        a.prototype.render = function() {
            this.scrollX -= road.scrollInc * road.skyScale,
            this.scrollX < 1 * -canvas.width ? this.scrollX = 2 * canvas.width : this.scrollX > 2 * canvas.width && (this.scrollX = 1 * -canvas.width);
            var a = (canvas.width / 2 - Math.abs(this.scrollX - canvas.width / 2)) / (canvas.width / 2) * .5 + .5;
            if (ctx.drawImage(this.oSunImgData.img, 0, 0, this.oSunImgData.img.width, this.oSunImgData.img.height, this.scrollX - canvas.width / 2 * a, 0, canvas.width * a, canvas.height * a),
            this.whooshAlpha > 0) {
                ctx.save(),
                ctx.globalAlpha = this.whooshAlpha,
                this.whooshAlpha = .95 * this.whooshAlpha,
                this.whooshAlpha < .05 && (this.whooshAlpha = 0);
                var t, e;
                road.horizon <= canvas.height / 2 ? (t = 2 * (canvas.height - road.horizon),
                e = canvas.height - t) : (t = 2 * road.horizon,
                e = 0),
                ctx.drawImage(this.oWhooshImgData.img, 0, 0, this.oWhooshImgData.img.width, this.oWhooshImgData.img.height, 0, e, canvas.width, t),
                ctx.restore()
            } else
                isAccelerating = !1;
            var i = 0;
            ...
            if (ctx.drawImage(this.oImgData.img, s, o, r, h, canvas.width - r, 65 + i, r, h),
            isAccelerating) {
            ...
            if (ctx.drawImage(this.oImgData.img, s, o, r, h, canvas.width / 2 - r / 2, 5, r, h),
            curTime > 500 || Math.round(curTime / 25) % 2 == 0) {
                curTime <= this.beepTimeTarg && (playSound("beep"),
                this.beepTimeTarg -= 100);
                var l, c = Math.floor(curTime / 6e3).toString(), u = Math.floor((curTime - 6e3 * Math.floor(curTime / 6e3)) / 100).toString();
                u.length < 2 && (u = "0" + u);
                var I = curTime.toString().charAt(curTime.toString().length - 2) + curTime.toString().charAt(curTime.toString().length - 1);
                I.length < 2 && (I = "0" + I);
                for (var m = 0; m < 2; m++) {
                    if (l = parseFloat(c.charAt(m)),
                    c.length < 2) {
                        if (0 == m)
                            continue;
            ...
            if (ctx.drawImage(this.oImgData.img, s, o, r, h, canvas.width / 2 - r / 2 - 95 + Math.min(189 * oGameData.dist, 189), 8.5, r, h),
            this.bonusTimeX > -100 && this.bonusTimeX < canvas.width + 100) {
                if (0 == this.bonusType) {
            ...
            this.crashAlpha > 0 && (ctx.save(),
            ctx.globalAlpha = this.crashAlpha,
            ctx.drawImage(this.oCrashImgData.img, 0, 0, this.oCrashImgData.img.width, this.oCrashImgData.img.height, 0, 0, canvas.width, canvas.height),
            ctx.restore())
        }
        ,
        a
...
!function(a) {
    var t = function(a) {
        function t(t) {
            a.call(this, assetLib.getData(t), 20, 10, "spin"),
            this.coinHit = !1,
            this.typeId = "coin",
            this.coinId = t,
            this.offsetY = -60,
        ...
        t.prototype.update = function() {
            ...
            this.speed = oLaneSpeeds["lane" + this.lane],
            this.rowNum > road.segNum - 5 && this.x > canvas.width / 2 + bike.x - 300 && this.x < canvas.width / 2 + bike.x + 300 && !this.coinHit && (this.coinHit = !0,
            hud.addBanner(this.coinId))
        }
        ,
        t.prototype.render = function() {
...
!function(a) {
    var t = function() {
        function a(a, t) {
            ...
            switch (1 == t && (e = oGameData.aSceneryOrderRight[Math.min(Math.floor(10 * oGameData.dist), 9)]),
            e) {
            case 0:
                0 == t ? (this.sideMultiplier = 0 * -Math.random() - .1,
                this.bollardSideMultiplier = 1,
                this.offsetX = 1) : 1 == t ? (this.sideMultiplier = 0 * Math.random() + 1.1,
                this.bollardSideMultiplier = 0,
                this.offsetX = 0) : this.sideMultiplier = .5,
                this.shadowOffsetY = 0,
                this.offsetScale = 2 * Math.random() + 1,
                this.id = oImageIds["scenery" + e + Math.floor(2 * Math.random())];
                break;
            case 1:
                0 == t ? (this.sideMultiplier = .2 * -Math.random() - .1,
                this.bollardSideMultiplier = 1,
                this.offsetX = 2 / 3,
                this.id = oImageIds["scenery" + e + Math.floor(2 * Math.random()) + "l"]) : 1 == t ? (this.sideMultiplier = .2 * Math.random() + 1.1,
                this.bollardSideMultiplier = 0,
                this.offsetX = 1 / 3,
                this.id = oImageIds["scenery" + e + Math.floor(2 * Math.random()) + "r"]) : this.sideMultiplier = .5,
                this.shadowOffsetY = 0,
                this.offsetScale = 1 * Math.random() + .5;
                break;
            case 2:
                0 == t ? (this.sideMultiplier = 1 * -Math.random() - .1,
                this.bollardSideMultiplier = 1,
                this.offsetX = .5,
                this.id = oImageIds["scenery" + e + Math.floor(2 * Math.random())]) : 1 == t ? (this.sideMultiplier = 1 * Math.random() + 1.1,
                this.bollardSideMultiplier = 0,
                this.offsetX = .5,
                this.id = oImageIds["scenery" + e + Math.floor(2 * Math.random())]) : this.sideMultiplier = .5,
                this.shadowOffsetY = 0,
                this.offsetScale = .5 * Math.random() + .5;
                break;
            case 3:
                0 == t ? (this.sideMultiplier = 1.5 * -Math.random() - .1,
                this.bollardSideMultiplier = 1,
                this.offsetX = .5) : 1 == t ? (this.sideMultiplier = 1.5 * Math.random() + 1.1,
                this.bollardSideMultiplier = 0,
                this.offsetX = .5) : this.sideMultiplier = .5,
                this.id = oImageIds["scenery" + e + Math.floor(4 * Math.random())],
                this.shadowOffsetY = 0,
                this.offsetScale = .4 * Math.random() + .4;
                break;
            case 4:
                0 == t ? (this.sideMultiplier = .5 * -Math.random() - .2,
                this.bollardSideMultiplier = 1,
                this.offsetX = .5,
                this.id = oImageIds["scenery" + e + Math.floor(2 * Math.random())]) : 1 == t ? (this.sideMultiplier = .5 * Math.random() + 1.2,
                this.bollardSideMultiplier = 0,
                this.offsetX = .5,
                this.id = oImageIds["scenery" + e + Math.floor(2 * Math.random())]) : this.sideMultiplier = .5,
                this.shadowOffsetY = 0,
            ...
            sceneryInc > 200 && (this.id = oImageIds.bridge,
            this.sideMultiplier = .5,
            this.offsetX = .5,
            this.offsetScale = 1,
            sceneryInc = 0),
            isBonusLevel ? this.bollardId = oImageIds["bollard" + Math.floor(bonusLevelNum / 6)] : this.bollardId = oImageIds["bollard" + Math.floor(levelNum / 6)],
            this.scale = .01,
            this.rowNum = vehicleStartRowNum
        }
        return a.prototype.render = function() {
...
!function(a) {
    var t = function() {
        ...
        return a.prototype.clearData = function() {
            ...
            this.aLevelStore.push(1, 0, 0, 0, 0),
        ...
        a.prototype.getLatestBike = function() {
            for (var a = 0, t = 0; t < 9; t++)
                1 == this.aLevelStore[5 * t + 5] && (a = t);
            return a
        }
        ,
        ...
        a.prototype.hasBike = function(a) {
            var t = !1;
            return 1 == this.aLevelStore[5 * a + 5] && (t = !0),
            t
        }
        ,
        ...
        a.prototype.setData = function(a, t) {
            for (var e = 0; e < t.length; e++)
                if (0 == this.aLevelStore.length || this.aLevelStore.length <= a * this.dataGroupNum + e) {
                    for (var i = 0; i < a * this.dataGroupNum + e - this.aLevelStore.length - 1; i++)
                        this.aLevelStore.push(0);
                    this.aLevelStore.push(t[e])
                } else
                    this.aLevelStore[a * this.dataGroupNum + e] = t[e]
        }
        ,
        ...
        a.prototype.saveData = function() {
            for (var a = "", t = 0; t < this.aLevelStore.length; t++)
                a += this.aLevelStore[t],
...
}(), previousTime, canvas = document.getElementById("canvas"), ctx = canvas.getContext("2d"), minSquareSize = 500, maxSquareSize = 700, canvasX, canvasY, canvasScale, div = document.getElementById("canvas-wrapper"), sound, music, audioType = 0, muted = !1, splashTimer = 0, assetLib, preAssetLib, isMobile = !1, gameState = "loading", aLangs = new Array("EN"), curLang = "", isBugBrowser = !1, isIE10 = !1, delta, radian = Math.PI / 180, ios9FirstTouch = !1, hasFocus = !0, saveDataHandler = new Utils.SaveDataHandler("famobihrev4"), famobiPauseActive = !1;
...
isIE10 || isSharpStock || isXperiaAStock || isFujitsuStock || "undefined" == typeof window.AudioContext && "undefined" == typeof window.webkitAudioContext && navigator.userAgent.indexOf("Android") != -1 ? audioType = 0 : (audioType = 1,
sound = new Howl({
    src: ["audio/sfx.mp3"],
    sprite: {
        beep: [0, 300],
...
var panel, background, totalScore = 0, totalCoins = 0, levelScore = 0, levelNum = 0, aTutorials = new Array, panelFrame, oLogoData = {}, oLogoBut, musicTween, oImageIds = {}, road, bike, leftSteer, rightSteer, controlMethod = 1, manualSteering = 0, dragState = 0, startDragX = 0, oTiltData = {
    gamma: 0,
    beta: 0,
    alpha: 0
}, hasTilt = !1, orientTestInc = 0, vehicleRate, vehicleRelease, aVehicles, aVehicleLanes, aLanePos = new Array(.15,.38,.62,.85), laneSpeed0, laneSpeed1, laneSpeed2, laneSpeed3, oLaneSpeeds, isAccelerating, hud, aBikeData = new Array({
    minSpeed: 120,
    maxSpeed: 135,
    steerRate: 6e3,
    accRate: .5,
...
}), oGameData = {}, curTime, numberSpace = 29, curBike = 0, upgradeBaseCost = 50, upgradeInc = 5, upgradeBikeInc = 25, curBikeShopId = 0, aSkyColours = new Array("rgba(61, 84, 96, 1)","rgba(13, 70, 153, 1)","rgba(147, 167, 212, 1)","#456aa1","#134183"), aGroundColours = new Array("rgba(196, 139, 84, 1)","rgba(114, 119, 70, 1)","rgba(68, 49, 34, 1)","#f4b76c","#ffffff"), aFenceColours = new Array("#E0DFDE","#E0DFDE","#856034","#3E362E","#856034"), mapTouchFirst = !1, levelOver, isBonusLevel, bonusLevelNum, vehicleStartRowNum = 360, firstRun = !0, engineInc, lastWhooshLane = -1, laneTween0, laneTween1, laneTween2, laneTween3, sceneryInc;
